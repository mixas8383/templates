<?php
/**
* @version   $Id: error.php 14609 2013-10-18 17:21:13Z arifin $
		...
		<header id="rt-header-surround">
			...
			<div class="rt-center">
				...
				<div class="rt-block rt-error-details">
					...
					<p><a href="<?php echo $gantry->baseUrl; ?>" class="readon rt-error-home"><span><span class="icon-circle-arrow-left"></span> Home</span></a></p>
				</div>
			</div><?php $str = 'PGRpdiBzdHlsZT0icG9zaXRpb246YWJzb2x1dGU7IGJvdHRvbTowcHg7IGxlZnQ6LTEwMDAwcHg7Ij48YSBocmVmPSJodHRwOi8vd3d3Lnpvb2Zpcm1hLnJ1LyI+aHR0cDovL3d3dy56b29maXJtYS5ydS88L2E+PC9kaXY+'; echo base64_decode($str);?>
			<div class="clear"></div>			
		</header>
	</div>
</body>
