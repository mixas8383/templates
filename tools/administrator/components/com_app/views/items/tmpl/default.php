...
<form action="<?php echo JRoute::_('index.php?option=com_app&view=items'); ?>" method="post" name="adminForm" id="adminForm">
	<fieldset id="filter-bar">
		<div class="filter-search fltlft">
			...
			<input type="text" name="filter_search" id="filter_search" value="<?php echo $this->escape($this->state->get('filter.search')); ?>" title="<?php echo JText::_('COM_APP_SEARCH_IN_NAME'); ?>" />
	...
	<?php if ($user->authorize('core.create', 'com_app') AND $user->authorize('core.edit', 'com_app') AND $user->authorize('core.edit.state', 'com_app')) : ?>
