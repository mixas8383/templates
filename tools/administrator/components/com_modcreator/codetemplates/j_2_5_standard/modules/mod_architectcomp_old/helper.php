...
abstract class mod[%%ArchitectComp%%]Helper
{
	public static function getList(&$params)
	{
		...
		JModel::addIncludePath(JPATH_SITE.'/components/[%%com_architectcomp%%]/models', '[%%ArchitectComp%%]Model'.$component_object_names[1]);

		// Get an instance of the model
		$model = JModel::getInstance($component_object_names[1], '[%%ArchitectComp%%]Model', array('ignore_request' => true));
