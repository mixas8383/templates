 ...
 * @author			Component Architect (www.Modcreatort.com)
 * @package			com_Modcreatort
 * @subpackage		com_Modcreatort.admin
 ...
 *
 */
class ModcreatorModelGenerateDialog extends JModelAdmin
{
  ...
  protected function populateState ()
  {
    ...
    $params = JComponentHelper::getParams ( 'com_Modcreatort' ) ;
  ...
  public function getForm ( $data = array() , $loadData = true )
  {
    ...
    $form = $this->loadForm ( 'com_modcreatort.generatedialog' , 'generatedialog' , array( 'control' => 'jform' , 'load_data' => $loadData ) , true ) ;
    if ( empty ( $form ) )
    {
      return false ;
    }
  ...
  protected function loadFormData ()
  {
    ...
    $data = JFactory::getApplication ()->getUserState ( 'com_Modcreatort.generatedialog.data' , array() ) ;
  ...
  public function generate ( $token )
  {
    ...
    $progress = new ModcreatortGenerateProgressHelper() ;
    $progress->initialiseProgress ( $token ) ;

    require_once JPATH_COMPONENT . '/' . 'helpers' . '/' . 'generate.php' ;

    $generate = new ModcreatortGenerateHelper ( $token ) ;
