...
class JFormFieldModal_CodeTemplates extends JFormField
{
	...
	protected function getInput()
	{
		...
		$link = 'index.php?option=com_modcreator&amp;view=codetemplates&amp;layout=modal&amp;tmpl=component&amp;function=jSelectCodeTemplate_'.$this->id;
		...
		if ($allow_edit)
		{
			if (version_compare(JVERSION, '3.0', 'lt'))
			{
				$html[] = '<div class="button2-left">';
				$html[] = '	<div class="blank">';
				$html[] = '<a class="btn'.($value ? '' : ' hidden').'" href="index.php?option=com_modcreator&layout=modal&tmpl=component&task=codetemplate.edit&id=' . $value. '" target="_blank" title="'.JText::_('COM_COMPONENTARCHITECT_CODETEMPLATES_EDIT_DESC').'" >' . JText::_('JACTION_EDIT') . '</a>';
				$html[] = '	</div>';
				$html[] = '</div>';
			}
			else
			{		
				$html[] = '<a class="btn hasTooltip'.($value ? '' : ' hidden').'" href="index.php?option=com_modcreator&layout=modal&tmpl=component&task=codetemplate.edit&id=' . $value. '" target="_blank" title="'.JHtml::tooltipText('COM_COMPONENTARCHITECT_CODETEMPLATES_EDIT_DESC').'" ><span class="icon-edit"></span>' . JText::_('JACTION_EDIT') . '</a>';
			}	
		}
