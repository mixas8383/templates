...
class ModcreatorViewItem extends JView
{
	...
	public function display($tpl = null)
	{
		...
		$this->can_do = ModcreatorItemsHelper::getActions($this->item->id);
	...
	protected function addToolbar()
	{
		...
		JToolBarHelper::title($is_new ? JText::_('COM_MODCREATOR_ITEMS_NEW_HEADER') : JText::_('COM_MODCREATOR_ITEMS_EDIT_HEADER'), 'items.png');
	...
	protected function _prepareDocument()
	{
		...
		$this->document->addScript(JUri::root() ."administrator/components/com_modcreator/assets/js/modcreatorvalidate.js");
		
		$this->document->addScript(JUri::root() ."administrator/components/com_modcreator/assets/js/formsubmitbutton.js");
