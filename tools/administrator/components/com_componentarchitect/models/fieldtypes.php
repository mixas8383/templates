...
/**
 * Methods supporting a list of fieldtype records.
 *
 */
class ComponentArchitectModelFieldTypes extends JModelList
{
	/**
	...
	protected function getListQuery()
	{
		...
		// Select the required types from the table.
		$query->select(
			$this->getState(
					'list.select',
					'a.*'
	...
	public function getCreators()
	{
		...
		$query->join('INNER', '#__componentarchitect_fieldtypes AS a ON a.created_by = u.id');
