<?php
/**
 * @version 		$Id: componentobjectgeneratesiteviews.php 411 2014-10-19 18:39:07Z BrianWade $
...
/**
 * Form Rule class for the Object/Table - Generate Site Views field.
 */
class JFormRulecomponentobjectgeneratesiteviews extends JFormRule
{
	/**
	...
	public function test(SimpleXMLElement $element, $value, $group = null, JRegistry $input = null, JForm $form = null)
	{
		...
		else
		{
			...
			if ($joomla_parts['generate_site'] == '0' AND $value == '1')
			{
				// Change to RuntimeException when Joomla! 2.5 no longer supported as JException (deprecated) and will be removed from Joomla
				return new JException(JText::_('COM_COMPONENTARCHITECT_COMPONENTOBJECTS_FIELD_GENERATE_SITE_VIEWS_ERROR_SITE_NOT_SET'), 1, E_WARNING);
			}
			//[%%END_CUSTOM_CODE%%]			
			return true;
		}
