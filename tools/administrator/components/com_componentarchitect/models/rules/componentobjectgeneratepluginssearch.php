<?php
/**
 * @version 		$Id: componentobjectgeneratepluginssearch.php 411 2014-10-19 18:39:07Z BrianWade $
...
/**
 * Form Rule class for the Object/Table - Generate Plugins - Search field.
 */
class JFormRulecomponentobjectgeneratepluginssearch extends JFormRule
{
	/**
	...
	public function test(SimpleXMLElement $element, $value, $group = null, JRegistry $input = null, JForm $form = null)
	{
		...
		else
		{
			...
			if ($joomla_parts['generate_plugins'] == '0' AND $value == '1')
			{
				...
				return new JException(JText::_('COM_COMPONENTARCHITECT_COMPONENTOBJECTS_FIELD_GENERATE_PLUGINS_SEARCH_ERROR_PLUGINS_NOT_SET'), 1, E_WARNING);
			}
			//[%%END_CUSTOM_CODE%%]			
			return true;
		}
