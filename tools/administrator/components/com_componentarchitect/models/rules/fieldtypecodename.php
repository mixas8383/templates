<?php
/**
 * @version 		$Id: fieldtypecodename.php 411 2014-10-19 18:39:07Z BrianWade $
...
/**
 * Form Rule class for the Field Type - Code Name field.
 */
class JFormRulefieldtypecodename extends JFormRule
{
	/**
	...
	public function test(SimpleXMLElement $element, $value, $group = null, JRegistry $input = null, JForm $form = null)
	{
		...
		else
		{
			...
			// Build the query.
			$query->select('COUNT(*)');
			$query->from('#__componentarchitect_fieldtypes');
			...
			if ($duplicate)
			{
				...
				return new JException(JText::_('COM_COMPONENTARCHITECT_FIELDTYPES_FIELD_CODE_NAME_ERROR_DUPLICATE'), 1, E_WARNING);
			}
			//[%%END_CUSTOM_CODE%%]				
			return true;
		}
