<?php
/**
 * @version 		$Id: componentgeneratecategoriessiteviewscategories.php 411 2014-10-19 18:39:07Z BrianWade $
...
/**
 * Form Rule class for the Component/Extension - Generate Categories -Site Categories View field.
 */
class JFormRulecomponentgeneratecategoriessiteviewscategories extends JFormRule
{
	/**
	...
	public function test(SimpleXMLElement $element, $value, $group = null, JRegistry $input = null, JForm $form = null)
	{
		...
		else
		{
			...
			if (($joomla_parts['generate_categories'] == '0' OR $joomla_parts['generate_site'] == '0') AND $value == '1')
			{
				...
				return new JException(JText::_('COM_COMPONENTARCHITECT_COMPONENTS_FIELD_GENERATE_CATEGORIES_SITE_VIEW_CATEGORIES_ERROR_CATEGORIES_SITE_NOT_SET'), 1, E_WARNING);
			}
			//[%%END_CUSTOM_CODE%%]	
			return true;
		}
