<?php
/**
 * @version 		$Id: fieldmysqldefault.php 411 2014-10-19 18:39:07Z BrianWade $
...
/**
 * Form Rule class for the Field - MySQL Default field.
 */
class JFormRulefieldmysqldefault extends JFormRule
{
	/**
	...
	public function test(SimpleXMLElement $element, $value, $group = null, JRegistry $input = null, JForm $form = null)
	{
		...
		else
		{
			...
			if ($value != '' AND ($value[0] != "'" OR $value[strlen($value)-1] != "'"))
			{
				...
				return new JException(JText::_('COM_COMPONENTARCHITECT_FIELDS_FIELD_MYSQL_DEFAULT_ERROR_NOT_IN_QUOTES'), 1, E_WARNING);
			}	
			//[%%END_CUSTOM_CODE%%]		
			return true;
		}
