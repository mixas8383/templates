<?php
/**
 * @version 		$Id: componenticon48px.php 411 2014-10-19 18:39:07Z BrianWade $
...
/**
 * Form Rule class for the Component/Extension - Icon 48px field.
 */
class JFormRulecomponenticon48px extends JFormRule
{
	/**
		...
		else
		{
			...
			if ($file_name != '')
			{
				...
				if ($file_type != 'png')
				{
					...
					return new JException(JText::_('COM_COMPONENTARCHITECT_COMPONENTS_FIELD_ICON_48PX_ERROR_NOT_PNG'), 1, E_WARNING);
				}
			}
			//[%%END_CUSTOM_CODE%%]			
			return true;
