...
/**
 * FieldTypes list controller class.
 *
 * 
 */
class ComponentArchitectControllerFieldTypes extends JControllerAdmin
{
	/**
	...
	/**
	 * Creates a copy of selected field types
	 *
	 * @return  void
	 *
	 */
	 ...
	 * 
	 */
	public function getModel($name = 'FieldType', $prefix = 'ComponentArchitectModel',$config = array('ignore_request' => true))
	{
