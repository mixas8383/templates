...
/**
 * View to edit a fieldtype.
 *
 */
class ComponentArchitectViewFieldType extends JViewLegacy
{
	protected $form;
	protected $item;
	protected $state;
	...
	protected function addToolbar()
	{
		...
		JToolbarHelper::help('JHELP_COMPONENTS_COMPONENTARCHITECT_FIELDTYPE_EDIT', true, null, 'com_componentarchitect');
	}
	/**
