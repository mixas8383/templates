 ...
 *
 */
class ComponentArchitectViewFields extends JViewLegacy
{
	protected $items;
	...
	protected $f_fieldsets;
	protected $predefined_field_values;
	protected $ft_fieldtypes;
	protected $o1_componentobjects;
	...
	public function display($tpl = null)
	{
		...
		$this->f_fieldsets	= $this->get('FFieldsets');
		$this->predefined_field_values	= $this->get('Predefinedfieldvalues');
		$this->ft_fieldtypes	= $this->get('FTFieldtypes');
		$this->o1_componentobjects	= $this->get('O1Componentobjects');
		// Check for errors.
	...
	protected function addToolbar()
	{
		...
		JToolbarHelper::title(JText::_('COM_COMPONENTARCHITECT_FIELDS_LIST_HEADER'), 'stack fields');

		JToolbarHelper::addNew('field.add','JTOOLBAR_NEW');
		
		JToolbarHelper::editList('field.edit','JTOOLBAR_EDIT');
		
		JToolbarHelper::custom('fields.copy', 'copy.png', 'copy_f2.png','COM_COMPONENTARCHITECT_COPY', true);		
		...
		JToolbarHelper::help('JHELP_COMPONENTS_COMPONENTARCHITECT_FIELDS', true, null, 'com_componentarchitect');
	...
	{	
		...
		JHtmlSidebar::setAction('index.php?option=com_componentarchitect&view=fields');
	...
	protected function getSortFields()
	{
		return array(
			...
			'c1_component_name' => JText::_('COM_COMPONENTARCHITECT_FIELDS_HEADING_COMPONENT_ID'),
			'o_component_object_name' => JText::_('COM_COMPONENTARCHITECT_FIELDS_HEADING_COMPONENT_OBJECT_ID'),
			'f_fieldset_name' => JText::_('COM_COMPONENTARCHITECT_FIELDS_HEADING_FIELDSET_ID'),
			'a.predefined_field' => JText::_('COM_COMPONENTARCHITECT_FIELDS_HEADING_PREDEFINED_FIELD'),
			'ft_field_type_name' => JText::_('COM_COMPONENTARCHITECT_FIELDS_HEADING_FIELDTYPE_ID'),
			'o1_component_object_name' => JText::_('COM_COMPONENTARCHITECT_FIELDS_HEADING_FOREIGN_OBJECT_ID'),
