 ...
 *
 * @version			$Id: default_children.php 417 2014-10-22 14:42:10Z BrianWade $
...
<?php if (count($this->children[$this->category->id]) > 0) : ?>
	<?php foreach($this->children[$this->category->id] as $id => $child) : ?>
		<?php if ($this->params->get('show_empty_cat') OR $child->getNumItems(true) OR count($child->getChildren())) : ?>
			<?php 
