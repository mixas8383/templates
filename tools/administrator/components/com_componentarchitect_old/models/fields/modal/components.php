...
class JFormFieldModal_Components extends JFormField
{
	...
	protected function getInput()
	{
		...
		$link = 'index.php?option=com_componentarchitect&amp;view=components&amp;layout=modal&amp;tmpl=component&amp;function=jSelectComponent_'.$this->id;
		...
		if ($allow_edit)
		{
			if (version_compare(JVERSION, '3.0', 'lt'))
			{
				$html[] = '<div class="button2-left">';
				$html[] = '	<div class="blank">';
				$html[] = '<a class="btn'.($value ? '' : ' hidden').'" href="index.php?option=com_componentarchitect&layout=modal&tmpl=component&task=component.edit&id=' . $value. '" target="_blank" title="'.JText::_('COM_COMPONENTARCHITECT_COMPONENTS_EDIT_DESC').'" >' . JText::_('JACTION_EDIT') . '</a>';
				$html[] = '	</div>';
				$html[] = '</div>';
			}
			else
			{		
				$html[] = '<a class="btn hasTooltip'.($value ? '' : ' hidden').'" href="index.php?option=com_componentarchitect&layout=modal&tmpl=component&task=component.edit&id=' . $value. '" target="_blank" title="'.JHtml::tooltipText('COM_COMPONENTARCHITECT_COMPONENTS_EDIT_DESC').'" ><span class="icon-edit"></span>' . JText::_('JACTION_EDIT') . '</a>';
			}	
		}
