...
/**
 * ComponentObject Field class from the Joomla! Framework.
 *
 */
class JFormFieldComponentObject extends JFormFieldList
{
	/**
	 * The form field type.
	 *
	...
	public function getOptions()
	{
		...
		$query->from('#__componentarchitect_componentobjects AS a');
		$query->order('a.name');
