<?php
/**
 * @version 		$Id: componentobjectcodename.php 411 2014-10-19 18:39:07Z BrianWade $
...
/**
 * Form Rule class for the Object/Table - Code Name field.
 */
class JFormRulecomponentobjectcodename extends JFormRule
{
	/**
		...
		else
		{
			...
			if ($input->get('component_id') > 0)
			{
				...
				if ($duplicate)
				{
					...
					return new JException(JText::_('COM_COMPONENTARCHITECT_COMPONENTOBJECTS_FIELD_CODE_NAME_ERROR_DUPLICATE'), 1, E_WARNING);
				}
