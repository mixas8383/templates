<?php
/**
 * @version 		$Id: componentobjecticon16px.php 411 2014-10-19 18:39:07Z BrianWade $
...
/**
 * Form Rule class for the Object/Table - Icon 16px field.
 */
class JFormRulecomponentobjecticon16px extends JFormRule
{
	/**
	...
	public function test(SimpleXMLElement $element, $value, $group = null, JRegistry $input = null, JForm $form = null)
	{
		...
		{
			//[%%START_CUSTOM_CODE%%]
			$file_name =  $_FILES['jform']['name']['icon_16px'];
			if ($file_name != '')
			{
				...
				if ($file_type != 'png')
				{
					...
					return new JException(JText::_('COM_COMPONENTARCHITECT_COMPONENTOBJECTS_FIELD_ICON_16PX_ERROR_NOT_PNG'), 1, E_WARNING);
				}
			}
			//[%%END_CUSTOM_CODE%%]				
			return true;
