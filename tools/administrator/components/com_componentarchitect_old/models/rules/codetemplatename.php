<?php
/**
 * @version 		$Id: codetemplatename.php 411 2014-10-19 18:39:07Z BrianWade $
...
/**
 * Form Rule class for the Code Template - Name field.
 */
class JFormRulecodetemplatename extends JFormRule
{
	/**
	...
	public function test(SimpleXMLElement $element, $value, $group = null, JRegistry $input = null, JForm $form = null)
	{
		...
		else
		{
			...
			// Build the query.
			$query->select('COUNT(*)');
			$query->from('#__componentarchitect_codetemplates');
			...
			if ($duplicate)
			{
				...
				return new JException(JText::_('COM_COMPONENTARCHITECT_CODETEMPLATES_FIELD_NAME_ERROR_DUPLICATE'), 1, E_WARNING);
			}
			return true;
		}
	}	
