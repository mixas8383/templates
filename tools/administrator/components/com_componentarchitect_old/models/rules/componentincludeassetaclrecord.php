<?php
/**
 * @version 		$Id: componentincludeassetaclrecord.php 411 2014-10-19 18:39:07Z BrianWade $
...
/**
 * Form Rule class for the Component/Extension - Include Asset ACL - Record Level field.
 */
class JFormRulecomponentincludeassetaclrecord extends JFormRule
{
	/**
	...
	public function test(SimpleXMLElement $element, $value, $group = null, JRegistry $input = null, JForm $form = null)
	{
		...
		else
		{
			...
			if ($joomla_features['include_assetacl'] == '0' AND $value == '1')
			{
				...
				return new JException(JText::_('COM_COMPONENTARCHITECT_COMPONENTS_FIELD_INCLUDE_ASSETACL_RECORD_ERROR_ASSETACL_NOT_SET'), 1, E_WARNING);
			}
			//[%%END_CUSTOM_CODE%%]			
			return true;
		}
