...
/**
 * CodeTemplates list controller class.
 *
 * 
 */
class ComponentArchitectControllerCodeTemplates extends JControllerAdmin
{
	/**
	...
	/**
	 * Creates a copy of selected code templates
	 *
	 * @return  void
	 *
	 */
	 ...
	 * 
	 */
	public function getModel($name = 'CodeTemplate', $prefix = 'ComponentArchitectModel',$config = array('ignore_request' => true))
	{
