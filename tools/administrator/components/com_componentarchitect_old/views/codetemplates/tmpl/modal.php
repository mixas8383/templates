...
$function	= $app->input->get('function', 'jSelectCodeTemplate');
...
?>
<h3><?php echo JText::_('COM_COMPONENTARCHITECT_CODETEMPLATES_SELECT_ITEM_LABEL'); ?></h3>
<form action="<?php echo JRoute::_('index.php?option=com_componentarchitect&view=codetemplates&layout=modal&tmpl=component&function='.$function.'&'.JSession::getFormToken().'=1');?>" method="post" name="adminForm" id="adminForm">
