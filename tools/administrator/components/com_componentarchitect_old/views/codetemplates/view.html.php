...
/**
 * View class for a list of codetemplates.
 *
 */
class ComponentArchitectViewCodeTemplates extends JViewLegacy
{
	protected $items;
	protected $pagination;
	protected $state;
	protected $creators;
	protected $predefined_code_template_values;
	...
	public function display($tpl = null)
	{
		...
		$this->predefined_code_template_values	= $this->get('Predefinedcodetemplatevalues');
		// Check for errors.
	...
	protected function addToolbar()
	{
		...
		JToolbarHelper::title(JText::_('COM_COMPONENTARCHITECT_CODETEMPLATES_LIST_HEADER'), 'stack codetemplates');
	...
	{	
		...
		JHtmlSidebar::setAction('index.php?option=com_componentarchitect&view=codetemplates');
	...
	protected function getSortFields()
	{
		return array(
			...
			'a.predefined_code_template' => JText::_('COM_COMPONENTARCHITECT_CODETEMPLATES_HEADING_PREDEFINED_CODE_TEMPLATE'),
