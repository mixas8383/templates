 ...
 *
 */
class ComponentArchitectViewComponent extends JViewLegacy
{
	protected $form;
	protected $item;
	protected $state;
	...
	protected function addToolbar()
	{
		...
		JToolbarHelper::help('JHELP_COMPONENTS_COMPONENTARCHITECT_COMPONENT_EDIT', true, null, 'com_componentarchitect');
	}
	/**
