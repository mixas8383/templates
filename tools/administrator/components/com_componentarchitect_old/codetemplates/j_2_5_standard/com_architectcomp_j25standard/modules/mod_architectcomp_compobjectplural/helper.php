...
JModel::addIncludePath(JPATH_SITE.'/components/[%%com_architectcomp%%]/models', '[%%ArchitectComp%%]Model[%%CompObjectPlural%%]');
...
abstract class mod[%%CompObjectPlural%%]Helper
{
	public static function getList(&$params)
	{
		...
		$model = JModel::getInstance('[%%CompObjectPlural%%]', '[%%ArchitectComp%%]Model', array('ignore_request' => true));
