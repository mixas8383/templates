 ...
 *
 * @version		Id: category[%%architectcomp%%].php 324 2012-10-03 09:09:04Z BrianWade $
...
/**
 * [%%ArchitectComp_name%%] extended class to access JHtmlCategory.  Helper file category.php being used 
 * insted of libraries/joomla/html/html/category.php 
 *
 */
class JHtmlCategory[%%ArchitectComp%%] extends JHtmlCategory
{
	/**
