...
class JFormFieldModal_Items extends JFormField
{
	...
	protected function getInput()
	{
		...
		$html[] = '	<a class="modal" title="'.JText::_('COM_APP_ITEMS_SELECT_BUTTON').'"  href="'.$link.'&amp;'.JSession::getFormToken().'=1" rel="{handler: \'iframe\', size: {x: 800, y: 450}}">'.JText::_('COM_APP_ITEMS_SELECT_BUTTON').'</a>';
		$html[] = '  </div>';
		$html[] = '</div>';
		...
		$html[] = 'document.id(\'' . $this->id . '_name\').value=\''.JText::_('COM_APP_ITEMS_SELECT_ITEM_LABEL').'\';';
