...
{
	(function($){
        progress_ajax_url = 'index.php?option=com_componentarchitect&task=generateprogress.progress';
...
function generate_start()
{
	...
	(function($){
	    ...
	    generate_ajax_url = 'index.php?option=com_componentarchitect&task=generatedialog.generate';
		// Data to send to AJAX
        var dataObj = {}; 		
	    var token_name = $('#token > input[type=hidden]').attr("name");
        dataObj['token'] = token_name; 
