 ...
 *
 */
class Slider2TableItems extends JTable
{
	...
	public function __construct(&$db)
	{
		...
		parent::__construct('#__slider2_items', 'id', $db);
		...
		JTableObserverTags::createObserver($this, array('typeAlias' => 'com_slider2.item'));

		JTableObserverContenthistory::createObserver($this, array('typeAlias' => 'com_slider2.item'));
	}
	...
	public function check()
	{
		...
		$table = JTable::getInstance('Items', 'Slider2Table');
		if ($table->load(array('alias'=>$this->alias)) AND ($table->id != $this->id OR $this->id==0))
		{
			$this->setError(JText::_('COM_SLIDER2_FIELD_ALIAS_DUPLICATED'));
			return false;
		}		
	...
	{
		$k = $this->_tbl_key;
		return 'com_slider2.item.'.(int) $this->$k;
	}
	...
	protected function _getAssetParentId(JTable $table = null, $id = null)
	{
		...
		if ($asset->loadByName('com_slider2'))
		{
			return $asset->id;
		}
		else
