 ...
 *
 */
class Slider2ViewItem extends JViewLegacy
{
	protected $form;
	protected $item;
	protected $state;
	...
	public function display($tpl = null)
	{
		...
		$this->can_do = JHelperContent::getActions('com_slider2', 'item', $this->item->id);
	...
	protected function addToolbar()
	{
		...
		JToolbarHelper::title($is_new ? JText::_('COM_SLIDER2_ITEMS_NEW_HEADER') : JText::_('COM_SLIDER2_ITEMS_EDIT_HEADER'), 'items.png');
