 ...
 * @author			 ()
 * @package			com_slider2
 * @subpackage		com_slider2.install
 * @copyright		
 ...
 */
class com_slider2InstallerScript
{
    /**
    ...
    function install($parent) 
    {
		...
		$install_html_file = __DIR__ . '/slider2_install.html';
		...
		ob_start();            
		?>
		<div id="slider2install-info">
			<h1><?php echo JText::_('COM_SLIDER2_INSTALL_HEADER'); ?></h1>
			<div id="slider2install-intro">
				<?php echo JText::_('COM_SLIDER2_INSTALL_INTRO'); ?>
			</div>
			<table id="slider2install-table" class="adminlist">
				<thead class="slider2install-heading">
					<tr>
						<th colspan="3">
							<?php echo JText::_('COM_SLIDER2_INSTALL_HEADER');?>
						</th>
					</tr>
				</thead>
				<tbody>
					<tr class="slider2install-subheading">
						<th colspan="2">
							<?php echo JText::_('COM_SLIDER2_EXTENSION_HEADER');?>
						</th>
						<th width="50%">
							<?php echo JText::_('COM_SLIDER2_STATUS_HEADER');?>
						</th>					
					</tr>			
					<tr class="slider2install-row">
						<td  colspan="2">
							<?php echo JText::_('COM_SLIDER2');?>
						</td>
						<td class="slider2install-success">
							<?php echo JText::_('COM_SLIDER2_INSTALL_PACKAGE_SUCCESS');?>
						</td>
					</tr>
					<tr>				
						<td colspan="3">
							<?php echo JText::_('COM_SLIDER2_INSTALL_CORE_COMPONENT_SUCCESS');?>
						</td>
					</tr>
		<?php
		$buffer .= ob_get_clean();
		...
		if (count($manifest->plugins->plugin) > 0)
		{
			...
			<tr class="slider2install-subheading">
				<th>
					<?php echo JText::_('COM_SLIDER2_PLUGIN_HEADER');?>
				</th>
				<th>
					<?php echo JText::_('COM_SLIDER2_PLUGIN_GROUP_HEADER');?>
				</th>				
				<th width="50%">
					<?php echo JText::_('COM_SLIDER2_STATUS_HEADER');?>
				</th>					
 		...
 		if (count($manifest->modules->module) > 0)
		{
			...
			<tr class="slider2install-subheading">
				<th>
					<?php echo JText::_('COM_SLIDER2_MODULE_HEADER');?>
				</th>
				<th>
					<?php echo JText::_('COM_SLIDER2_MODULE_GROUP_HEADER');?>
				</th>				
				<th width="50%">
					<?php echo JText::_('COM_SLIDER2_STATUS_HEADER');?>
				</th>					
	...
	?>
				...
				<tfoot>
					<tr>
						<td colspan="3" text-align="center">
							<?php if ($install_error) : ?>
								<div id="slider2install-component-error">
									<?php echo JText::_('COM_SLIDER2_INSTALL_COMPONENT_ERROR'); ?>
								</div>			
							<?php else : ?>
								<div id="slider2install-component-success">
									<?php echo JText::_('COM_SLIDER2_INSTALL_COMPONENT_SUCCESS'); ?>
								</div>			
							<?php endif; ?>
						</td>
					</tr>
					<tr>
						<td colspan="3" text-align="center">
							<?php echo JText::_('COM_SLIDER2_JOOMLA_LOGO_DISCLAIMER'); ?>	
						</td>				
					</tr>					
				</tfoot>
			</table>					
    ...
    function uninstall($parent) 
    {
        ...
        $manifest = $parent->get("manifest");
        $parent = $parent->getParent();
		$uninstall_html_file = __DIR__ . '/slider2_uninstall.html';
     ...
     ?>
	<div id="slider2install-info">
		<h1><?php echo JText::_('COM_SLIDER2_UNINSTALL_HEADER'); ?></h1>
			<table id="slider2install-table" class="adminlist">
				<thead class="slider2install-heading">
					<tr>
						<th colspan="3">
							<?php echo JText::_('COM_SLIDER2_UNINSTALL_HEADER');?>
						</th>
					</tr>
				</thead>
				<tbody>
					...
					<tr class="slider2install-row">
						...
						<td class="slider2install-success">
							<?php echo JText::_('COM_SLIDER2_UNINSTALL_PACKAGE_SUCCESS');?>
						</td>
					</tr>
	<?php
		$buffer .= ob_get_clean();  
		...
		JFolder::delete(JPATH_SITE.'/images/slider2'); 
		JFolder::delete(JPATH_SITE.'/plugins/slider2'); 

		$db->setQuery(
						'DELETE FROM '.$db->quoteName('#__content_types')
						.' WHERE '.$db->quoteName('type_alias').' = '.$db->quote('com_slider2.item')
					 );
				...
				<tfoot>
					<tr>
						<td colspan="3">
							<?php if ($install_error) : ?>
								<div id="slider2install-component-error">
									<?php echo JText::_('COM_SLIDER2_UNINSTALL_COMPONENT_ERROR'); ?>
								</div>			
							<?php else : ?>
								<div id="slider2install-component-success">
									<?php echo JText::_('COM_SLIDER2_UNINSTALL_COMPONENT_SUCCESS'); ?>
								</div>			
							<?php endif; ?>
						</td>
					</tr>
    ...
    function update($parent) 
    {
		...
		?>
		<div id="slider2install-info">
			<h1><?php echo JText::_('COM_SLIDER2_UPDATE_HEADER'); ?></h1>
			<table id="slider2install-table" class="adminlist">
				<thead class="slider2install-heading">
					<tr>
						<th colspan="3">
							<?php echo JText::_('COM_SLIDER2_UPDATE_HEADER');?>
						</th>
					</tr>
				</thead>
				<tbody>
					...
					<tr class="slider2install-row">
						...
						<td class="slider2install-success">
							<?php echo JText::_('COM_SLIDER2_UPDATE_PACKAGE_SUCCESS');?>
						</td>
					</tr>					
		<?php
		$buffer .= ob_get_clean();  
				...
				<tfoot>
					<tr>
						<td colspan="3">
							<?php if ($install_error) : ?>
								<div id="slider2install-component-error">
									<?php echo JText::_('COM_SLIDER2_UPDATE_COMPONENT_ERROR'); ?>
								</div>			
							<?php else : ?>
								<div id="slider2install-component-success">
									<?php echo JText::_('COM_SLIDER2_UPDATE_COMPONENT_SUCCESS'); ?>
								</div>			
							<?php endif; ?>
						</td>
					</tr>
    ...
    function preflight($type, $parent) 
    {
		...
		if( version_compare( $joomla_version->getShortVersion(), $this->minimum_joomla_release, 'lt' ) ) {
			Jerror::raiseWarning(null, JTEXT::sprintf('COM_SLIDER2_INSTALL_COMPONENT_ERROR_WRONG_JOOMLA_VERSION',$this->minimum_joomla_release));
			return false;
		}
		switch ($type)
		{
			...
			case 'update' :
				...
				{
					Jerror::raiseWarning(null, JTEXT::sprintf('COM_SLIDER2_UPDATE_COMPONENT_ERROR_WRONG_VERSION_SEQUENCE', $rel));
					return false;
				}			
			default :
				break; 
    ...
    function postflight($type, $parent) 
    {
		...
		{
			case 'install' :
				JFolder::create(JPATH_SITE.'/images/slider2'); 
				JFile::copy('administrator/components/com_slider2/index.html','images/slider2/index.html', JPATH_SITE);
				
				// Make sure index.html files in all folders
				if (JFolder::exists(JPATH_SITE.'/plugins/slider2') AND !JFile::exists(JPATH_SITE.'/plugins/slider2/index.html'))
				{
					JFile::copy('administrator/components/com_slider2/index.html','plugins/slider2/index.html', JPATH_SITE);
				}	
				break;    				
			case 'update' :
				/*
	...
	private function getManifest()
	{
		...
		$query->from($db->quoteName('#__extensions'));	
		$query->where($db->quoteName('name').' = '.$db->quote('com_slider2'));		
	...
	<tr class="slider2install-row">
		...
		<td class="slider2install-error">
			<div>
				<?php echo JText::_('COM_SLIDER2_'.strtoupper($action).'_PACKAGE_ERROR');?><br />
				<span class="slider2install-errormsg">
					<?php echo $msg; ?>
				</span>	
			</div>		
		</td>
    ...
    private function printSuccess($package, $group, $action)
    {
		...
		<tr class="slider2install-row">
			...
			<td class="slider2install-success">
				<div><?php echo JText::_('COM_SLIDER2_'.strtoupper($action).'_PACKAGE_SUCCESS');?></div>
			</td>
		</tr> 		
		<?php
            $out = ob_get_clean();
    ...
    private function populateUCM()
    {
		...
		$content_type['type_alias'] = 'com_slider2.item';
		$content_type['table'] = '{"special":{"dbtable":"slider2_items","key":"id","type":"Items","prefix":"Slider2Table","config":"array()"},';
		...
		$content_type['router'] = 'Slider2HelperRoute::getItemRoute';

		$content_type['content_history_options'] = '{"formFile":"administrator\/components\/slider2\/models\/forms\/item.xml",';
