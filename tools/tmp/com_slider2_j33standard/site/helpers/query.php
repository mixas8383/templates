...
/**
 * Slider Component Query Helper
 *
 */
class Slider2HelperQuery
{
	/**
	...
	public static function getQueryDate($order_date) 
	{
		...
		switch ($order_date)
		{
			...
			case 'publish_up' :
				$query_date = ' CASE WHEN a.publish_up = ' . $db->quote($db->getNullDate()) . ' THEN a.modified ELSE a.publish_up END ';
				$query_date = ' CASE WHEN a.publish_up = ' . $db->quote($db->getNullDate()) . ' THEN a.created ELSE a.publish_up END ';
				break;
			case 'created' :
