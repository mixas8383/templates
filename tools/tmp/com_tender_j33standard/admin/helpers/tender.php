 ...
 * 
 * @version			$Id: architectcomp.php 408 2014-10-19 18:31:00Z BrianWade $
...
class [%%ArchitectComp%%]Helper extends JHelperContent
{
	...
	public static function addSubmenu($view_name)
	{
		...
		$active = $view_name == 'itemses'? true : false;
		JHtmlSidebar::addEntry(
			JText::_('[%%COM_ARCHITECTCOMP%%]_ITEMSES_SUBMENU'),
			'index.php?option=[%%com_architectcomp%%]&view=itemses',
			$view_name == 'itemses',
			$active
		);
