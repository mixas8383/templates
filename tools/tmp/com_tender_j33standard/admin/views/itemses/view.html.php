...
class [%%ArchitectComp%%]ViewItemses extends JViewLegacy
{
	...
	protected function addToolbar()
	{
		...
		JToolbarHelper::title(JText::_('[%%COM_ARCHITECTCOMP%%]_ITEMSES_LIST_HEADER'), 'stack itemses');
	...
	{	
		JHtmlSidebar::setAction('index.php?option=[%%com_architectcomp%%]&view=itemses');
