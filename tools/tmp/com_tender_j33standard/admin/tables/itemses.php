 ...
 *
 */
class [%%ArchitectComp%%]TableItemses extends JTable
{
	...
	public function __construct(&$db)
	{
		...
		parent::__construct('#__[%%architectcomp%%]_itemses', 'id', $db);
		...
		JTableObserverTags::createObserver($this, array('typeAlias' => '[%%com_architectcomp%%].items'));

		JTableObserverContenthistory::createObserver($this, array('typeAlias' => '[%%com_architectcomp%%].items'));
	}
	...
	public function check()
	{
		...
		$table = JTable::getInstance('Itemses', '[%%ArchitectComp%%]Table');
	...
	{
		$k = $this->_tbl_key;
		return '[%%com_architectcomp%%].items.'.(int) $this->$k;
	}
