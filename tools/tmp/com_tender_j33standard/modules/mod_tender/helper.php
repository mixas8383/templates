...
abstract class Mod[%%ArchitectComp%%]Helper
{
	...
	public static function getList(&$params)
	{
		...
		{
			$order_map = array(
				'itemses m_dsc' => 'a.modified DESC, a.created',
				'itemses c_dsc' => 'a.created',
				'itemses p_dsc' => 'a.publish_up',
				'itemses h_dsc' => 'a.hits',
				'itemses n_asc' => 'a.name',
				'itemses n_dsc' => 'a.name',
				'itemses o_asc' => 'a.ordering',
			);
