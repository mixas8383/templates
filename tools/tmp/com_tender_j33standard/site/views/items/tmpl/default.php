...
<div class="[%%architectcomp%%] items-view<?php echo $params->get('pageclass_sfx')?>" itemscope itemtype="http://schema.org/CreativeWork">
	...
	<?php if ($params->get('show_items_hits') != '0' OR 
		($params->get('show_items_image', '0') == '1' AND isset($images['image_url']) AND $images['image_url'] != '')): ?>	
			<div class="pull-<?php echo htmlspecialchars($params->get('show_items_image_float','right')); ?>">
			<?php if ($params->get('show_items_image') == '1' AND isset($images['image_url']) AND $images['image_url'] != '') : ?>
					...
					/>
			<?php endif; ?>			 
			<?php if ($params->get('show_items_hits')) : ?>
	...
	<div style="clear:both; padding-top: 10px;">
		...
		<?php elseif ($params->get('show_items_noauth') == true AND  $user->get('guest') ) : ?>
			<?php if ($params->get('show_items_intro')) : ?>
				<span itemprop="description">
				<?php echo $this->item->intro; ?>
				</span>
			<?php endif; ?>	
			<?php //Optional link to let them register to see the whole items. ?>
			<?php if ($params->get('show_items_readmore')) :
	...
	<div style="padding-top: 10px;">
		<?php if ($params->get('access-view')) : ?>	
			...
			<form action="" name="itemsForm" id="itemsForm">
			<?php
				$dummy = false;
		$display_fieldset = (
							...
							($params->get('show_items_publish_up')) OR
							($params->get('show_items_publish_down')) OR
							($params->get('show_items_admin') AND $this->item->params->get('access-change')) OR							
							$dummy
							);
			?>
			...
			<?php endif; ?>						
			<?php if ($params->get('show_items_tags')  == '1' AND !empty($this->item->tags) AND !empty($this->item->tags->itemTags)) : ?>
				<div class="formelm">
					<label>
			...
			<?php endif; ?>	
			<?php if ($params->get('show_items_created_by_alias')) : ?>
			...
			<?php endif; ?>
			<?php if ($params->get('show_items_publish_down')) : ?>
				<div class="formelm">
					<label>
			...
			<?php if ($params->get('access-change')): ?>
				<?php if ($params->get('show_items_admin')) : ?>
