...
<div class="[%%architectcomp%%] itemses-list<?php echo $this->params->get('pageclass_sfx');?>">
	...
	<form action="<?php echo JFilterOutput::ampReplace(JUri::getInstance()->toString()); ?>" method="post" name="adminForm" id="adminForm">
		...
		<?php if (empty($this->items)) : ?>
			...
			<p><?php echo JText::_('[%%COM_ARCHITECTCOMP%%]_ITEMSES_NO_ITEMS'); ?></p>
			<?php endif; ?>
		...
		<?php else : ?>
			...
			<tbody>
				...
				?>			
					...
					<td class="list-name">
						<a href="<?php echo JRoute::_([%%ArchitectComp%%]HelperRoute::getItemsRoute($item->slug, 
																									$item->catid, 
																									$item->language,
																									$layout,									
