...
require_once __DIR__ . '/itemses.php';
...
class [%%ArchitectComp%%]ModelCategory extends JModelList
{
	...
	protected function buildOrderBy()
	{
		...
		{
			case 'Itemses' :
				$secondary_order_by	= $params->get('items_orderby_sec', 'none');
				$order_date			= $params->get('items_order_date');
				$category_order_by	= $params->def('items_orderby_pri', '');
