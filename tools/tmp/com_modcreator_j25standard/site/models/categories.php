...
/**
 * This models supports retrieving lists of modcreator categories.
 *
 */
class ModcreatorModelCategories extends JModel
{
	/**
	 ...
	 * @var		string
	 */
	public $_context = 'com_modcreator.categories';
	 ...
	 * @var		string
	 */
	protected $_extension = 'com_modcreator';
