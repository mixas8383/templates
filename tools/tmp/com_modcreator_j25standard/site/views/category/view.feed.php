...
class ModcreatorViewCategory extends JView
{
	function display()
	{
		...
		$doc->link = JRoute::_(ModcreatorHelperRoute::getCategoryRoute($category->id, $params->get('keep_item_itemid')));
		...
		foreach ($rows as $row)
		{
			...
			$link = JRoute::_(ModcreatorHelperRoute::getItemRoute($row->slug, 
																						$row->catid, 
																						$row->language,
																						'default',									
