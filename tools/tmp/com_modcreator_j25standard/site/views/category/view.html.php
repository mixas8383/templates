...
/**
 * HTML View class for the ModCreator component
 *
 */
class ModcreatorViewCategory extends JView
{
	protected $state;
	protected $category;
	protected $children;
	...
	protected function _prepareDocument()
	{
		...
		{
			$this->params->def('page_heading', JText::_('COM_MODCREATOR_CATEGORY_HEADER'));
		}

		$id = (int) @$menu->query['id'];

		if ($menu AND ($menu->query['option'] != 'com_modcreator' OR
					 ...
					 $id != $this->category->id))
		{
			...
			while (($menu->query['option'] != 'com_modcreator' OR
					$menu->query['view'] == 'item' OR
		...
		$this->document->addStyleSheet(JUri::root()."components/com_modcreator/assets/css/".JString::strtolower(str_replace(' ','',$this->params->get('items_to_display'))).".css");
		$this->document->addStyleSheet(JUri::root()."components/com_modcreator/assets/css/categories.css");
	
		if ($lang->isRTL())
		{
			$this->document->addStyleSheet(JUri::root()."components/com_modcreator/assets/css/modcreator-rtl.css");
			$this->document->addStyleSheet(JUri::root()."components/com_modcreator/assets/css/".JString::strtolower(str_replace(' ','',$this->params->get('items_to_display')))."-rtl.css");
			$this->document->addStyleSheet(JUri::root()."components/com_modcreator/assets/css/categories-rtl.css");
		}
