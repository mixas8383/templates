...
<div class="modcreator item-edit<?php echo $this->escape($params->get('pageclass_sfx')); ?>">
		...
		<h2>
			<?php  
				if (!is_null($this->item->id)) :
					echo JText::sprintf('COM_MODCREATOR_EDIT_ITEM', $this->escape($this->item->name)); 
				else :
					echo JText::_('COM_MODCREATOR_ITEMS_CREATE_ITEM');
				endif;
			?>
		</h2>
		</div>
	...
	<?php endif; ?>
	<form action="<?php echo JRoute::_('index.php?option=com_modcreator&view=itemform&layout=edit&id='.(int) $this->item->id); ?>" method="post" name="adminForm" id="adminForm" class="form-validate">
		...
		<fieldset>
			<legend><?php echo JText::_('COM_MODCREATOR_FIELD_IMAGE_LABEL'); ?></legend>
		...
		<fieldset>
			<legend><?php echo JText::_('COM_MODCREATOR_FIELDSET_URLS_LABEL'); ?></legend>
		...
		<fieldset>
			<legend><?php echo JText::_('COM_MODCREATOR_FIELDSET_PUBLISHING_LABEL'); ?></legend>						
			<?php $creator =  $this->item->created_by ?>
			<?php $creator = ($this->item->created_by_name ? $this->item->created_by_name : $creator);?>

			<div class="formelm">
				<label>				
					<?php echo JText::_('COM_MODCREATOR_FIELD_CREATED_BY_LABEL'); ?> 
				</label>
				<span>
			...
			<div class="formelm">
				<label>				
					<?php echo JText::_('COM_MODCREATOR_FIELD_CREATED_LABEL'); ?>
				</label>				
				<span>				
			...
			<div class="formelm">				
				<label>				
					<?php echo JText::_('COM_MODCREATOR_FIELD_MODIFIED_BY_LABEL'); ?> 
				</label>				
				<span>				
			...
			<div class="formelm">
				<label>				
					<?php echo JText::_('COM_MODCREATOR_FIELD_MODIFIED_LABEL'); ?>				
				</label>				
				<span>				
		...
		<?php endif; ?>
		<fieldset>
			<legend><?php echo JText::_('COM_MODCREATOR_FIELDSET_METADATA_LABEL'); ?></legend>
		...
		<?php if (is_null($this->item->id)):?>
			<div class="form-note">
			<p><?php echo JText::_('COM_MODCREATOR_ITEMS_ORDERING'); ?></p>
			</div>
		<?php endif; ?>
	</form>
</div>