...
class ModcreatorViewCategories extends JView
{
	...
	function display($tpl = null)
	{
		...
		if ($children === false)
		{
			JError::raiseWarning(500, JText::_('COM_MODCREATOR_ERROR_CATEGORY_NOT_FOUND'));
			return false;
		}

		if ($parent == false)
		{
			JError::raiseWarning(500, JText::_('COM_MODCREATOR_ERROR_PARENT_CATEGORY_NOT_FOUND'));
			return false;
		}
	...
	protected function _prepareDocument()
	{
		...
		{
			$this->params->def('page_heading', JText::_('COM_MODCREATOR_CATEGORIES_LABEL'));
		}
