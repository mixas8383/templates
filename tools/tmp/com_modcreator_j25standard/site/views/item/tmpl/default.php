...
<div class="modcreator item-view<?php echo $params->get('pageclass_sfx')?>">
		...
		($params->get('show_item_image', '0') == '1' AND $this->item->image_url != '')) : ?>	
		 <div style="float: right;">
			...
			<?php if ($params->get('show_item_hits')) : ?>
				...
				<?php echo '<br />'.JText::sprintf('COM_MODCREATOR_HITS', $this->item->hits); ?>
			<?php endif; ?>	
		</div>
	<?php endif; ?>	
	...
	<div style="padding-top: 10px;">
		<?php if ($params->get('access-view')) : ?>	
			...
			<?php if ($params->get('show_item_parent_category') AND $this->item->parent_slug != '1:root') : ?>
				...
				<div class="formelm">
					<label>
						<?php echo JText::_('COM_MODCREATOR_FIELD_PARENT_CATEGORY_LABEL'); ?>
					</label>
					<span>
			...
			<?php if ($params->get('show_item_category')) : ?>
				...
				<div class="formelm">				
					<label>
						<?php echo JText::_('COM_MODCREATOR_FIELD_CATEGORY_LABEL'); ?>
					</label>
					<span>
			...
			<?php if ($params->get('show_item_publish_up')) : ?>
				<div class="formelm">
					<label>
						<?php echo JText::_('COM_MODCREATOR_FIELD_PUBLISH_UP_LABEL'); ?>				
					</label>
					<span>
			...
			<?php if ($params->get('show_item_publish_down')) : ?>
				<div class="formelm">
				<label>
					<?php echo JText::_('COM_MODCREATOR_FIELD_PUBLISH_DOWN_LABEL'); ?>				
				</label>
				<span>
			...
			<?php if ($this->item->params->get('access-change')): ?>
				<?php if ($params->get('show_item_admin')) : ?>
					...
					<div class="formelm">
						<label>
						<?php echo JText::_('COM_MODCREATOR_FIELD_STATUS_LABEL'); ?>
						</label>
						<span>
							<?php 
					...
					<div class="formelm">
						<label>
							<?php echo JText::_('COM_MODCREATOR_FIELD_FEATURED_LABEL'); ?>
						</label>
						<span>
							<?php 
					...
					<div class="formelm">
						<label>
							<?php echo JText::_('COM_MODCREATOR_FIELD_ACCESS_LABEL'); ?>
						</label>
						<span>
