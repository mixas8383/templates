...
<fieldset class="adminform">
	<legend><?php echo JText::_('COM_MODCREATOR_ITEM_BATCH_OPTIONS');?></legend>
	<p><?php echo JText::_('COM_MODCREATOR_ITEM_BATCH_TIP'); ?></p>
	<ul>
		<li><?php echo JHtml::_('itembatch.access');?><li>
		<li><?php echo JHtml::_('itembatch.language'); ?></li>
	
		<li><?php echo JHtml::_('itembatch.copy_items', 'com_modcreator');?></li>
	</ul>	
