 ...
 *
 */
class AppHelper extends JHelperContent
{
	...
	public static function addSubmenu($view_name)
	{
		...
		JHtmlSidebar::addEntry(
			JText::_('COM_APP_ITEMS_SUBMENU'),
			'index.php?option=com_app&view=items',
			$view_name == 'items',
			$active
		);
	
		if ($category_component != JText::_('COM_APP_FIELD_CATEGORY_COMPONENT_NO_CATEGORIES'))
		{	
			$active = $view_name == 'categories'? true : false;
			
			JHtmlSidebar::addEntry(
				JText::_('COM_APP_CATEGORIES_SUBMENU'),
