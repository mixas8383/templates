...
class JFormFieldModal_Items extends JFormField
{
	...
	protected function getInput()
	{
		...
		$html[] = '<input type="text" class="input-medium" id="'.$this->id.'_name" value="'.$title.'" disabled="disabled" size="35" />'
				 .'<a class="modal btn" title="'.JText::_('COM_APP_ITEMS_SELECT_BUTTON_LABEL').'"  href="'.$link.'&amp;'.JSession::getFormToken().'=1" rel="{handler: \'iframe\', size: {x: 800, y: 450}}"><i class="icon-file"></i> '.JText::_('COM_APP_ITEMS_SELECT_ITEM_LABEL').'</a>';
		$html[] = '</span>';
