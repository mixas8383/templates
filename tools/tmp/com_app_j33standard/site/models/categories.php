...
/**
 * This models supports retrieving lists of app categories.
 *
 */
class AppModelCategories extends JModelList
{
	/**
	 ...
	 * @var		string
	 */
	public $_context = 'com_app.categories';
