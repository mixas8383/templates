...
<div class="app item-view<?php echo $params->get('pageclass_sfx')?>" itemscope itemtype="http://schema.org/CreativeWork">
		...
		$display_fieldset = (
			...
			<?php if ($params->get('show_item_created_by_alias')) : ?>
				<div class="formelm" itemprop="creator" itemscope itemtype="http://schema.org/Person">				
					<label>
						<?php echo JText::_('COM_APP_FIELD_CREATED_BY_ALIAS_LABEL'); ?>
					</label>
