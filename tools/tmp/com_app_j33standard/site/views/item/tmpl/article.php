...
<div class="app item-article<?php echo $params->get('pageclass_sfx')?>" itemscope itemtype="http://schema.org/Article">
	...
	<?php if ($params->get('access-view')) : ?>	
		...
		<dl class="info">
			<dt class="info-title"><?php  echo JText::_('COM_APP_ITEMS_INFO'); ?></dt>
		<?php endif; ?>		
