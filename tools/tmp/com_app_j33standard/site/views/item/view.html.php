 ...
 *
 */
class AppViewItem extends JViewLegacy
{
	protected $item;
	protected $params;
	protected $print;
		...
		if ($item->params->get('access-view') != true)
		{
			...
			if (!$item->params->get('show_item_noauth'))
			{
				...
				if( $user->get('guest'))
				{
					...
					$app->redirect('index.php?option=com_users&view=login&return=' . base64_encode($uri), JText::_('COM_APP_ITEMS_ERROR_LOGIN_TO_VIEW_ITEM'));
