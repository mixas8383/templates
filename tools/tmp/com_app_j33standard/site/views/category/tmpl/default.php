...
$this->document->addStyleSheet(JUri::root().'media/com_app/css/site_'.JString::strtolower(str_replace(' ','',$this->params->get('items_to_display'))).'.css');
$this->document->addStyleSheet(JUri::root().'media/com_app/css/site_categories.css');

if ($lang->isRTL())
{
	$this->document->addStyleSheet(JUri::root().'media/com_app/css/site_app-rtl.css');
	$this->document->addStyleSheet(JUri::root().'media/com_app/css/site_'.JString::strtolower(str_replace(' ','',$this->params->get('items_to_display'))).'-rtl.css');
	$this->document->addStyleSheet(JUri::root().'media/com_app/css/site_categories-rtl.css');
}
...
<div class="app category-list <?php echo $this->pageclass_sfx;?>" itemscope itemtype="http://schema.org/Blog">
