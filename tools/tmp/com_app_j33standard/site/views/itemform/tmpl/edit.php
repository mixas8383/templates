...
<div class="app item-edit<?php echo $this->escape($params->get('pageclass_sfx')); ?>">
	...
	<?php endif; ?>
	<form action="<?php echo JRoute::_('index.php?option=com_app&view=itemform&id='.(int) $this->item->id); ?>" method="post" name="adminForm" id="item-form" class="form-validate">
		...
		<fieldset>
			<ul class="nav nav-tabs">
				<li class="active"><a href="#basic-details" data-toggle="tab"><?php echo JText::_('COM_APP_ITEMS_FIELDSET_DETAILS_LABEL');?></a></li>
				<li><a href="#imageslinks" data-toggle="tab"><?php echo JText::_('COM_APP_FIELDSET_IMAGES_URLS_LABEL');?></a></li>
				<?php if ($this->item->params->get('access-change')): ?>
				<li><a href="#publishing" data-toggle="tab"><?php echo JText::_('COM_APP_FIELDSET_PUBLISHING_LABEL');?></a></li>
				<li><a href="#metadata" data-toggle="tab"><?php echo JText::_('COM_APP_FIELDSET_METADATA_LABEL');?></a></li>
				<li><a href="#language" data-toggle="tab"><?php echo JText::_('COM_APP_FIELDSET_LANGUAGE_LABEL');?></a></li>
				<?php endif; ?>				
			</ul>		
