 ...
 *
 */
class SliderViewItems extends JViewLegacy
{
	protected $items;
	...
	public function display($tpl = null)
	{
		...
		$this->can_do = JHelperContent::getActions('com_slider');
	...
	protected function addToolbar()
	{
		...
		JToolbarHelper::title(JText::_('COM_SLIDER_ITEMS_LIST_HEADER'), 'stack items');
	...
	{	
		JHtmlSidebar::setAction('index.php?option=com_slider&view=items');
