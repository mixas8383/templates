...
if ($save_order)
{
	$save_ordering_url = 'index.php?option=com_slider&task=items.saveOrderAjax&tmpl=component';
...
<form action="<?php echo JRoute::_('index.php?option=com_slider&view=items'); ?>" method="post" name="adminForm" id="adminForm">
	...
	<?php else : ?>
		<table class="table table-striped" id="item-list">
			...
			<?php foreach ($this->items as $i => $item) :
				...
				$can_edit	= $user->authorise('core.edit',	'com_slider.item.'.$item->id);
		
				$can_edit_own	= $user->authorise('core.edit.own',		'com_slider.item.'.$item->id) 
								AND $item->created_by == $user_id
								;
				$can_change	= $user->authorise('core.edit.state',	'com_slider.item.'.$item->id) 
								AND $can_checkin
								;
				if ($item->language == '*'):
					...
					<td class="nowrap has-context">
						<div class="pull-left">
							...
							<?php if ($can_edit OR $can_edit_own) : ?>
								<a href="<?php echo JRoute::_('index.php?option=com_slider&task=item.edit&id='.(int) $item->id); ?>">
