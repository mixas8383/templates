...
class SliderViewItem extends JViewLegacy
{
	...
	public function display($tpl = null)
	{
		...
		$this->can_do = JHelperContent::getActions('com_slider', 'item', $this->item->id);
	...
	protected function addToolbar()
	{
		...
		JToolbarHelper::title($is_new ? JText::_('COM_SLIDER_ITEMS_NEW_HEADER') : JText::_('COM_SLIDER_ITEMS_EDIT_HEADER'), 'items.png');
