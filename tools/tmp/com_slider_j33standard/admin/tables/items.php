 ...
 *
 */
class SliderTableItems extends JTable
{
	...
	public function __construct(&$db)
	{
		...
		parent::__construct('#__slider_items', 'id', $db);
		...
		JTableObserverTags::createObserver($this, array('typeAlias' => 'com_slider.item'));

		JTableObserverContenthistory::createObserver($this, array('typeAlias' => 'com_slider.item'));
	}
	...
	public function check()
	{
		...
		$table = JTable::getInstance('Items', 'SliderTable');
	...
	{
		$k = $this->_tbl_key;
		return 'com_slider.item.'.(int) $this->$k;
	}
