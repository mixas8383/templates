...
<div class="slider itemses-blog<?php echo $this->params->get('pageclass_sfx');?>" itemscope itemtype="http://schema.org/Blog">
	...
	<?php else : ?>
		...
		<div class="pagination">
				...
				<?php if ($this->params->def('show_items_pagination_results', 1)) : ?>
					<p class="counter">
