...
?>
<dl class="items-info">
	<dt class="items-info-term"><?php  echo JText::_('COM_SLIDER_ITEMSES_INFO'); ?></dt>
	...
	<?php if ($params->get('show_items_tags')) : ?>
		<?php 
			...
			$this->item->tags->getItemTags('com_slider.items', $this->item->id);	
	...
	<?php if ($params->get('show_items_created')) : ?>
		<dd class="create">
				...
				<?php echo JText::sprintf('COM_SLIDER_CREATED_DATE_ON', JHtml::_('date',$this->item->created, JText::_('DATE_FORMAT_LC2'))); ?>
			</time>
		</dd>
	<?php endif; ?>
	<?php if ($params->get('show_items_publish_up')) : ?>
		<dd class="published">
			<time datetime="<?php echo JHtml::_('date', $this->item->publish_up, 'c'); ?>" itemprop="datePublished">
				<?php echo JText::sprintf('COM_SLIDER_PUBLISH_UP_ON', JHtml::_('date',$this->item->publish_up, JText::_('DATE_FORMAT_LC2'))); ?>
			</time>
		</dd>
	<?php endif; ?>
	<?php if ($params->get('show_items_modified')) : ?>
		<dd class="modified">
			<time datetime="<?php echo JHtml::_('date', $this->item->modified, 'c'); ?>" itemprop="dateModified">
				<?php echo JText::sprintf('COM_SLIDER_LAST_UPDATED', JHtml::_('date',$this->item->modified, JText::_('DATE_FORMAT_LC2'))); ?>
			</time>
		</dd>
	<?php endif; ?>
	...
	<dd class="createdby" itemprop="author" itemscope itemtype="http://schema.org/Person"> 
		...
		<?php if (!empty($this->item->created_by ) AND  $this->params->get('link_items_created_by') == 1):?>
			<?php echo JText::sprintf('COM_SLIDER_CREATED_BY',JHtml::_('link',
