 ...
 *
 */
class SliderViewCategory extends JViewLegacy
{
	protected $state;
	protected $category;
	protected $children;
	...
	public function display($tpl = null)
	{
		...
		$this->category->tags->getItemTags('com_slider.category', $this->category->id);
	...
	protected function prepareDocument()
	{
		...
		{
			$this->params->def('page_heading', JText::_('COM_SLIDER_CATEGORY_HEADER'));
		}

		$id = (int) @$menu->query['id'];

		if ($menu AND ($menu->query['option'] != 'com_slider' OR
					 ...
					 $id != $this->category->id))
		{
			...
			while (($menu->query['option'] != 'com_slider' OR
					$menu->query['view'] == 'item' OR
