...
<h2 itemprop="name">
		<?php if ($params->get('link_item_names') ) : ?>
			<a href="<?php echo JRoute::_(SliderHelperRoute::getItemRoute($this->item->slug, 
											$this->item->catid, 
											$this->item->language,
											$layout,									
...
<?php else : ?>
	...
	<?php if ($params->get('show_item_readmore')) :
			if ($params->get('access-view')) :
				$link = JRoute::_(SliderHelperRoute::getItemRoute($this->item->slug, 
																							$this->item->catid, 
																							$this->item->language,
																							$layout,									
				...
				if ($params->get('show_item_noauth') AND $user->get('guest')) :
					...
					$return_url = JRoute::_(SliderHelperRoute::getItemRoute($this->item->slug, 
																								$this->item->catid, 
																								$this->item->language,									
																								$layout,									
																								$params->get('keep_item_itemid')));
