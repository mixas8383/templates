...
require_once JPATH_ADMINISTRATOR.'/components/com_slider/models/item.php';

class SliderModelItemForm extends SliderModelItem
{
	/**
	 ...
	 * @var		string
	 */
	protected $context = 'com_slider.edit.item';
	/**
	...
	*/
	...
	protected function loadFormData()
	{
		...
		$data = JFactory::getApplication()->getUserState('com_slider.edit.item.data', array());
	...
	public function save($data)
	{
		...
		$result = $dispatcher->trigger('onItemBeforeSave', array('com_slider.item', &$table, $is_new));
		...
		$dispatcher->trigger('onItemAfterSave', array('com_slider.item', $table, $is_new));
