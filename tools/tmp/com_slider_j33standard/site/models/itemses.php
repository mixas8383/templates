...
class SliderModelItemses extends JModelList
{
	...
	protected function populateState($ordering = null, $direction = null)
	{
		...
		if ((!$user->authorise('core.edit.state', 'com_slider')) AND  (!$user->authorise('core.edit', 'com_slider')))
		{
	...
	protected function getListQuery()
	{
		...
		$query->from($db->quoteName('#__slider_itemses').' AS a');
		...
		$can_publish = $user->authorise('core.edit.state', 'com_slider');
	...
	public function getItems()
	{
		...
		$global_params = JComponentHelper::getParams('com_slider', true);
		...
		if ($items = parent::getItems())
		{
			...
			foreach ($items as &$item)
			{
				...
				if (!$guest) 
				{
					$asset	= 'com_slider.items.'.$item->id;
				...
				$item->tags->getItemTags('com_slider.items', $item->id);
			}
		}
		return $items;
	}
