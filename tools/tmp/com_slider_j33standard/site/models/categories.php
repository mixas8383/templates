...
/**
 * This models supports retrieving lists of slider categories.
 *
 */
class SliderModelCategories extends JModelList
{
	/**
	 ...
	 * @var		string
	 */
	public $_context = 'com_slider.categories';
	 ...
	 * @var		string
	 */
	protected $_extension = 'com_slider';
