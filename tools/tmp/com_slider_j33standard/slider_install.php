...
class com_sliderInstallerScript
{
    ...
    function install($parent) 
    {
		...
		$install_html_file = __DIR__ . '/slider_install.html';
		...
		ob_start();            
		?>
		<div id="sliderinstall-info">
			<h1><?php echo JText::_('COM_SLIDER_INSTALL_HEADER'); ?></h1>
			<div id="sliderinstall-intro">
				<?php echo JText::_('COM_SLIDER_INSTALL_INTRO'); ?>
			</div>
			<table id="sliderinstall-table" class="adminlist">
				<thead class="sliderinstall-heading">
					<tr>
						<th colspan="3">
							<?php echo JText::_('COM_SLIDER_INSTALL_HEADER');?>
						</th>
					</tr>
				</thead>
				<tbody>
					<tr class="sliderinstall-subheading">
						<th colspan="2">
							<?php echo JText::_('COM_SLIDER_EXTENSION_HEADER');?>
						</th>
						<th width="50%">
							<?php echo JText::_('COM_SLIDER_STATUS_HEADER');?>
						</th>					
					</tr>			
					<tr class="sliderinstall-row">
						<td  colspan="2">
							<?php echo JText::_('COM_SLIDER');?>
						</td>
						<td class="sliderinstall-success">
							<?php echo JText::_('COM_SLIDER_INSTALL_PACKAGE_SUCCESS');?>
						</td>
					</tr>
					<tr>				
						<td colspan="3">
							<?php echo JText::_('COM_SLIDER_INSTALL_CORE_COMPONENT_SUCCESS');?>
						</td>
					</tr>
		<?php
		$buffer .= ob_get_clean();
		...
		if (count($manifest->plugins->plugin) > 0)
		{
			...
			<tr class="sliderinstall-subheading">
				<th>
					<?php echo JText::_('COM_SLIDER_PLUGIN_HEADER');?>
				</th>
				<th>
					<?php echo JText::_('COM_SLIDER_PLUGIN_GROUP_HEADER');?>
				</th>				
				<th width="50%">
					<?php echo JText::_('COM_SLIDER_STATUS_HEADER');?>
				</th>					
 		...
 		if (count($manifest->modules->module) > 0)
		{
			...
			<tr class="sliderinstall-subheading">
				<th>
					<?php echo JText::_('COM_SLIDER_MODULE_HEADER');?>
				</th>
				<th>
					<?php echo JText::_('COM_SLIDER_MODULE_GROUP_HEADER');?>
				</th>				
				<th width="50%">
					<?php echo JText::_('COM_SLIDER_STATUS_HEADER');?>
				</th>					
	...
	?>
				...
				<tfoot>
					<tr>
						<td colspan="3" text-align="center">
							<?php if ($install_error) : ?>
								<div id="sliderinstall-component-error">
									<?php echo JText::_('COM_SLIDER_INSTALL_COMPONENT_ERROR'); ?>
								</div>			
							<?php else : ?>
								<div id="sliderinstall-component-success">
									<?php echo JText::_('COM_SLIDER_INSTALL_COMPONENT_SUCCESS'); ?>
								</div>			
							<?php endif; ?>
						</td>
					</tr>
					<tr>
						<td colspan="3" text-align="center">
							<?php echo JText::_('COM_SLIDER_JOOMLA_LOGO_DISCLAIMER'); ?>	
						</td>				
					</tr>					
				</tfoot>
			</table>					
    ...
    function uninstall($parent) 
    {
        ...
        $manifest = $parent->get("manifest");
        $parent = $parent->getParent();
		$uninstall_html_file = __DIR__ . '/slider_uninstall.html';
     ...
     ?>
	<div id="sliderinstall-info">
		<h1><?php echo JText::_('COM_SLIDER_UNINSTALL_HEADER'); ?></h1>
			<table id="sliderinstall-table" class="adminlist">
				<thead class="sliderinstall-heading">
					<tr>
						<th colspan="3">
							<?php echo JText::_('COM_SLIDER_UNINSTALL_HEADER');?>
						</th>
					</tr>
				</thead>
				<tbody>
					...
					<tr class="sliderinstall-row">
						...
						<td class="sliderinstall-success">
							<?php echo JText::_('COM_SLIDER_UNINSTALL_PACKAGE_SUCCESS');?>
						</td>
					</tr>
	<?php
		$buffer .= ob_get_clean();  
		...
		JFolder::delete(JPATH_SITE.'/images/slider'); 
		JFolder::delete(JPATH_SITE.'/plugins/slider'); 

		$db->setQuery(
						'DELETE FROM '.$db->quoteName('#__content_types')
						.' WHERE '.$db->quoteName('type_alias').' = '.$db->quote('com_slider.item')
					 );
				...
				<tfoot>
					<tr>
						<td colspan="3">
							<?php if ($install_error) : ?>
								<div id="sliderinstall-component-error">
									<?php echo JText::_('COM_SLIDER_UNINSTALL_COMPONENT_ERROR'); ?>
								</div>			
							<?php else : ?>
								<div id="sliderinstall-component-success">
									<?php echo JText::_('COM_SLIDER_UNINSTALL_COMPONENT_SUCCESS'); ?>
								</div>			
							<?php endif; ?>
						</td>
					</tr>
    ...
    function update($parent) 
    {
		...
		?>
		<div id="sliderinstall-info">
			<h1><?php echo JText::_('COM_SLIDER_UPDATE_HEADER'); ?></h1>
			<table id="sliderinstall-table" class="adminlist">
				<thead class="sliderinstall-heading">
					<tr>
						<th colspan="3">
							<?php echo JText::_('COM_SLIDER_UPDATE_HEADER');?>
						</th>
					</tr>
				</thead>
				<tbody>
					...
					<tr class="sliderinstall-row">
						...
						<td class="sliderinstall-success">
							<?php echo JText::_('COM_SLIDER_UPDATE_PACKAGE_SUCCESS');?>
						</td>
					</tr>					
		<?php
		$buffer .= ob_get_clean();  
				...
				<tfoot>
					<tr>
						<td colspan="3">
							<?php if ($install_error) : ?>
								<div id="sliderinstall-component-error">
									<?php echo JText::_('COM_SLIDER_UPDATE_COMPONENT_ERROR'); ?>
								</div>			
							<?php else : ?>
								<div id="sliderinstall-component-success">
									<?php echo JText::_('COM_SLIDER_UPDATE_COMPONENT_SUCCESS'); ?>
								</div>			
							<?php endif; ?>
						</td>
					</tr>
    ...
    function preflight($type, $parent) 
    {
		...
		if( version_compare( $joomla_version->getShortVersion(), $this->minimum_joomla_release, 'lt' ) ) {
			Jerror::raiseWarning(null, JTEXT::sprintf('COM_SLIDER_INSTALL_COMPONENT_ERROR_WRONG_JOOMLA_VERSION',$this->minimum_joomla_release));
			return false;
		}
		switch ($type)
		{
			...
			case 'update' :
				...
				{
					Jerror::raiseWarning(null, JTEXT::sprintf('COM_SLIDER_UPDATE_COMPONENT_ERROR_WRONG_VERSION_SEQUENCE', $rel));
					return false;
				}			
			default :
				break; 
    ...
    function postflight($type, $parent) 
    {
		...
		{
			case 'install' :
				JFolder::create(JPATH_SITE.'/images/slider'); 
				JFile::copy('administrator/components/com_slider/index.html','images/slider/index.html', JPATH_SITE);
				
				// Make sure index.html files in all folders
				if (JFolder::exists(JPATH_SITE.'/plugins/slider') AND !JFile::exists(JPATH_SITE.'/plugins/slider/index.html'))
				{
					JFile::copy('administrator/components/com_slider/index.html','plugins/slider/index.html', JPATH_SITE);
				}	
				break;    				
			case 'update' :
				/*
	...
	private function getManifest()
	{
		...
		$query->from($db->quoteName('#__extensions'));	
		$query->where($db->quoteName('name').' = '.$db->quote('com_slider'));		
	...
	<tr class="sliderinstall-row">
		...
		<td class="sliderinstall-error">
			<div>
				<?php echo JText::_('COM_SLIDER_'.strtoupper($action).'_PACKAGE_ERROR');?><br />
				<span class="sliderinstall-errormsg">
					<?php echo $msg; ?>
				</span>	
			</div>		
		</td>
    ...
    private function printSuccess($package, $group, $action)
    {
		...
		<tr class="sliderinstall-row">
			...
			<td class="sliderinstall-success">
				<div><?php echo JText::_('COM_SLIDER_'.strtoupper($action).'_PACKAGE_SUCCESS');?></div>
			</td>
		</tr> 		
		<?php
            $out = ob_get_clean();
    ...
    private function populateUCM()
    {
		...
		$content_type['type_alias'] = 'com_slider.item';
		$content_type['table'] = '{"special":{"dbtable":"slider_items","key":"id","type":"Items","prefix":"SliderTable","config":"array()"},';
		...
		$content_type['router'] = 'SliderHelperRoute::getItemRoute';

		$content_type['content_history_options'] = '{"formFile":"administrator\/components\/slider\/models\/forms\/item.xml",';
