...
<div class="example item-edit<?php echo $this->escape($params->get('pageclass_sfx')); ?>">
	...
	<?php endif; ?>
	<form action="<?php echo JRoute::_('index.php?option=com_example&view=itemform&layout=edit&id='.(int) $this->item->id); ?>" method="post" name="adminForm" id="adminForm" class="form-validate">
		...
		<fieldset>
			<legend><?php echo JText::_('COM_EXAMPLE_FIELD_IMAGE_LABEL'); ?></legend>
		...
		<fieldset>
			<legend><?php echo JText::_('COM_EXAMPLE_FIELDSET_URLS_LABEL'); ?></legend>
		...
		<fieldset>
			...
			<div class="formelm">				
				<label>				
					<?php echo JText::_('COM_EXAMPLE_FIELD_MODIFIED_BY_LABEL'); ?> 
				</label>				
				<span>				
		...
		<?php endif; ?>
		<fieldset>
			<legend><?php echo JText::_('COM_EXAMPLE_FIELDSET_METADATA_LABEL'); ?></legend>
