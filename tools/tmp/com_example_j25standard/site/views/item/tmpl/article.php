...
<div class="example item-article<?php echo $params->get('pageclass_sfx')?>">
	...
	<?php if ($params->get('access-view')) : ?>	
		...
		<?php if ($use_def_list) : ?>
		<dl class="info">
			<dt class="info-title"><?php  echo JText::_('COM_EXAMPLE_ITEMS_INFO'); ?></dt>
		<?php endif; ?>
		...
		<dd class="modified">
			<?php echo JText::sprintf('COM_EXAMPLE_PUBLISH_DOWN_ON', JHTML::_('date',$this->item->publish_down, JText::_('DATE_FORMAT_LC2'))); ?>
		</dd>
		<?php endif; ?>
