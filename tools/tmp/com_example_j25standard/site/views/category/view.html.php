...
/**
 * HTML View class for the Example component
 *
 */
class ExampleViewCategory extends JView
{
	protected $state;
	protected $category;
	protected $children;
	...
	protected function _prepareDocument()
	{
		...
		{
			$this->params->def('page_heading', JText::_('COM_EXAMPLE_CATEGORY_HEADER'));
		}

		$id = (int) @$menu->query['id'];

		if ($menu AND ($menu->query['option'] != 'com_example' OR
					 ...
					 $id != $this->category->id))
		{
			...
			while (($menu->query['option'] != 'com_example' OR
					$menu->query['view'] == 'item' OR
		...
		$this->document->addStyleSheet(JUri::root()."components/com_example/assets/css/".JString::strtolower(str_replace(' ','',$this->params->get('items_to_display'))).".css");
		...
		if ($lang->isRTL())
		{
			...
			$this->document->addStyleSheet(JUri::root()."components/com_example/assets/css/".JString::strtolower(str_replace(' ','',$this->params->get('items_to_display')))."-rtl.css");
