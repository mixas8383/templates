...
class ExampleModelCategory extends JModelList
{
	...
	protected function populateState($ordering = null, $direction = null)
	{
		...
		{
			$limit = $app->getUserStateFromRequest('com_example.category.list.' . $item_id . '.limit', 'limit', $app->getCfg('list_limit'));
		}
	...
	public function getItems()
	{
		...
		if ($params->get('items_to_display') AND $params->get('items_to_display') !='None')
		{
			...
			{
				$model = JModel::getInstance($object_upper_case, 'ExampleModel', array('ignore_request' => true));
