...
abstract class modExampleHelper
{
	public static function getList(&$params)
	{
		...
		JModel::addIncludePath(JPATH_SITE.'/components/com_example/models', 'ExampleModel'.$component_object_names[1]);

		// Get an instance of the model
		$model = JModel::getInstance($component_object_names[1], 'ExampleModel', array('ignore_request' => true));
