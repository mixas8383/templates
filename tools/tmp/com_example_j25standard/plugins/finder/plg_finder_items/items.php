 ...
 * @author			 ()
 * @package			com_example
 * @subpackage		com_example.finder.example.items
 * @copyright		
...
/**
 * Finder adapter for com_example - items
 *
 */
class plgFinderItems extends FinderIndexerAdapter
{
	...
	{
		// Make sure we're handling com_example categories
		if ($extension == 'com_example')
		{
	...
	public function onFinderAfterSave($context, $row, $is_new)
	{
		...
		if ($context == 'com_example.item' OR $context == 'com_example.itemform')
		{
	...
	protected function index(FinderIndexerResult $item, $format = 'html')
	{
		...
		$item->params = JComponentHelper::getParams('com_example', true);
		...
		$item->route = ExampleHelperRoute::getItemRoute($item->slug, $item->catslug, $item->language, $this->sub_layout);
	...
	protected function setup()
	{
		...
		include_once JPATH_SITE . '/components/com_example/helpers/route.php';
