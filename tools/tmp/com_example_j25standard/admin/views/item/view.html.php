...
class ExampleViewItem extends JView
{
	...
	public function display($tpl = null)
	{
		...
		$this->can_do = ExampleItemsHelper::getActions(0, $this->item->id);
	...
	protected function addToolbar()
	{
		...
		JToolBarHelper::title($is_new ? JText::_('COM_EXAMPLE_ITEMS_NEW_HEADER') : JText::_('COM_EXAMPLE_ITEMS_EDIT_HEADER'), 'items.png');
	...
	protected function _prepareDocument()
	{
		...
		$this->document->addStyleSheet(JUri::root()."administrator/components/com_example/assets/css/admin.css");
		...
		$this->document->addScript(JUri::root() ."administrator/components/com_example/assets/js/examplevalidate.js");
		
		$this->document->addScript(JUri::root() ."administrator/components/com_example/assets/js/formsubmitbutton.js");
