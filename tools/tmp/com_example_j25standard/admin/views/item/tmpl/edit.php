...
<form action="<?php echo JRoute::_('index.php?option=com_example&view=item&layout=edit&id='.(int) $this->item->id); ?>" method="post" name="adminForm" id="item-form" class="form-validate">
	<div class="width-60 fltlft">
		<fieldset class="adminform">
			<legend><?php echo JText::_('COM_EXAMPLE_FIELDSET_DETAILS_LABEL'); ?></legend>
	...
	<div class="width-40 fltrt">
		...
		<?php echo JHtml::_('sliders.panel',JText::_('COM_EXAMPLE_FIELDSET_PUBLISHING_DETAILS_LABEL'), 'publishing'); ?>
		...
		<?php echo JHtml::_('sliders.panel',JText::_('COM_EXAMPLE_FIELDSET_URLS_LABEL'), 'links'); ?>
	...
	<?php if ($this->can_do->get('core.admin')): ?>
		<div  class="width-100 fltlft">
			...
			<?php echo JHtml::_('sliders.panel',JText::_('COM_EXAMPLE_ITEMS_FIELDSET_RULES'), 'access-rules'); ?>	
				<fieldset class="panelform">
