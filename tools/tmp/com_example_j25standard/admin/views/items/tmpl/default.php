...
<form action="<?php echo JRoute::_('index.php?option=com_example&view=items'); ?>" method="post" name="adminForm" id="adminForm">
	<fieldset id="filter-bar">
		<div class="filter-search fltlft">
			...
			<input type="text" name="filter_search" id="filter_search" value="<?php echo $this->escape($this->state->get('filter.search')); ?>" title="<?php echo JText::_('COM_EXAMPLE_SEARCH_IN_NAME'); ?>" />
		...
		<div class="filter-select fltrt">
			...
			<select name="filter_state" class="inputbox" onchange="this.form.submit()">
				<option value=""><?php echo JText::_('COM_EXAMPLE_SELECT_PUBLISHED');?></option>
	...
	<?php if ($user->authorize('core.create', 'com_example') AND $user->authorize('core.edit', 'com_example') AND $user->authorize('core.edit.state', 'com_example')) : ?>
