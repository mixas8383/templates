...
abstract class JHtmlItem
{
	...
	static function featured($value = 0, $i, $can_change = true)
	{
		...
		$states	= array(
			0	=> array('disabled.png', 'items.featured', 'COM_EXAMPLE_ITEMS_UNFEATURED', 'COM_EXAMPLE_ITEMS_TOGGLE_TO_FEATURE'),
			1	=> array('featured.png', 'items.unfeatured', 'JFEATURED', 'COM_EXAMPLE_ITEMS_TOGGLE_TO_UNFEATURE'),
		);
