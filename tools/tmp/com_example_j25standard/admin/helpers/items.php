...
class ExampleItemsHelper
{
	 ...
	 * 
	 */
	public static function getActions($category_id = 0, $item_id = 0)
	{
		...
		{
			$asset_name = 'com_example.item.'.(int) $item_id;
		}
		else
		{
			...
			{
				$level = 'category';			
				$asset_name = 'com_example.category.'.(int) $category_id;
			}
			else
			{
				$asset_name = 'com_example';
			}
		}
		$actions = JAccess::getActions('com_example', $level);
