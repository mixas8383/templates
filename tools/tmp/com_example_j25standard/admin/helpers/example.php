...
class ExampleHelper
{
	...
	{
		$config = JComponentHelper::getParams(JText::_('COM_EXAMPLE_FIELD_CATEGORY_COMPONENT_DEFAULT'));
		$category_component = $config->get('category_component', JText::_('COM_EXAMPLE_FIELD_CATEGORY_COMPONENT_DEFAULT'));	

		JSubMenuHelper::addEntry(
			JText::_('COM_EXAMPLE_ITEMS_SUBMENU'),
			'index.php?option=com_example&view=items',
			$view_name == 'items'
		);
	
		if ($category_component != JText::_('COM_EXAMPLE_FIELD_CATEGORY_COMPONENT_NO_CATEGORIES'))
		{	
			JSubMenuHelper::addEntry(
				JText::_('COM_EXAMPLE_CATEGORIES_SUBMENU'),
