 ...
 * @subpackage		com_videomanager.finder.videomanager.categorieses
 * @copyright		
...
/**
 * Finder adapter for com_videomanager - categorieses
 *
 */
class PlgFinderCategorieses extends FinderIndexerAdapter
{
	/**
	 * @var    $context	string	The plugin identifier.
	 */
	protected $context = 'Categorieses';

	/**
	 * @var    $extensionstring	The extension name.
	 */
	protected $extension = 'com_videomanager';
	 ...
	 */
	protected $layout = 'categories';

	/**
	 * @var    $type_title	string	The type of content that the adapter indexes.
	 */
	protected $type_title = 'Categorieses';

	/**
	 * @var    $table	string	The table name.
	 */
	protected $table = '#__videomanager_categorieses';
	...
	{
		// Make sure we're handling com_videomanager categories
		if ($extension == 'com_videomanager')
		{
	...
	{
		if ($context == 'com_videomanager.categories')
		{
			$id = $table->id;
		}
	...
	{
		// We only want to handle categorieses here
		if ($context == 'com_videomanager.categories' OR $context == 'com_videomanager.categoriesform')
		{
	...
	protected function index(FinderIndexerResult $item, $format = 'html')
	{
		...
		$item->params = JComponentHelper::getParams('com_videomanager', true);
		...
		$item->route = VideomanagerHelperRoute::getCategoriesRoute($item->slug, $item->catslug, $item->language, $this->sub_layout);
		...
		$item->addTaxonomy('Type', 'Categories');
	...
	protected function setup()
	{
		...
		include_once JPATH_SITE . '/components/com_videomanager/helpers/route.php';
