 ...
 * @subpackage		com_videomanager.finder.videomanager.configs
 * @copyright		
...
/**
 * Finder adapter for com_videomanager - configs
 *
 */
class PlgFinderConfigs extends FinderIndexerAdapter
{
	/**
	 * @var    $context	string	The plugin identifier.
	 */
	protected $context = 'Configs';
	...
	{
		if ($context == 'com_videomanager.config')
		{
			$id = $table->id;
		}
	...
	{
		// We only want to handle configs here
		if ($context == 'com_videomanager.config' OR $context == 'com_videomanager.configform')
		{
	...
	protected function index(FinderIndexerResult $item, $format = 'html')
	{
		...
		$item->route = VideomanagerHelperRoute::getConfigRoute($item->slug, $item->language, $this->sub_layout);
