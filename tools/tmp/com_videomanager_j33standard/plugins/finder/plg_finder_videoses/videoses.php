 ...
 * @subpackage		com_videomanager.finder.videomanager.videoses
 * @copyright		
...
/**
 * Finder adapter for com_videomanager - videoses
 *
 */
class PlgFinderVideoses extends FinderIndexerAdapter
{
	/**
	 * @var    $context	string	The plugin identifier.
	 */
	protected $context = 'Videoses';
	...
	{
		if ($context == 'com_videomanager.videos')
		{
			$id = $table->id;
		}
	...
	{
		// We only want to handle videoses here
		if ($context == 'com_videomanager.videos' OR $context == 'com_videomanager.videosform')
		{
	...
	protected function index(FinderIndexerResult $item, $format = 'html')
	{
		...
		$item->route = VideomanagerHelperRoute::getVideosRoute($item->slug, $item->language, $this->sub_layout);
