...
require_once JPATH_ADMINISTRATOR.'/components/com_videomanager/models/config.php';

class VideomanagerModelConfigForm extends VideomanagerModelConfig
{
	/**
	 ...
	 * @var		string
	 */
	protected $context = 'com_videomanager.edit.config';
	/**
	...
	*/
	...
	protected function loadFormData()
	{
		...
		$data = JFactory::getApplication()->getUserState('com_videomanager.edit.config.data', array());
	...
	public function save($data)
	{
		...
		$result = $dispatcher->trigger('onConfigBeforeSave', array('com_videomanager.config', &$table, $is_new));
		...
		$dispatcher->trigger('onConfigAfterSave', array('com_videomanager.config', $table, $is_new));
