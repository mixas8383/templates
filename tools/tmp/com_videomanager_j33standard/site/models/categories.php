...
/**
 * This models supports retrieving lists of videomanager categories.
 *
 */
class VideomanagerModelCategories extends JModelList
{
	/**
	 ...
	 * @var		string
	 */
	public $_context = 'com_videomanager.categories';
	 ...
	 * @var		string
	 */
	protected $_extension = 'com_videomanager';
