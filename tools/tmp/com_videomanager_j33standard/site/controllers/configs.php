 ...
 *
 */
class VideomanagerControllerConfigs extends JControllerLegacy
{
	/**
	 ...
	 * 
	 */
	public function getModel($name = 'Configs', $prefix = 'VideomanagerModel',$config = array('ignore_request' => true))
	{
