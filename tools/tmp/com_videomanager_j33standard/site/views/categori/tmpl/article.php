...
<div class="videomanager categori-article<?php echo $params->get('pageclass_sfx')?>" itemscope itemtype="http://schema.org/Article">
	...
	<?php if ($params->get('show_categori_icons',-1) >= 0) : ?>
		<?php
			if ($params->get('show_categori_print_icon') 
	...
	<?php if (($params->get('show_categori_image', '0') == '1' AND isset($images['image_url']) AND $images['image_url'] != "")): ?>	
		<div class="pull-<?php echo htmlspecialchars($params->get('show_categori_image_float','right')); ?>">
			<?php 
				...
				$display_width = (int) $params->get('show_categori_image_width','100');
				$display_height = (int) $params->get('show_categori_image_height','0');
	...
	<?php if ($params->get('access-view')) : ?>	
		...
		<dl class="info">
			<dt class="info-title"><?php  echo JText::_('COM_VIDEOMANAGER_CATEGORIS_INFO'); ?></dt>
		<?php endif; ?>		
		
			<?php if ($params->get('show_categori_modified_time')) : ?>
				<dd class="field">
					<strong><?php echo JText::_('COM_VIDEOMANAGER_CATEGORIS_FIELD_MODIFIED_TIME_LABEL'); ?></strong>
					<?php
			...
			<?php if ($params->get('show_categori_modified_user_id')) : ?>
				<dd class="field">
					<strong><?php echo JText::_('COM_VIDEOMANAGER_CATEGORIS_FIELD_MODIFIED_USER_ID_LABEL'); ?></strong>
					<?php
			...
			<?php if ($params->get('show_categori_created_time')) : ?>
				<dd class="field">
					<strong><?php echo JText::_('COM_VIDEOMANAGER_CATEGORIS_FIELD_CREATED_TIME_LABEL'); ?></strong>
					<?php
			...
			<?php if ($params->get('show_categori_created_user_id')) : ?>
				<dd class="field">
					<strong><?php echo JText::_('COM_VIDEOMANAGER_CATEGORIS_FIELD_CREATED_USER_ID_LABEL'); ?></strong>
					<?php
			...
			<?php if ($params->get('show_categori_metadata')) : ?>
				<dd class="field">
					<strong><?php echo JText::_('COM_VIDEOMANAGER_CATEGORIS_FIELD_METADATA_LABEL'); ?></strong>
					<?php
			...
			<?php if ($params->get('show_categori_published')) : ?>
				<dd class="field">
					<strong><?php echo JText::_('COM_VIDEOMANAGER_CATEGORIS_FIELD_PUBLISHED_LABEL'); ?></strong>
					<?php
			...
			<?php if ($params->get('show_categori_note')) : ?>
				<dd class="field">
					<strong><?php echo JText::_('COM_VIDEOMANAGER_CATEGORIS_FIELD_NOTE_LABEL'); ?></strong>
					<?php
			...
			<?php if ($params->get('show_categori_title')) : ?>
				<dd class="field">
					<strong><?php echo JText::_('COM_VIDEOMANAGER_CATEGORIS_FIELD_TITLE_LABEL'); ?></strong>
					<?php
			...
			<?php if ($params->get('show_categori_extension')) : ?>
				<dd class="field">
					<strong><?php echo JText::_('COM_VIDEOMANAGER_CATEGORIS_FIELD_EXTENSION_LABEL'); ?></strong>
					<?php
			...
			<?php if ($params->get('show_categori_path')) : ?>
				<dd class="field">
					<strong><?php echo JText::_('COM_VIDEOMANAGER_CATEGORIS_FIELD_PATH_LABEL'); ?></strong>
					<?php
			...
			<?php if ($params->get('show_categori_level')) : ?>
				<dd class="field">
					<strong><?php echo JText::_('COM_VIDEOMANAGER_CATEGORIS_FIELD_LEVEL_LABEL'); ?></strong>
					<?php
			...
			<?php if ($params->get('show_categori_rgt')) : ?>
				<dd class="field">
					<strong><?php echo JText::_('COM_VIDEOMANAGER_CATEGORIS_FIELD_RGT_LABEL'); ?></strong>
					<?php
			...
			<?php if ($params->get('show_categori_lft')) : ?>
				<dd class="field">
					<strong><?php echo JText::_('COM_VIDEOMANAGER_CATEGORIS_FIELD_LFT_LABEL'); ?></strong>
					<?php
			...
			<?php if ($params->get('show_categori_parent_id')) : ?>
				<dd class="field">
					<strong><?php echo JText::_('COM_VIDEOMANAGER_CATEGORIS_FIELD_PARENT_ID_LABEL'); ?></strong>
					<?php
	...
	<?php elseif ($params->get('show_categori_noauth') AND $user->get('guest') ) : ?>
		<?php if (($params->get('show_categori_intro_image', '0') == '1' AND isset($images['intro_image_url']) AND $images['intro_image_url'] != "")): ?>	
			<div class="pull-<?php echo htmlspecialchars($params->get('show_categori_intro_image_float','right')); ?>">
				<?php 
		...
		<?php endif; ?>	
		<?php
			if ($params->get('show_categori_intro')) : 
		...
		<?php
			if ($params->get('show_categori_readmore')) :
