...
<div class="videomanager config-view<?php echo $params->get('pageclass_sfx')?>" itemscope itemtype="http://schema.org/CreativeWork">
	...
	<?php if ($params->get('show_config_hits') != '0' OR 
		($params->get('show_config_image', '0') == '1' AND isset($images['image_url']) AND $images['image_url'] != '')): ?>	
			<div class="pull-<?php echo htmlspecialchars($params->get('show_config_image_float','right')); ?>">
			<?php if ($params->get('show_config_image') == '1' AND isset($images['image_url']) AND $images['image_url'] != '') : ?>
					...
					/>
			<?php endif; ?>			 
			<?php if ($params->get('show_config_hits')) : ?>
	...
	<div style="clear:both; padding-top: 10px;">
		...
		<?php elseif ($params->get('show_config_noauth') == true AND  $user->get('guest') ) : ?>
			<?php if ($params->get('show_config_intro')) : ?>
				<span itemprop="description">
				<?php echo $this->item->intro; ?>
				</span>
			<?php endif; ?>	
			<?php //Optional link to let them register to see the whole config. ?>
			<?php if ($params->get('show_config_readmore')) :
	...
	<div style="padding-top: 10px;">
		...
		$display_fieldset = (
							...
							($params->get('show_config_publish_up')) OR
							($params->get('show_config_publish_down')) OR
			...
			<?php if ($params->get('show_config_tags')  == '1' AND !empty($this->item->tags) AND !empty($this->item->tags->itemTags)) : ?>
				<div class="formelm">
					<label>
			...
			<?php endif; ?>
			<?php if ($params->get('show_config_created_by') ) : ?>
				...
				<div class="formelm">				
					...
					<span itemprop="creator" itemscope itemtype="http://schema.org/Person">
						<?php if (!empty($this->item->created_by ) AND  $this->params->get('link_config_created_by') == 1):?>
							<?php echo JHtml::_(
									'link',
			...
			<?php endif; ?>	
			<?php if ($params->get('show_config_created_by_alias')) : ?>
			...
			<?php endif; ?>				
			<?php if ($params->get('show_config_created')) : ?>
				<div class="formelm">
					<label>
			...
			<?php endif; ?>
			<?php if ($params->get('show_config_modified')) : ?>
				<div class="formelm">
					<label>
			...
			<?php endif; ?>	
			<?php if ($params->get('show_config_publish_up')) : ?>
				<div class="formelm">
					<label>
			...
			<?php endif; ?>
			<?php if ($params->get('show_config_publish_down')) : ?>
				<div class="formelm">
					<label>
