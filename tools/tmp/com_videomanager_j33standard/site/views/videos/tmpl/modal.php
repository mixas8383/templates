 ...
 */
?>
<div class="videos-modal<?php echo $this->params->get('pageclass_sfx');?>">
	<h3><?php echo JText::_('COM_VIDEOMANAGER_VIDEOS_SELECT_ITEM_LABEL'); ?></h3>
	<form action="<?php echo JRoute::_('index.php?option=com_videomanager&view=videos&layout=modal&tmpl=component');?>" method="post" name="adminForm" id="adminForm">
