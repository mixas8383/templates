...
<div class="videomanager video-view<?php echo $params->get('pageclass_sfx')?>" itemscope itemtype="http://schema.org/CreativeWork">
	...
	<?php if ($params->get('show_video_hits') != '0' OR 
		($params->get('show_video_image', '0') == '1' AND isset($images['image_url']) AND $images['image_url'] != '')): ?>	
			<div class="pull-<?php echo htmlspecialchars($params->get('show_video_image_float','right')); ?>">
			<?php if ($params->get('show_video_image') == '1' AND isset($images['image_url']) AND $images['image_url'] != '') : ?>
					...
					/>
			<?php endif; ?>			 
			<?php if ($params->get('show_video_hits')) : ?>
	...
	<div style="clear:both; padding-top: 10px;">
		...
		<?php elseif ($params->get('show_video_noauth') == true AND  $user->get('guest') ) : ?>
			<?php if ($params->get('show_video_intro')) : ?>
				<span itemprop="description">
				<?php echo $this->item->intro; ?>
				</span>
			<?php endif; ?>	
			<?php //Optional link to let them register to see the whole video. ?>
			<?php if ($params->get('show_video_readmore')) :
	...
	<div style="padding-top: 10px;">
		<?php if ($params->get('access-view')) : ?>	
			...
			<form action="" name="videoForm" id="videoForm">
			<?php $dummy = false;
					$display_fieldset = (
			...
			<?php if ($display_fieldset) : ?>				
				<fieldset>	
					<legend><?php echo JText::_('COM_VIDEOMANAGER_VIDEOS_FIELDSET_BASIC_DETAILS_LABEL'); ?></legend>
			<?php endif; ?>
					<div style="padding-top: 10px;">			
						<?php if ($params->get('show_video_metadata')) : ?>
						<div class="formelm">
							<label>
								<?php echo JText::_('COM_VIDEOMANAGER_VIDEOS_FIELD_METADATA_LABEL'); ?>
							</label>
							<span>
								<?php
						...
						<div class="formelm">
							<label>
								<?php echo JText::_('COM_VIDEOMANAGER_VIDEOS_FIELD_PARENTID_LABEL'); ?>
							</label>
							<span>
								<?php
						...
						<div class="formelm">
							<label>
								<?php echo JText::_('COM_VIDEOMANAGER_VIDEOS_FIELD_ATTRIBS_LABEL'); ?>
							</label>
							<span>
								<?php
						...
						<div class="formelm">
							<label>
								<?php echo JText::_('COM_VIDEOMANAGER_VIDEOS_FIELD_MASK_LABEL'); ?>
							</label>
							<span>
								<?php
						...
						<div class="formelm">
							<label>
								<?php echo JText::_('COM_VIDEOMANAGER_VIDEOS_FIELD_SECTIONID_LABEL'); ?>
							</label>
							<span>
								<?php
						...
						<div class="formelm">
							<label>
								<?php echo JText::_('COM_VIDEOMANAGER_VIDEOS_FIELD_FULLTEXT_LABEL'); ?>
							</label>
							<span>
								<?php
						...
						<div class="formelm">
							<label>
								<?php echo JText::_('COM_VIDEOMANAGER_VIDEOS_FIELD_INTROTEXT_LABEL'); ?>
							</label>
							<span>
								<?php
						...
						<div class="formelm">
							<label>
								<?php echo JText::_('COM_VIDEOMANAGER_VIDEOS_FIELD_TITLE_ALIAS_LABEL'); ?>
							</label>
							<span>
								<?php
						...
						<div class="formelm">
							<label>
								<?php echo JText::_('COM_VIDEOMANAGER_VIDEOS_FIELD_TITLE_LABEL'); ?>
							</label>
							<span>
								<?php
		...
		$display_fieldset = (
							...
							($params->get('show_video_publish_up')) OR
							($params->get('show_video_publish_down')) OR
							($params->get('show_video_admin') AND $this->item->params->get('access-change')) OR							
							$dummy
							);
			?>
			<?php if ($display_fieldset) : ?>				
			...
			<?php if ($params->get('show_video_parent_category') AND $this->item->parent_slug != '1:root') : ?>
				...
				<div class="formelm">
					...
					<span>
						<?php if ($params->get('link_video_parent_category') AND $this->item->parent_slug) : ?>
							<?php $url = '<a href="'.JRoute::_(VideomanagerHelperRoute::getCategoryRoute($this->item->parent_slug, $params->get('keep_video_itemid'))).'" itemprop="url">'.$title.'</a>'; ?>
							<?php echo $url; ?>
						<?php else : ?>
							<?php echo $title; ?>
						<?php endif; ?>
			...
			<?php endif;?>	
			<?php if ($params->get('show_video_category')) : ?>
				...
				<div class="formelm">				
					...
					<span>
						<?php if ($params->get('link_video_category') AND $this->item->catslug) : ?>
							<?php $url = '<a href="'.JRoute::_(VideomanagerHelperRoute::getCategoryRoute($this->item->catslug, $params->get('keep_video_itemid'))).'" itemprop="url">'.$title.'</a>'; ?>
							<?php echo $url; ?>
						<?php else : ?>
							<?php echo $title; ?>
						<?php endif; ?>	
			...
			<?php endif; ?>						
			<?php if ($params->get('show_video_tags')  == '1' AND !empty($this->item->tags) AND !empty($this->item->tags->itemTags)) : ?>
				<div class="formelm">
					<label>
			...
			<?php endif; ?>
			<?php if ($params->get('show_video_created_by') ) : ?>
				...
				<div class="formelm">				
					...
					<span itemprop="creator" itemscope itemtype="http://schema.org/Person">
						<?php if (!empty($this->item->created_by ) AND  $this->params->get('link_video_created_by') == 1):?>
							<?php echo JHtml::_(
									'link',
			...
			<?php endif; ?>	
			<?php if ($params->get('show_video_created_by_alias')) : ?>
			...
			<?php endif; ?>				
			<?php if ($params->get('show_video_created')) : ?>
				<div class="formelm">
					<label>
			...
			<?php endif; ?>
			<?php if ($params->get('show_video_modified')) : ?>
				<div class="formelm">
					<label>
			...
			<?php endif; ?>	
			<?php if ($params->get('show_video_publish_up')) : ?>
				<div class="formelm">
					<label>
			...
			<?php endif; ?>
			<?php if ($params->get('show_video_publish_down')) : ?>
				<div class="formelm">
					<label>
			...
			<?php if ($params->get('access-change')): ?>
				<?php if ($params->get('show_video_admin')) : ?>
