...
/**
 * HTML View class for the Videomanager component
 *
 */
class VideomanagerViewCategory extends JViewLegacy
{
	protected $state;
	protected $category;
	protected $children;
	...
	public function display($tpl = null)
	{
		...
		$this->category->tags->getItemTags('com_videomanager.category', $this->category->id);
	...
	protected function prepareDocument()
	{
		...
		{
			$this->params->def('page_heading', JText::_('COM_VIDEOMANAGER_CATEGORY_HEADER'));
		}

		$id = (int) @$menu->query['id'];

		if ($menu AND ($menu->query['option'] != 'com_videomanager' OR
					 $menu->query['view'] == 'video' OR 
					 $id != $this->category->id))
		{
			$path = array(array('title' => $this->category->title, 'link' => ''));
			$category = $this->category->getParent();

			while (($menu->query['option'] != 'com_videomanager' OR
					$menu->query['view'] == 'video' OR
