...
$function	= $app->input->get('function', 'jSelectVideos');
 ...
 */
?>
<div class="videoses-modal<?php echo $this->params->get('pageclass_sfx');?>">
	<h3><?php echo JText::_('COM_VIDEOMANAGER_VIDEOSES_SELECT_ITEM_LABEL'); ?></h3>
	<form action="<?php echo JRoute::_('index.php?option=com_videomanager&view=videoses&layout=modal&tmpl=component');?>" method="post" name="adminForm" id="adminForm">
