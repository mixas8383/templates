...
<h2 itemprop="name">
		<?php if ($params->get('link_config_names') ) : ?>
			<a href="<?php echo JRoute::_(VideomanagerHelperRoute::getConfigRoute($this->item->slug, 
											$this->item->language,									
											$layout,									
...
<?php else : ?>
	...
	<?php if ($params->get('show_config_readmore')) :
			if ($params->get('access-view')) :
				$link = JRoute::_(VideomanagerHelperRoute::getConfigRoute($this->item->slug, 
																							$this->item->language,									
																							$layout,									
				...
				if ($params->get('show_config_noauth') AND $user->get('guest')) :
					...
					$return_url = JRoute::_(VideomanagerHelperRoute::getConfigRoute($this->item->slug, 
																								$this->item->language,									
																								$layout,									
																								$params->get('keep_config_itemid')));
