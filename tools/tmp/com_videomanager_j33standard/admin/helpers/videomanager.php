 ...
 *
 */
class VideomanagerHelper extends JHelperContent
{
	...
	{
		$config = JComponentHelper::getParams(JText::_('COM_VIDEOMANAGER_FIELD_CATEGORY_COMPONENT_DEFAULT'));
		$category_component = $config->get('category_component', JText::_('COM_VIDEOMANAGER_FIELD_CATEGORY_COMPONENT_DEFAULT'));	

		$active = $view_name == 'configs'? true : false;
		JHtmlSidebar::addEntry(
			JText::_('COM_VIDEOMANAGER_CONFIGS_SUBMENU'),
			'index.php?option=com_videomanager&view=configs',
			$view_name == 'configs',
			$active
		);
	
		$active = $view_name == 'videos'? true : false;
		JHtmlSidebar::addEntry(
			JText::_('COM_VIDEOMANAGER_VIDEOS_SUBMENU'),
			'index.php?option=com_videomanager&view=videos',
			$view_name == 'videos',
			$active
		);
	
		if ($category_component != JText::_('COM_VIDEOMANAGER_FIELD_CATEGORY_COMPONENT_NO_CATEGORIES'))
		{	
			$active = $view_name == 'categories'? true : false;
			
			JHtmlSidebar::addEntry(
				JText::_('COM_VIDEOMANAGER_CATEGORIES_SUBMENU'),
