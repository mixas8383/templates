 ...
 *
 * @CAversion		Id: component.php 408 2014-10-19 18:31:00Z BrianWade $
...
class JFormFieldComponent extends JFormFieldList
{
	...
	public function getOptions()
	{
		...
		$query->where($db->quoteName('a.name').' <> "'.JText::_('COM_VIDEOMANAGER_COMPONENT_NAME').'"');
		...
		array_unshift($options, JHtml::_('select.option', '0', JText::_('COM_VIDEOMANAGER_COMPONENT_NAME')));
		array_unshift($options, JHtml::_('select.option', '0', JText::_('COM_VIDEOMANAGER_FIELD_CATEGORY_COMPONENT_NO_CATEGORIES')));
		return $options;
	}
}
