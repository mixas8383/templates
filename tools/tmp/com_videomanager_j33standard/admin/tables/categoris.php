 ...
 *
 */
class VideomanagerTableCategoris extends JTable
{
	...
	public function __construct(&$db)
	{
		...
		parent::__construct('#__videomanager_categoris', 'id', $db);
		...
		JTableObserverTags::createObserver($this, array('typeAlias' => 'com_videomanager.categori'));

		JTableObserverContenthistory::createObserver($this, array('typeAlias' => 'com_videomanager.categori'));
	}
	...
	public function check()
	{
		...
		$table = JTable::getInstance('Categoris', 'VideomanagerTable');
	...
	public function store($update_nulls = false)
	{
		...
		if (empty($this->id))
		{
			// New Categori. A created and created_by field can be set by the user,
	...
	{
		$k = $this->_tbl_key;
		return 'com_videomanager.categori.'.(int) $this->$k;
	}
