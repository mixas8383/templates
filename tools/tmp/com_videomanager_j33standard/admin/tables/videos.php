 ...
 *
 */
class VideomanagerTableVideos extends JTable
{
	...
	public function __construct(&$db)
	{
		...
		parent::__construct('#__videomanager_videos', 'id', $db);
		...
		JTableObserverTags::createObserver($this, array('typeAlias' => 'com_videomanager.video'));

		JTableObserverContenthistory::createObserver($this, array('typeAlias' => 'com_videomanager.video'));
	}
	...
	public function check()
	{
		...
		$table = JTable::getInstance('Videos', 'VideomanagerTable');
	...
	public function store($update_nulls = false)
	{
		...
		if (empty($this->id))
		{
			// New Video. A created and created_by field can be set by the user,
	...
	{
		$k = $this->_tbl_key;
		return 'com_videomanager.video.'.(int) $this->$k;
	}
