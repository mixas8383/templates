 ...
 *
 */
class VideomanagerTableConfigs extends JTable
{
	...
	public function __construct(&$db)
	{
		...
		parent::__construct('#__videomanager_configs', 'id', $db);
		...
		JTableObserverTags::createObserver($this, array('typeAlias' => 'com_videomanager.config'));

		JTableObserverContenthistory::createObserver($this, array('typeAlias' => 'com_videomanager.config'));
	}
	...
	public function check()
	{
		...
		$table = JTable::getInstance('Configs', 'VideomanagerTable');
	...
	public function store($update_nulls = false)
	{
		...
		if (empty($this->id))
		{
			// New Config. A created and created_by field can be set by the user,
	...
	{
		$k = $this->_tbl_key;
		return 'com_videomanager.config.'.(int) $this->$k;
	}
