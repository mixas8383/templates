 ...
 *
 */
class VideomanagerTableVideoses extends JTable
{
	...
	public function __construct(&$db)
	{
		...
		parent::__construct('#__videomanager_videoses', 'id', $db);
		...
		JTableObserverTags::createObserver($this, array('typeAlias' => 'com_videomanager.videos'));

		JTableObserverContenthistory::createObserver($this, array('typeAlias' => 'com_videomanager.videos'));
	}
	...
	public function check()
	{
		...
		$table = JTable::getInstance('Videoses', 'VideomanagerTable');
	...
	public function store($update_nulls = false)
	{
		...
		if (empty($this->id))
		{
			// New Videos. A created and created_by field can be set by the user,
	...
	{
		$k = $this->_tbl_key;
		return 'com_videomanager.videos.'.(int) $this->$k;
	}
