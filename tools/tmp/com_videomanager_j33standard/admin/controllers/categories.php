...
class VideomanagerControllerCategories extends JControllerForm
{
	...
	protected function allowEdit($data = array(), $key = 'id')
	{
		...
		if ($user->authorise('core.edit', 'com_videomanager.categories.'.$record_id))
		{
			return true;
		}
		// Fallback on edit.own.
		// First test if the permission is available.
		if ($user->authorise('core.edit.own', 'com_videomanager.categories.'.$record_id))
		{
	...
	public function batch($model = null)
	{
		...
		// Set the model
		$model = $this->getModel('Categories', 'VideomanagerModel', array());

		// Preset the redirect
		$this->setRedirect(JRoute::_('index.php?option=com_videomanager&view=categorieses' . $this->getRedirectToListAppend(), false));
