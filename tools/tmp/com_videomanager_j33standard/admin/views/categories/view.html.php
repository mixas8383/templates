...
/**
 * View to edit a categories.
 *
 */
class VideomanagerViewCategories extends JViewLegacy
{
	protected $form;
	protected $item;
	protected $state;
	...
	public function display($tpl = null)
	{
		...
		$this->can_do = JHelperContent::getActions('com_videomanager', 'categories', $this->item->id);
	...
	protected function addToolbar()
	{
		...
		JToolbarHelper::title($is_new ? JText::_('COM_VIDEOMANAGER_CATEGORIESES_NEW_HEADER') : JText::_('COM_VIDEOMANAGER_CATEGORIESES_EDIT_HEADER'), 'categorieses.png');
		...
		if ($this->state->params->get('save_history', 1) AND $this->state->params->get('categories_save_history', 1)
			AND !$is_new  
			...
			)
		{
			...
			$type_alias = 'com_videomanager.categories';
