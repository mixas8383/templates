...
class VideomanagerViewVideos extends JViewLegacy
{
	...
	protected function addToolbar()
	{
		...
		JToolbarHelper::title(JText::_('COM_VIDEOMANAGER_VIDEOS_LIST_HEADER'), 'stack videos');
		...
		if ($this->can_do->get('core.edit.state') ) 
		{
			...
			if ($this->state->get('filter.state') != -1 ) 
			{
				...
				else 
				{
					if ($this->state->get('filter.state') == 2) 
					{
						JToolbarHelper::unarchiveList('videos.publish', 'JTOOLBAR_UNARCHIVE');
					}
				}
			}
		}
	...
	{	
		JHtmlSidebar::setAction('index.php?option=com_videomanager&view=videos');
