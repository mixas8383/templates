...
<form action="<?php echo JRoute::_('index.php?option=com_videomanager&view=config&layout=edit&id='.(int) $this->item->id); ?>" method="post" name="adminForm" id="config-form" class="form-validate">
	...
	<div class="form-horizontal">
		<?php echo JHtml::_('bootstrap.startTabSet', 'config-tabs', array('active' => 'details')); ?>
			<?php echo JHtml::_('bootstrap.addTab', 'config-tabs', 'details', JText::_('COM_VIDEOMANAGER_CONFIGS_FIELDSET_DETAILS_LABEL', true)); ?>
			<div class="row-fluid">
				<div class="span9">
			...
			<?php echo JHtml::_('bootstrap.addTab', 'config-tabs', 'publishing', JText::_('COM_VIDEOMANAGER_FIELDSET_PUBLISHING_LABEL', true)); ?>
			...
			<?php echo JHtml::_('bootstrap.addTab', 'config-tabs', 'imageslinks', JText::_('COM_VIDEOMANAGER_FIELDSET_IMAGES_URLS_LABEL', true)); ?>
			...
			<?php echo JHtml::_('bootstrap.addTab', 'config-tabs', 'metadata', JText::_('COM_VIDEOMANAGER_FIELDSET_METADATA_LABEL', true)); ?>
			<div class="row-fluid form-horizontal-desktop">
				<fieldset>
			...
			<?php if (isset($app->item_associations) AND JLanguageAssociations::isEnabled()) : ?>
				<?php echo JHtml::_('bootstrap.addTab', 'config-tabs', 'associations', JText::_('COM_VIDEOMANAGER_FIELDSET_ASSOCIATIONS_LABEL', true)); ?>
					<?php echo JLayoutHelper::render('joomla.edit.associations', $this); ?>
				<?php echo JHtml::_('bootstrap.endTab'); ?>
			<?php endif; ?>
			<?php if ($this->can_do->get('core.admin')) : ?>
				<?php echo JHtml::_('bootstrap.addTab', 'config-tabs', 'permissions', JText::_('COM_VIDEOMANAGER_CONFIGS_FIELDSET_RULES', true)); ?>
