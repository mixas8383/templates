...
?>
		...
		<table width="100%" align="center">
			<tr width="40%">
				<td class="key" align="right">
					<label for="title">
						<?php echo JText::_('COM_VIDEOMANAGER_PAGEBREAK_TITLE'); ?>
					</label>
				</td>
				<td>
			...
			<tr width="60%">
				<td class="key" align="right">
					<label for="alias">
						<?php echo JText::_('COM_VIDEOMANAGER__PAGEBREAK_TOC'); ?>
					</label>
				</td>
				<td>
		...
		<button onclick="insertPagebreak();"><?php echo JText::_('COM_VIDEOMANAGER_PAGEBREAK_INSERT_BUTTON'); ?></button>
