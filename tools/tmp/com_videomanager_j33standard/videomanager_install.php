 ...
 * @subpackage		com_videomanager.install
 * @copyright		
 ...
 */
class com_videomanagerInstallerScript
{
    /**
    ...
    function install($parent) 
    {
		...
		$install_html_file = __DIR__ . '/videomanager_install.html';
		...
		ob_start();            
		?>
		<div id="videomanagerinstall-info">
			<h1><?php echo JText::_('COM_VIDEOMANAGER_INSTALL_HEADER'); ?></h1>
			<div id="videomanagerinstall-intro">
				<?php echo JText::_('COM_VIDEOMANAGER_INSTALL_INTRO'); ?>
			</div>
			<table id="videomanagerinstall-table" class="adminlist">
				<thead class="videomanagerinstall-heading">
					<tr>
						<th colspan="3">
							<?php echo JText::_('COM_VIDEOMANAGER_INSTALL_HEADER');?>
						</th>
					</tr>
				</thead>
				<tbody>
					<tr class="videomanagerinstall-subheading">
						<th colspan="2">
							<?php echo JText::_('COM_VIDEOMANAGER_EXTENSION_HEADER');?>
						</th>
						<th width="50%">
							<?php echo JText::_('COM_VIDEOMANAGER_STATUS_HEADER');?>
						</th>					
					</tr>			
					<tr class="videomanagerinstall-row">
						<td  colspan="2">
							<?php echo JText::_('COM_VIDEOMANAGER');?>
						</td>
						<td class="videomanagerinstall-success">
							<?php echo JText::_('COM_VIDEOMANAGER_INSTALL_PACKAGE_SUCCESS');?>
						</td>
					</tr>
					<tr>				
						<td colspan="3">
							<?php echo JText::_('COM_VIDEOMANAGER_INSTALL_CORE_COMPONENT_SUCCESS');?>
						</td>
					</tr>
		<?php
		$buffer .= ob_get_clean();
		...
		if (count($manifest->plugins->plugin) > 0)
		{
			...
			<tr class="videomanagerinstall-subheading">
				<th>
					<?php echo JText::_('COM_VIDEOMANAGER_PLUGIN_HEADER');?>
				</th>
				<th>
					<?php echo JText::_('COM_VIDEOMANAGER_PLUGIN_GROUP_HEADER');?>
				</th>				
				<th width="50%">
					<?php echo JText::_('COM_VIDEOMANAGER_STATUS_HEADER');?>
				</th>					
 		...
 		if (count($manifest->modules->module) > 0)
		{
			...
			<tr class="videomanagerinstall-subheading">
				<th>
					<?php echo JText::_('COM_VIDEOMANAGER_MODULE_HEADER');?>
				</th>
				<th>
					<?php echo JText::_('COM_VIDEOMANAGER_MODULE_GROUP_HEADER');?>
				</th>				
				<th width="50%">
					<?php echo JText::_('COM_VIDEOMANAGER_STATUS_HEADER');?>
				</th>					
	...
	?>
				...
				<tfoot>
					<tr>
						<td colspan="3" text-align="center">
							<?php if ($install_error) : ?>
								<div id="videomanagerinstall-component-error">
									<?php echo JText::_('COM_VIDEOMANAGER_INSTALL_COMPONENT_ERROR'); ?>
								</div>			
							<?php else : ?>
								<div id="videomanagerinstall-component-success">
									<?php echo JText::_('COM_VIDEOMANAGER_INSTALL_COMPONENT_SUCCESS'); ?>
								</div>			
							<?php endif; ?>
						</td>
					</tr>
					<tr>
						<td colspan="3" text-align="center">
							<?php echo JText::_('COM_VIDEOMANAGER_JOOMLA_LOGO_DISCLAIMER'); ?>	
						</td>				
					</tr>					
				</tfoot>
			</table>					
    ...
    function uninstall($parent) 
    {
        ...
        $manifest = $parent->get("manifest");
        $parent = $parent->getParent();
		$uninstall_html_file = __DIR__ . '/videomanager_uninstall.html';
     ...
     ?>
	<div id="videomanagerinstall-info">
		<h1><?php echo JText::_('COM_VIDEOMANAGER_UNINSTALL_HEADER'); ?></h1>
			<table id="videomanagerinstall-table" class="adminlist">
				<thead class="videomanagerinstall-heading">
					<tr>
						<th colspan="3">
							<?php echo JText::_('COM_VIDEOMANAGER_UNINSTALL_HEADER');?>
						</th>
					</tr>
				</thead>
				<tbody>
					...
					<tr class="videomanagerinstall-row">
						...
						<td class="videomanagerinstall-success">
							<?php echo JText::_('COM_VIDEOMANAGER_UNINSTALL_PACKAGE_SUCCESS');?>
						</td>
					</tr>
	<?php
		$buffer .= ob_get_clean();  
		...
		JFolder::delete(JPATH_SITE.'/images/videomanager'); 
		JFolder::delete(JPATH_SITE.'/plugins/videomanager'); 

		$db->setQuery(
						'DELETE FROM '.$db->quoteName('#__content_types')
						.' WHERE '.$db->quoteName('type_alias').' = '.$db->quote('com_videomanager.config')
					 );

		$db->execute(); 
		$db->setQuery(
						'DELETE FROM '.$db->quoteName('#__content_types')
						.' WHERE '.$db->quoteName('type_alias').' = '.$db->quote('com_videomanager.video')
					 );
		...
		$db->setQuery(
						'DELETE FROM '.$db->quoteName('#__content_types')
						.' WHERE '.$db->quoteName('type_alias').' = '.$db->quote('com_videomanager.category')
					 );
				...
				<tfoot>
					<tr>
						<td colspan="3">
							<?php if ($install_error) : ?>
								<div id="videomanagerinstall-component-error">
									<?php echo JText::_('COM_VIDEOMANAGER_UNINSTALL_COMPONENT_ERROR'); ?>
								</div>			
							<?php else : ?>
								<div id="videomanagerinstall-component-success">
									<?php echo JText::_('COM_VIDEOMANAGER_UNINSTALL_COMPONENT_SUCCESS'); ?>
								</div>			
							<?php endif; ?>
						</td>
					</tr>
    ...
    function update($parent) 
    {
		...
		?>
		<div id="videomanagerinstall-info">
			<h1><?php echo JText::_('COM_VIDEOMANAGER_UPDATE_HEADER'); ?></h1>
			<table id="videomanagerinstall-table" class="adminlist">
				<thead class="videomanagerinstall-heading">
					<tr>
						<th colspan="3">
							<?php echo JText::_('COM_VIDEOMANAGER_UPDATE_HEADER');?>
						</th>
					</tr>
				</thead>
				<tbody>
					...
					<tr class="videomanagerinstall-row">
						...
						<td class="videomanagerinstall-success">
							<?php echo JText::_('COM_VIDEOMANAGER_UPDATE_PACKAGE_SUCCESS');?>
						</td>
					</tr>					
		<?php
		$buffer .= ob_get_clean();  
				...
				<tfoot>
					<tr>
						<td colspan="3">
							<?php if ($install_error) : ?>
								<div id="videomanagerinstall-component-error">
									<?php echo JText::_('COM_VIDEOMANAGER_UPDATE_COMPONENT_ERROR'); ?>
								</div>			
							<?php else : ?>
								<div id="videomanagerinstall-component-success">
									<?php echo JText::_('COM_VIDEOMANAGER_UPDATE_COMPONENT_SUCCESS'); ?>
								</div>			
							<?php endif; ?>
						</td>
					</tr>
    ...
    function preflight($type, $parent) 
    {
		...
		if( version_compare( $joomla_version->getShortVersion(), $this->minimum_joomla_release, 'lt' ) ) {
			Jerror::raiseWarning(null, JTEXT::sprintf('COM_VIDEOMANAGER_INSTALL_COMPONENT_ERROR_WRONG_JOOMLA_VERSION',$this->minimum_joomla_release));
			return false;
		}
		switch ($type)
		{
			...
			case 'update' :
				...
				{
					Jerror::raiseWarning(null, JTEXT::sprintf('COM_VIDEOMANAGER_UPDATE_COMPONENT_ERROR_WRONG_VERSION_SEQUENCE', $rel));
					return false;
				}			
			default :
				break; 
    ...
    function postflight($type, $parent) 
    {
		...
		{
			case 'install' :
				JFolder::create(JPATH_SITE.'/images/videomanager'); 
				JFile::copy('administrator/components/com_videomanager/index.html','images/videomanager/index.html', JPATH_SITE);
				
				// Make sure index.html files in all folders
				if (JFolder::exists(JPATH_SITE.'/plugins/videomanager') AND !JFile::exists(JPATH_SITE.'/plugins/videomanager/index.html'))
				{
					JFile::copy('administrator/components/com_videomanager/index.html','plugins/videomanager/index.html', JPATH_SITE);
				}	
				break;    				
			case 'update' :
				/*
	...
	private function getManifest()
	{
		...
		$query->from($db->quoteName('#__extensions'));	
		$query->where($db->quoteName('name').' = '.$db->quote('com_videomanager'));		
	...
	<tr class="videomanagerinstall-row">
		...
		<td class="videomanagerinstall-error">
			<div>
				<?php echo JText::_('COM_VIDEOMANAGER_'.strtoupper($action).'_PACKAGE_ERROR');?><br />
				<span class="videomanagerinstall-errormsg">
					<?php echo $msg; ?>
				</span>	
			</div>		
		</td>
    ...
    private function printSuccess($package, $group, $action)
    {
		...
		<tr class="videomanagerinstall-row">
			...
			<td class="videomanagerinstall-success">
				<div><?php echo JText::_('COM_VIDEOMANAGER_'.strtoupper($action).'_PACKAGE_SUCCESS');?></div>
			</td>
		</tr> 		
		<?php
            $out = ob_get_clean();
    ...
    private function populateUCM()
    {
		...
		$content_type['type_alias'] = 'com_videomanager.config';
		$content_type['table'] = '{"special":{"dbtable":"videomanager_configs","key":"id","type":"Configs","prefix":"VideomanagerTable","config":"array()"},';
		...
		$content_type['router'] = 'VideomanagerHelperRoute::getConfigRoute';

		$content_type['content_history_options'] = '{"formFile":"administrator\/components\/videomanager\/models\/forms\/config.xml",';
		...
		$db->execute(); 
		$content_type = array();
		$content_type['type_title'] = 'Video';
		$content_type['type_alias'] = 'com_videomanager.video';
		$content_type['table'] = '{"special":{"dbtable":"videomanager_videos","key":"id","type":"Videos","prefix":"VideomanagerTable","config":"array()"},';
		$content_type['table'] .= '"common":{"dbtable":"#__core_content","key":"ucm_id","type":"Corecontent","prefix":"JTable","config":"array()"}}';
		$content_type['rules'] = '';
		$content_type['field_mappings'] = '{"special":{},"common":{"core_content_item_id":"id",';
		$content_type['field_mappings'] .= '"core_title":"name",';
		...
		$content_type['field_mappings'] .= '"asset_id":"asset_id"';
		$content_type['field_mappings'] .= '}}';									
		$content_type['router'] = 'VideomanagerHelperRoute::getVideoRoute';

		$content_type['content_history_options'] = '{"formFile":"administrator\/components\/videomanager\/models\/forms\/video.xml",';
		$content_type['content_history_options'] .= '"hideFields":[';
		$content_type['content_history_options'] .= '"asset_id",';
		$content_type['content_history_options'] .= '"checked_out","checked_out_time",';
		$content_type['content_history_options'] .= '"version"],"ignoreChanges":[';
		...
		$content_type = array();
		$content_type['type_title'] = 'Videomanager Category';
		$content_type['type_alias'] = 'com_videomanager.category';
		...
		$content_type['router'] = 'VideomanagerHelperRoute::getCategoryRoute';
