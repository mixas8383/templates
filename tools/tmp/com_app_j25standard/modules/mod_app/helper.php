...
abstract class modAppHelper
{
	public static function getList(&$params)
	{
		...
		JModel::addIncludePath(JPATH_SITE.'/components/com_app/models', 'AppModel'.$component_object_names[1]);

		// Get an instance of the model
		$model = JModel::getInstance($component_object_names[1], 'AppModel', array('ignore_request' => true));
