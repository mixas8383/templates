 ...
 * @author			 ()
 * @package			com_app
 * @subpackage		com_app.finder.app.items
 * @copyright		
...
/**
 * Finder adapter for com_app - items
 *
 */
class plgFinderItems extends FinderIndexerAdapter
{
	...
	{
		// Make sure we're handling com_app categories
		if ($extension == 'com_app')
		{
	...
	public function onFinderAfterSave($context, $row, $is_new)
	{
		...
		if ($context == 'com_app.item' OR $context == 'com_app.itemform')
		{
	...
	protected function index(FinderIndexerResult $item, $format = 'html')
	{
		...
		$item->params = JComponentHelper::getParams('com_app', true);
		...
		$item->route = AppHelperRoute::getItemRoute($item->slug, $item->catslug, $item->language, $this->sub_layout);
	...
	protected function setup()
	{
		...
		include_once JPATH_SITE . '/components/com_app/helpers/route.php';
