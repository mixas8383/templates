...
<div class="app item-article<?php echo $params->get('pageclass_sfx')?>">
	...
	<?php if ($params->get('access-view')) : ?>	
		...
		<dd class="modified">
			<?php echo JText::sprintf('COM_APP_PUBLISH_DOWN_ON', JHTML::_('date',$this->item->publish_down, JText::_('DATE_FORMAT_LC2'))); ?>
		</dd>
		<?php endif; ?>
