...
class AppViewCategory extends JView
{
	...
	protected function _prepareDocument()
	{
		...
		{
			$this->params->def('page_heading', JText::_('COM_APP_CATEGORY_HEADER'));
		}

		$id = (int) @$menu->query['id'];

		if ($menu AND ($menu->query['option'] != 'com_app' OR
					 ...
					 $id != $this->category->id))
		{
			...
			while (($menu->query['option'] != 'com_app' OR
					$menu->query['view'] == 'item' OR
		...
		$this->document->addStyleSheet(JUri::root()."components/com_app/assets/css/".JString::strtolower(str_replace(' ','',$this->params->get('items_to_display'))).".css");
		$this->document->addStyleSheet(JUri::root()."components/com_app/assets/css/categories.css");
	
		if ($lang->isRTL())
		{
			$this->document->addStyleSheet(JUri::root()."components/com_app/assets/css/app-rtl.css");
			$this->document->addStyleSheet(JUri::root()."components/com_app/assets/css/".JString::strtolower(str_replace(' ','',$this->params->get('items_to_display')))."-rtl.css");
			$this->document->addStyleSheet(JUri::root()."components/com_app/assets/css/categories-rtl.css");
		}
