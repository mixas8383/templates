				...
				<fieldset class="filters">
					...
					<div class="ca-filter-search">
						<?php if ($this->params->get('item_filter_field') != '' AND $this->params->get('item_filter_field') != 'hide') :?>
							<label class="filter-search-lbl" for="filter_search"><?php echo JText::_('COM_APP_'.$this->params->get('item_filter_field').'_FILTER_LABEL').'&#160;'; ?></label>
							<input type="text" name="filter_search" id="filter_search" value="<?php echo $this->escape($this->state->get('filter.search')); ?>" class="inputbox" onchange="document.adminForm.submit();" title="<?php echo JText::_('COM_APP_FILTER_SEARCH_DESC'); ?>" />
							<button type="submit">
						...
						<select name="filter_category_id" class="inputbox" onchange="this.form.submit()">
							...
							<?php echo JHtml::_('select.options', JHtml::_('categoryapp.options', 'com_app'), 'value', 'text', $this->state->get('filter.category_id'));?>
						</select>
					</div>
