...
<fieldset class="adminform">
	<legend><?php echo JText::_('COM_APP_ITEM_BATCH_OPTIONS');?></legend>
	<p><?php echo JText::_('COM_APP_ITEM_BATCH_TIP'); ?></p>
	<ul>
		<li><?php echo JHtml::_('itembatch.access');?><li>
		<li><?php echo JHtml::_('itembatch.language'); ?></li>
	
		<li><?php echo JHtml::_('itembatch.category', 'com_app');?></li>
		<li><?php echo JHtml::_('itembatch.copy_items', 'com_app');?></li>
	</ul>	
