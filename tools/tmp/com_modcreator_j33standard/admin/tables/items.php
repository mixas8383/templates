 ...
 *
 */
class ModcreatorTableItems extends JTable
{
	...
	public function __construct(&$db)
	{
		...
		parent::__construct('#__modcreator_items', 'id', $db);
		...
		JTableObserverTags::createObserver($this, array('typeAlias' => 'com_modcreator.item'));

		JTableObserverContenthistory::createObserver($this, array('typeAlias' => 'com_modcreator.item'));
	}
	...
	public function check()
	{
		...
		$table = JTable::getInstance('Items', 'ModcreatorTable');
		if ($table->load(array('alias'=>$this->alias)) AND ($table->id != $this->id OR $this->id==0))
		{
			$this->setError(JText::_('COM_MODCREATOR_FIELD_ALIAS_DUPLICATED'));
			return false;
		}		
	...
	{
		$k = $this->_tbl_key;
		return 'com_modcreator.item.'.(int) $this->$k;
	}
	...
	protected function _getAssetParentId(JTable $table = null, $id = null)
	{
		...
		if ($asset->loadByName('com_modcreator'))
		{
			return $asset->id;
		}
		else
