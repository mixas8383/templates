 ...
 *
 */
class ModcreatorViewItems extends JViewLegacy
{
	protected $items;
	...
	public function display($tpl = null)
	{
		...
		$this->can_do = JHelperContent::getActions('com_modcreator');
	...
	protected function addToolbar()
	{
		...
		// Add a batch button
		if ($user->authorise('core.create', 'com_modcreator') AND $user->authorise('core.edit', 'com_modcreator') AND $user->authorise('core.edit.state', 'com_modcreator'))
		{
		...
		if ($user->authorise('core.admin', 'com_modcreator')) 
		{
	...
	{	
		JHtmlSidebar::setAction('index.php?option=com_modcreator&view=items');
	...
	protected function getSortFields()
	{
		return array(
			...
			'a.name' => JText::_('COM_MODCREATOR_FIELD_NAME_LABEL'),
			'a.state' => JText::_('COM_MODCREATOR_FIELD_STATUS_LABEL'),
			'access_level' => JText::_('JGRID_HEADING_ACCESS'),
			'a.created_by' => JText::_('COM_MODCREATOR_FIELD_CREATED_BY_LABEL'),
			'a.created' => JText::_('COM_MODCREATOR_FIELD_CREATED_LABEL'),
