 ...
 * @subpackage		com_modcreator.install
 * @copyright		
 ...
 */
class com_modcreatorInstallerScript
{
    /**
    ...
    function install($parent) 
    {
		...
		$install_html_file = __DIR__ . '/modcreator_install.html';
		...
		ob_start();            
		?>
		<div id="modcreatorinstall-info">
			<h1><?php echo JText::_('COM_MODCREATOR_INSTALL_HEADER'); ?></h1>
			<div id="modcreatorinstall-intro">
				<?php echo JText::_('COM_MODCREATOR_INSTALL_INTRO'); ?>
			</div>
			<table id="modcreatorinstall-table" class="adminlist">
				<thead class="modcreatorinstall-heading">
					<tr>
						<th colspan="3">
							<?php echo JText::_('COM_MODCREATOR_INSTALL_HEADER');?>
						</th>
					</tr>
				</thead>
				<tbody>
					<tr class="modcreatorinstall-subheading">
						<th colspan="2">
							<?php echo JText::_('COM_MODCREATOR_EXTENSION_HEADER');?>
						</th>
						<th width="50%">
							<?php echo JText::_('COM_MODCREATOR_STATUS_HEADER');?>
						</th>					
					</tr>			
					<tr class="modcreatorinstall-row">
						<td  colspan="2">
							<?php echo JText::_('COM_MODCREATOR');?>
						</td>
						<td class="modcreatorinstall-success">
							<?php echo JText::_('COM_MODCREATOR_INSTALL_PACKAGE_SUCCESS');?>
						</td>
					</tr>
					<tr>				
						<td colspan="3">
							<?php echo JText::_('COM_MODCREATOR_INSTALL_CORE_COMPONENT_SUCCESS');?>
						</td>
					</tr>
		<?php
		$buffer .= ob_get_clean();
		...
		if (count($manifest->plugins->plugin) > 0)
		{
			...
			<tr class="modcreatorinstall-subheading">
				<th>
					<?php echo JText::_('COM_MODCREATOR_PLUGIN_HEADER');?>
				</th>
				<th>
					<?php echo JText::_('COM_MODCREATOR_PLUGIN_GROUP_HEADER');?>
				</th>				
				<th width="50%">
					<?php echo JText::_('COM_MODCREATOR_STATUS_HEADER');?>
				</th>					
 		...
 		if (count($manifest->modules->module) > 0)
		{
			...
			<tr class="modcreatorinstall-subheading">
				<th>
					<?php echo JText::_('COM_MODCREATOR_MODULE_HEADER');?>
				</th>
				<th>
					<?php echo JText::_('COM_MODCREATOR_MODULE_GROUP_HEADER');?>
				</th>				
				<th width="50%">
					<?php echo JText::_('COM_MODCREATOR_STATUS_HEADER');?>
				</th>					
	...
	?>
				...
				<tfoot>
					<tr>
						<td colspan="3" text-align="center">
							<?php if ($install_error) : ?>
								<div id="modcreatorinstall-component-error">
									<?php echo JText::_('COM_MODCREATOR_INSTALL_COMPONENT_ERROR'); ?>
								</div>			
							<?php else : ?>
								<div id="modcreatorinstall-component-success">
									<?php echo JText::_('COM_MODCREATOR_INSTALL_COMPONENT_SUCCESS'); ?>
								</div>			
							<?php endif; ?>
						</td>
					</tr>
					<tr>
						<td colspan="3" text-align="center">
							<?php echo JText::_('COM_MODCREATOR_JOOMLA_LOGO_DISCLAIMER'); ?>	
						</td>				
					</tr>					
				</tfoot>
			</table>					
    ...
    function uninstall($parent) 
    {
        ...
        $manifest = $parent->get("manifest");
        $parent = $parent->getParent();
		$uninstall_html_file = __DIR__ . '/modcreator_uninstall.html';
     ...
     ?>
	<div id="modcreatorinstall-info">
		<h1><?php echo JText::_('COM_MODCREATOR_UNINSTALL_HEADER'); ?></h1>
			<table id="modcreatorinstall-table" class="adminlist">
				<thead class="modcreatorinstall-heading">
					<tr>
						<th colspan="3">
							<?php echo JText::_('COM_MODCREATOR_UNINSTALL_HEADER');?>
						</th>
					</tr>
				</thead>
				<tbody>
					...
					<tr class="modcreatorinstall-row">
						...
						<td class="modcreatorinstall-success">
							<?php echo JText::_('COM_MODCREATOR_UNINSTALL_PACKAGE_SUCCESS');?>
						</td>
					</tr>
	<?php
		$buffer .= ob_get_clean();  
		...
		JFolder::delete(JPATH_SITE.'/images/modcreator'); 
		JFolder::delete(JPATH_SITE.'/plugins/modcreator'); 

		$db->setQuery(
						'DELETE FROM '.$db->quoteName('#__content_types')
						.' WHERE '.$db->quoteName('type_alias').' = '.$db->quote('com_modcreator.item')
					 );
				...
				<tfoot>
					<tr>
						<td colspan="3">
							<?php if ($install_error) : ?>
								<div id="modcreatorinstall-component-error">
									<?php echo JText::_('COM_MODCREATOR_UNINSTALL_COMPONENT_ERROR'); ?>
								</div>			
							<?php else : ?>
								<div id="modcreatorinstall-component-success">
									<?php echo JText::_('COM_MODCREATOR_UNINSTALL_COMPONENT_SUCCESS'); ?>
								</div>			
							<?php endif; ?>
						</td>
					</tr>
    ...
    function update($parent) 
    {
		...
		?>
		<div id="modcreatorinstall-info">
			<h1><?php echo JText::_('COM_MODCREATOR_UPDATE_HEADER'); ?></h1>
			<table id="modcreatorinstall-table" class="adminlist">
				<thead class="modcreatorinstall-heading">
					<tr>
						<th colspan="3">
							<?php echo JText::_('COM_MODCREATOR_UPDATE_HEADER');?>
						</th>
					</tr>
				</thead>
				<tbody>
					...
					<tr class="modcreatorinstall-row">
						...
						<td class="modcreatorinstall-success">
							<?php echo JText::_('COM_MODCREATOR_UPDATE_PACKAGE_SUCCESS');?>
						</td>
					</tr>					
		<?php
		$buffer .= ob_get_clean();  
				...
				<tfoot>
					<tr>
						<td colspan="3">
							<?php if ($install_error) : ?>
								<div id="modcreatorinstall-component-error">
									<?php echo JText::_('COM_MODCREATOR_UPDATE_COMPONENT_ERROR'); ?>
								</div>			
							<?php else : ?>
								<div id="modcreatorinstall-component-success">
									<?php echo JText::_('COM_MODCREATOR_UPDATE_COMPONENT_SUCCESS'); ?>
								</div>			
							<?php endif; ?>
						</td>
					</tr>
    ...
    function preflight($type, $parent) 
    {
		...
		if( version_compare( $joomla_version->getShortVersion(), $this->minimum_joomla_release, 'lt' ) ) {
			Jerror::raiseWarning(null, JTEXT::sprintf('COM_MODCREATOR_INSTALL_COMPONENT_ERROR_WRONG_JOOMLA_VERSION',$this->minimum_joomla_release));
			return false;
		}
		switch ($type)
		{
			...
			case 'update' :
				...
				{
					Jerror::raiseWarning(null, JTEXT::sprintf('COM_MODCREATOR_UPDATE_COMPONENT_ERROR_WRONG_VERSION_SEQUENCE', $rel));
					return false;
				}			
			default :
				break; 
    ...
    function postflight($type, $parent) 
    {
		...
		{
			case 'install' :
				JFolder::create(JPATH_SITE.'/images/modcreator'); 
				JFile::copy('administrator/components/com_modcreator/index.html','images/modcreator/index.html', JPATH_SITE);
				
				// Make sure index.html files in all folders
				if (JFolder::exists(JPATH_SITE.'/plugins/modcreator') AND !JFile::exists(JPATH_SITE.'/plugins/modcreator/index.html'))
				{
					JFile::copy('administrator/components/com_modcreator/index.html','plugins/modcreator/index.html', JPATH_SITE);
				}	
				break;    				
			case 'update' :
				/*
	...
	private function getManifest()
	{
		...
		$query->from($db->quoteName('#__extensions'));	
		$query->where($db->quoteName('name').' = '.$db->quote('com_modcreator'));		
	...
	<tr class="modcreatorinstall-row">
		...
		<td class="modcreatorinstall-error">
			<div>
				<?php echo JText::_('COM_MODCREATOR_'.strtoupper($action).'_PACKAGE_ERROR');?><br />
				<span class="modcreatorinstall-errormsg">
					<?php echo $msg; ?>
				</span>	
			</div>		
		</td>
    ...
    private function printSuccess($package, $group, $action)
    {
		...
		<tr class="modcreatorinstall-row">
			...
			<td class="modcreatorinstall-success">
				<div><?php echo JText::_('COM_MODCREATOR_'.strtoupper($action).'_PACKAGE_SUCCESS');?></div>
			</td>
		</tr> 		
		<?php
            $out = ob_get_clean();
    ...
    private function populateUCM()
    {
		...
		$content_type['type_alias'] = 'com_modcreator.item';
		$content_type['table'] = '{"special":{"dbtable":"modcreator_items","key":"id","type":"Items","prefix":"ModcreatorTable","config":"array()"},';
		...
		$content_type['router'] = 'ModcreatorHelperRoute::getItemRoute';

		$content_type['content_history_options'] = '{"formFile":"administrator\/components\/modcreator\/models\/forms\/item.xml",';
