...
JModelLegacy::addIncludePath(JPATH_SITE.'/components/com_example/models', 'ExampleModelItems');
...
abstract class ModItemsHelper
{
	...
	public static function getList(&$params)
	{
		...
		$model = JModelLegacy::getInstance('Items', 'ExampleModel', array('ignore_request' => true));
