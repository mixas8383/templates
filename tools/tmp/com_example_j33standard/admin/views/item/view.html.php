...
class ExampleViewItem extends JViewLegacy
{
	...
	public function display($tpl = null)
	{
		if ($this->getLayout() == 'pagebreak')
		{
			...
			$document->setTitle(JText::_('COM_EXAMPLE_PAGEBREAK_DOC_TITLE'));
			$this->eName = &$eName;
			parent::display($tpl);
			return;
		}
		...
		$this->can_do = JHelperContent::getActions('com_example', 'item', $this->item->id);
