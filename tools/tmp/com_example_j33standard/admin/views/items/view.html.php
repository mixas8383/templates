...
class ExampleViewItems extends JViewLegacy
{
	...
	public function display($tpl = null)
	{
		...
		$this->can_do = JHelperContent::getActions('com_example', 'category', $this->state->get('filter.category_id'));
	...
	protected function addToolbar()
	{
		...
		JToolbarHelper::title(JText::_('COM_EXAMPLE_ITEMS_LIST_HEADER'), 'stack items');
		...
		// Add a batch button
		if ($user->authorise('core.create', 'com_example') AND $user->authorise('core.edit', 'com_example') AND $user->authorise('core.edit.state', 'com_example'))
		{
	...
	{	
		JHtmlSidebar::setAction('index.php?option=com_example&view=items');
	...
	protected function getSortFields()
	{
		return array(
			...
			'a.name' => JText::_('COM_EXAMPLE_FIELD_NAME_LABEL'),
			'category_title' => JText::_('JCATEGORY'),
			'a.state' => JText::_('COM_EXAMPLE_FIELD_STATUS_LABEL'),
			'access_level' => JText::_('JGRID_HEADING_ACCESS'),
			'a.created_by' => JText::_('COM_EXAMPLE_FIELD_CREATED_BY_LABEL'),
			'a.created' => JText::_('COM_EXAMPLE_FIELD_CREATED_LABEL'),
