...
<div class="example item-view<?php echo $params->get('pageclass_sfx')?>" itemscope itemtype="http://schema.org/CreativeWork">
	...
	<?php if ($params->get('show_item_hits') != '0' OR 
		($params->get('show_item_image', '0') == '1' AND isset($images['image_url']) AND $images['image_url'] != '')): ?>	
			...
			<?php if ($params->get('show_item_hits')) : ?>
				...
				<?php echo '<br />'.JText::sprintf('COM_EXAMPLE_HITS', $this->item->hits); ?>
			<?php endif; ?>	
		</div>
	<?php endif; ?>	
					...
					<a href="<?php echo $link; ?>" itemprop="url">
						...
						if ($this->item->item_alternative_readmore == null) :
							if ($params->get('show_item_readmore_name') == 0) :					
								echo JText::_('COM_EXAMPLE_REGISTER_TO_READ_MORE');
							else :
								echo JText::_('COM_EXAMPLE_REGISTER_TO_READMORE_NAME');
	...
	<div style="padding-top: 10px;">
		...
		$display_fieldset = (
			...
			<?php if ($display_fieldset) : ?>				
					<fieldset>
						<legend><?php echo JText::_('COM_EXAMPLE_FIELDSET_PUBLISHING_LABEL'); ?></legend>
			<?php endif; ?>
			...
			<?php if ($params->get('show_item_parent_category') AND $this->item->parent_slug != '1:root') : ?>
				...
				<div class="formelm">
					<label>
						<?php echo JText::_('COM_EXAMPLE_FIELD_PARENT_CATEGORY_LABEL'); ?>
					</label>
					<span>
						<?php if ($params->get('link_item_parent_category') AND $this->item->parent_slug) : ?>
							<?php $url = '<a href="'.JRoute::_(ExampleHelperRoute::getCategoryRoute($this->item->parent_slug, $params->get('keep_item_itemid'))).'" itemprop="url">'.$title.'</a>'; ?>
							<?php echo $url; ?>
						<?php else : ?>
							<?php echo $title; ?>
						<?php endif; ?>
			...
			<?php if ($params->get('show_item_category')) : ?>
				...
				<div class="formelm">				
					<label>
						<?php echo JText::_('COM_EXAMPLE_FIELD_CATEGORY_LABEL'); ?>
					</label>
					<span>
						<?php if ($params->get('link_item_category') AND $this->item->catslug) : ?>
							<?php $url = '<a href="'.JRoute::_(ExampleHelperRoute::getCategoryRoute($this->item->catslug, $params->get('keep_item_itemid'))).'" itemprop="url">'.$title.'</a>'; ?>
							<?php echo $url; ?>
						<?php else : ?>
							<?php echo $title; ?>
						<?php endif; ?>	
			...
			<?php if ($params->get('show_item_created_by') ) : ?>
				...
				<div class="formelm">				
					<label>
						<?php echo JText::_('COM_EXAMPLE_FIELD_CREATED_BY_LABEL'); ?> 
					</label>
			...
			<?php if ($params->get('show_item_created_by_alias')) : ?>
				<div class="formelm" itemprop="creator" itemscope itemtype="http://schema.org/Person">				
					<label>
						<?php echo JText::_('COM_EXAMPLE_FIELD_CREATED_BY_ALIAS_LABEL'); ?>
					</label>
			...
			<?php if ($params->get('show_item_created')) : ?>
				<div class="formelm">
					<label>
						<?php echo JText::_('COM_EXAMPLE_FIELD_CREATED_LABEL'); ?>
					</label>
			...
			<?php if ($params->get('show_item_modified')) : ?>
				<div class="formelm">
					<label>
						<?php echo JText::_('COM_EXAMPLE_FIELD_MODIFIED_LABEL'); ?>				
					</label>
			...
			<?php if ($params->get('show_item_publish_up')) : ?>
				<div class="formelm">
					<label>
						<?php echo JText::_('COM_EXAMPLE_FIELD_PUBLISH_UP_LABEL'); ?>				
					</label>
			...
			<?php if ($params->get('show_item_publish_down')) : ?>
				<div class="formelm">
					<label>
						<?php echo JText::_('COM_EXAMPLE_FIELD_PUBLISH_DOWN_LABEL'); ?>				
					</label>
			...
			<?php if ($params->get('access-change')): ?>
				<?php if ($params->get('show_item_admin')) : ?>
					...
					<div class="formelm">
						<label>
						<?php echo JText::_('COM_EXAMPLE_FIELD_STATUS_LABEL'); ?>
						</label>
						<span>
							<?php 
					...
					<div class="formelm">
						<label>
							<?php echo JText::_('COM_EXAMPLE_FIELD_FEATURED_LABEL'); ?>
						</label>
						<span>
							<?php 
					...
					<div class="formelm">
						<label>
							<?php echo JText::_('COM_EXAMPLE_FIELD_ACCESS_LABEL'); ?>
						</label>
						<span>
