...
/**
 * This models supports retrieving lists of example categories.
 *
 */
class ExampleModelCategories extends JModelList
{
	/**
	 ...
	 * @var		string
	 */
	public $_context = 'com_example.categories';
	 ...
	 * @var		string
	 */
	protected $_extension = 'com_example';
