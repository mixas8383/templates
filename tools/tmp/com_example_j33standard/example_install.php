...
class com_exampleInstallerScript
{
    ...
    function install($parent) 
    {
		...
		$install_html_file = __DIR__ . '/example_install.html';
    ...
    function uninstall($parent) 
    {
        ...
        $manifest = $parent->get("manifest");
        $parent = $parent->getParent();
		$uninstall_html_file = __DIR__ . '/example_uninstall.html';
	...
	<?php
		...
		$db->setQuery(
						...
						.' WHERE '.$db->quoteName('type_alias').' = '.$db->quote('com_example.item')
					 );
		...
		$db->setQuery(
						'DELETE FROM '.$db->quoteName('#__content_types')
						.' WHERE '.$db->quoteName('type_alias').' = '.$db->quote('com_example.category')
					 );
    ...
    private function populateUCM()
    {
		...
		$content_type['type_alias'] = 'com_example.item';
		$content_type['table'] = '{"special":{"dbtable":"example_items","key":"id","type":"Items","prefix":"ExampleTable","config":"array()"},';
		...
		$content_type['router'] = 'ExampleHelperRoute::getItemRoute';

		$content_type['content_history_options'] = '{"formFile":"administrator\/components\/example\/models\/forms\/item.xml",';
		...
		$content_type = array();
		$content_type['type_title'] = 'Example Category';
		$content_type['type_alias'] = 'com_example.category';
		...
		$content_type['router'] = 'ExampleHelperRoute::getCategoryRoute';
