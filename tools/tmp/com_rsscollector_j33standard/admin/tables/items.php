 ...
 *
 */
class RssCollectorTableItems extends JTable
{
	...
	public function __construct(&$db)
	{
		...
		parent::__construct('#__rsscollector_items', 'id', $db);
		...
		JTableObserverTags::createObserver($this, array('typeAlias' => 'com_rsscollector.item'));

		JTableObserverContenthistory::createObserver($this, array('typeAlias' => 'com_rsscollector.item'));
	}
	...
	public function check()
	{
		...
		$table = JTable::getInstance('Items', 'RssCollectorTable');
	...
	public function store($update_nulls = false)
	{
		...
		if (empty($this->id))
		{
			// New Item. A created and created_by field can be set by the user,
	...
	{
		$k = $this->_tbl_key;
		return 'com_rsscollector.item.'.(int) $this->$k;
	}
