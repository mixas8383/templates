 ...
 *
 */
class RssCollectorTableRssItemses extends JTable
{
	...
	public function __construct(&$db)
	{
		...
		parent::__construct('#__rsscollector_rssitemses', 'id', $db);
		...
		JTableObserverTags::createObserver($this, array('typeAlias' => 'com_rsscollector.rssitems'));

		JTableObserverContenthistory::createObserver($this, array('typeAlias' => 'com_rsscollector.rssitems'));
	}
	...
	public function check()
	{
		...
		$table = JTable::getInstance('RssItemses', 'RssCollectorTable');
	...
	public function store($update_nulls = false)
	{
		...
		if (empty($this->id))
		{
			// New Rss_items. A created and created_by field can be set by the user,
	...
	{
		$k = $this->_tbl_key;
		return 'com_rsscollector.rssitems.'.(int) $this->$k;
	}
