 ...
 * 
 */
abstract class JHtmlRssItemsBatch
{
	/**
	...
	public static function copy_items()
	{
		...
		$lines = array('<label id="batch-copy-items-lbl" for="batch-copy-items"  class="hasTip"'
			. ' title="' . JText::_('COM_RSSCOLLECTOR_RSSITEMSES_BATCH_COPY_ITEMS_LABEL') . '::' . JText::_('COM_RSSCOLLECTOR_RSSITEMSES_BATCH_COPY_ITEMS_DESC') . '">',
			 JText::_('COM_RSSCOLLECTOR_RSSITEMSES_BATCH_COPY_ITEMS_LABEL'), '</label>',
