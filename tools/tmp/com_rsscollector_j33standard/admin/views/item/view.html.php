...
class RssCollectorViewItem extends JViewLegacy
{
	...
	public function display($tpl = null)
	{
		...
		$this->can_do = JHelperContent::getActions('com_rsscollector', 'item', $this->item->id);
	...
	protected function addToolbar()
	{
		...
		JToolbarHelper::title($is_new ? JText::_('COM_RSSCOLLECTOR_ITEMS_NEW_HEADER') : JText::_('COM_RSSCOLLECTOR_ITEMS_EDIT_HEADER'), 'items.png');
			...
			)
		{
			...
			$type_alias = 'com_rsscollector.item';
