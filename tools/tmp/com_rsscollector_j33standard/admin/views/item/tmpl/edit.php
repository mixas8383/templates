...
<form action="<?php echo JRoute::_('index.php?option=com_rsscollector&view=item&layout=edit&id='.(int) $this->item->id); ?>" method="post" name="adminForm" id="item-form" class="form-validate">
	...
	<div class="form-horizontal">
		<?php echo JHtml::_('bootstrap.startTabSet', 'item-tabs', array('active' => 'details')); ?>
			<?php echo JHtml::_('bootstrap.addTab', 'item-tabs', 'details', JText::_('COM_RSSCOLLECTOR_ITEMS_FIELDSET_DETAILS_LABEL', true)); ?>
			<div class="row-fluid">
				<div class="span9">
				...
				<div class="span3">
					<fieldset class="form-vertical">
						...
						<?php endif; ?>
						<?php if ($this->item->version AND $params->get('save_history') AND $params->get('item_save_history')) : ?>
			...
			<?php echo JHtml::_('bootstrap.addTab', 'item-tabs', 'publishing', JText::_('COM_RSSCOLLECTOR_FIELDSET_PUBLISHING_LABEL', true)); ?>
			...
			<?php echo JHtml::_('bootstrap.addTab', 'item-tabs', 'imageslinks', JText::_('COM_RSSCOLLECTOR_FIELDSET_IMAGES_URLS_LABEL', true)); ?>
			...
			<?php foreach ($fieldsets as $name => $fieldset) :?>
				<?php echo JHtml::_('bootstrap.addTab', 'item-tabs', 'params-'.$name, JText::_($fieldset->label, true)); ?>
				<div class="row-fluid form-horizontal-desktop">
			...
			<?php echo JHtml::_('bootstrap.addTab', 'item-tabs', 'metadata', JText::_('COM_RSSCOLLECTOR_FIELDSET_METADATA_LABEL', true)); ?>
			<div class="row-fluid form-horizontal-desktop">
				<fieldset>
			...
			<?php if (isset($app->item_associations) AND JLanguageAssociations::isEnabled()) : ?>
				<?php echo JHtml::_('bootstrap.addTab', 'item-tabs', 'associations', JText::_('COM_RSSCOLLECTOR_FIELDSET_ASSOCIATIONS_LABEL', true)); ?>
					<?php echo JLayoutHelper::render('joomla.edit.associations', $this); ?>
				<?php echo JHtml::_('bootstrap.endTab'); ?>
			<?php endif; ?>
			<?php if ($this->can_do->get('core.admin')) : ?>
				<?php echo JHtml::_('bootstrap.addTab', 'item-tabs', 'permissions', JText::_('COM_RSSCOLLECTOR_ITEMS_FIELDSET_RULES', true)); ?>
