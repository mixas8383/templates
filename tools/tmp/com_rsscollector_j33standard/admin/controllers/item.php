 ...
 *
 */
class RssCollectorControllerItem extends JControllerForm
{
	/**
	...
	protected function allowEdit($data = array(), $key = 'id')
	{
		...
		if ($user->authorise('core.edit', 'com_rsscollector.item.'.$record_id))
		{
			return true;
		}
		// Fallback on edit.own.
		// First test if the permission is available.
		if ($user->authorise('core.edit.own', 'com_rsscollector.item.'.$record_id))
		{
	...
	public function batch($model = null)
	{
		...
		// Set the model
		$model = $this->getModel('Item', 'RssCollectorModel', array());

		// Preset the redirect
		$this->setRedirect(JRoute::_('index.php?option=com_rsscollector&view=items' . $this->getRedirectToListAppend(), false));
