...
require_once JPATH_ADMINISTRATOR.'/components/com_rsscollector/models/item.php';

class RssCollectorModelItemForm extends RssCollectorModelItem
{
	/**
	 ...
	 * @var		string
	 */
	protected $context = 'com_rsscollector.edit.item';
	/**
	...
	*/
	...
	public function getItem($item_id = null)
	{
		...
		$asset	= 'com_rsscollector.item.'.$item->id;
	...
	protected function loadFormData()
	{
		...
		$data = JFactory::getApplication()->getUserState('com_rsscollector.edit.item.data', array());
	...
	public function save($data)
	{
		...
		$result = $dispatcher->trigger('onItemBeforeSave', array('com_rsscollector.item', &$table, $is_new));
		...
		$dispatcher->trigger('onItemAfterSave', array('com_rsscollector.item', $table, $is_new));
