...
<div class="rsscollector item-view<?php echo $params->get('pageclass_sfx')?>" itemscope itemtype="http://schema.org/CreativeWork">
	...
	<?php if ($params->get('show_item_hits') != '0' OR 
		($params->get('show_item_image', '0') == '1' AND isset($images['image_url']) AND $images['image_url'] != '')): ?>	
			...
			<?php if ($params->get('show_item_hits')) : ?>
				...
				<?php echo '<br />'.JText::sprintf('COM_RSSCOLLECTOR_HITS', $this->item->hits); ?>
			<?php endif; ?>	
		</div>
	<?php endif; ?>	
					...
					<a href="<?php echo $link; ?>" itemprop="url">
						...
						if ($this->item->item_alternative_readmore == null) :
							if ($params->get('show_item_readmore_name') == 0) :					
								echo JText::_('COM_RSSCOLLECTOR_REGISTER_TO_READ_MORE');
							else :
								echo JText::_('COM_RSSCOLLECTOR_REGISTER_TO_READMORE_NAME');
	...
	<div style="padding-top: 10px;">
		<?php if ($params->get('access-view')) : ?>	
			...
			<?php if ($display_fieldset) : ?>				
				<fieldset>	
					<legend><?php echo JText::_('COM_RSSCOLLECTOR_ITEMS_FIELDSET_BASIC_DETAILS_LABEL'); ?></legend>
			<?php endif; ?>
					<div style="padding-top: 10px;">			
						<?php if ($params->get('show_item_metadata')) : ?>
						<div class="formelm">
							<label>
								<?php echo JText::_('COM_RSSCOLLECTOR_ITEMS_FIELD_METADATA_LABEL'); ?>
							</label>
							<span>
								<?php
						...
						<div class="formelm">
							<label>
								<?php echo JText::_('COM_RSSCOLLECTOR_ITEMS_FIELD_PARENTID_LABEL'); ?>
							</label>
							<span>
								<?php
						...
						<div class="formelm">
							<label>
								<?php echo JText::_('COM_RSSCOLLECTOR_ITEMS_FIELD_ATTRIBS_LABEL'); ?>
							</label>
							<span>
								<?php
						...
						<div class="formelm">
							<label>
								<?php echo JText::_('COM_RSSCOLLECTOR_ITEMS_FIELD_MASK_LABEL'); ?>
							</label>
							<span>
								<?php
						...
						<div class="formelm">
							<label>
								<?php echo JText::_('COM_RSSCOLLECTOR_ITEMS_FIELD_SECTIONID_LABEL'); ?>
							</label>
							<span>
								<?php
						...
						<div class="formelm">
							<label>
								<?php echo JText::_('COM_RSSCOLLECTOR_ITEMS_FIELD_FULLTEXT_LABEL'); ?>
							</label>
							<span>
								<?php
						...
						<div class="formelm">
							<label>
								<?php echo JText::_('COM_RSSCOLLECTOR_ITEMS_FIELD_INTROTEXT_LABEL'); ?>
							</label>
							<span>
								<?php
						...
						<div class="formelm">
							<label>
								<?php echo JText::_('COM_RSSCOLLECTOR_ITEMS_FIELD_TITLE_ALIAS_LABEL'); ?>
							</label>
							<span>
								<?php
						...
						<div class="formelm">
							<label>
								<?php echo JText::_('COM_RSSCOLLECTOR_ITEMS_FIELD_TITLE_LABEL'); ?>
							</label>
							<span>
								<?php
		...
		$display_fieldset = (
			...
			<?php if ($display_fieldset) : ?>				
					<fieldset>
						<legend><?php echo JText::_('COM_RSSCOLLECTOR_FIELDSET_PUBLISHING_LABEL'); ?></legend>
			<?php endif; ?>
			...
			<?php if ($params->get('show_item_created_by') ) : ?>
				...
				<div class="formelm">				
					<label>
						<?php echo JText::_('COM_RSSCOLLECTOR_FIELD_CREATED_BY_LABEL'); ?> 
					</label>
			...
			<?php if ($params->get('show_item_created_by_alias')) : ?>
				<div class="formelm" itemprop="creator" itemscope itemtype="http://schema.org/Person">				
					<label>
						<?php echo JText::_('COM_RSSCOLLECTOR_FIELD_CREATED_BY_ALIAS_LABEL'); ?>
					</label>
			...
			<?php if ($params->get('show_item_created')) : ?>
				<div class="formelm">
					<label>
						<?php echo JText::_('COM_RSSCOLLECTOR_FIELD_CREATED_LABEL'); ?>
					</label>
			...
			<?php if ($params->get('show_item_modified')) : ?>
				<div class="formelm">
					<label>
						<?php echo JText::_('COM_RSSCOLLECTOR_FIELD_MODIFIED_LABEL'); ?>				
					</label>
			...
			<?php if ($params->get('show_item_publish_up')) : ?>
				<div class="formelm">
					<label>
						<?php echo JText::_('COM_RSSCOLLECTOR_FIELD_PUBLISH_UP_LABEL'); ?>				
					</label>
			...
			<?php if ($params->get('show_item_publish_down')) : ?>
				<div class="formelm">
					<label>
						<?php echo JText::_('COM_RSSCOLLECTOR_FIELD_PUBLISH_DOWN_LABEL'); ?>				
					</label>
			...
			<?php if ($params->get('access-change')): ?>
				<?php if ($params->get('show_item_admin')) : ?>
					...
					<div class="formelm">
						<label>
						<?php echo JText::_('COM_RSSCOLLECTOR_FIELD_STATUS_LABEL'); ?>
						</label>
						<span>
							<?php 
					...
					<div class="formelm">
						<label>
							<?php echo JText::_('COM_RSSCOLLECTOR_FIELD_FEATURED_LABEL'); ?>
						</label>
						<span>
							<?php 
					...
					<div class="formelm">
						<label>
							<?php echo JText::_('COM_RSSCOLLECTOR_FIELD_ACCESS_LABEL'); ?>
						</label>
						<span>
