 ...
 *
 */
class RssCollectorControllerItems extends JControllerLegacy
{
	/**
	 ...
	 * 
	 */
	public function getModel($name = 'Items', $prefix = 'RssCollectorModel',$config = array('ignore_request' => true))
	{
