 ...
 * @subpackage		com_rsscollector.install
 * @copyright		
 ...
 */
class com_rsscollectorInstallerScript
{
    /**
    ...
    function install($parent) 
    {
		...
		$install_html_file = __DIR__ . '/rsscollector_install.html';
		...
		ob_start();            
		?>
		<div id="rsscollectorinstall-info">
			<h1><?php echo JText::_('COM_RSSCOLLECTOR_INSTALL_HEADER'); ?></h1>
			<div id="rsscollectorinstall-intro">
				<?php echo JText::_('COM_RSSCOLLECTOR_INSTALL_INTRO'); ?>
			</div>
			<table id="rsscollectorinstall-table" class="adminlist">
				<thead class="rsscollectorinstall-heading">
					<tr>
						<th colspan="3">
							<?php echo JText::_('COM_RSSCOLLECTOR_INSTALL_HEADER');?>
						</th>
					</tr>
				</thead>
				<tbody>
					<tr class="rsscollectorinstall-subheading">
						<th colspan="2">
							<?php echo JText::_('COM_RSSCOLLECTOR_EXTENSION_HEADER');?>
						</th>
						<th width="50%">
							<?php echo JText::_('COM_RSSCOLLECTOR_STATUS_HEADER');?>
						</th>					
					</tr>			
					<tr class="rsscollectorinstall-row">
						<td  colspan="2">
							<?php echo JText::_('COM_RSSCOLLECTOR');?>
						</td>
						<td class="rsscollectorinstall-success">
							<?php echo JText::_('COM_RSSCOLLECTOR_INSTALL_PACKAGE_SUCCESS');?>
						</td>
					</tr>
					<tr>				
						<td colspan="3">
							<?php echo JText::_('COM_RSSCOLLECTOR_INSTALL_CORE_COMPONENT_SUCCESS');?>
						</td>
					</tr>
		<?php
		$buffer .= ob_get_clean();
		...
		if (count($manifest->plugins->plugin) > 0)
		{
			...
			<tr class="rsscollectorinstall-subheading">
				<th>
					<?php echo JText::_('COM_RSSCOLLECTOR_PLUGIN_HEADER');?>
				</th>
				<th>
					<?php echo JText::_('COM_RSSCOLLECTOR_PLUGIN_GROUP_HEADER');?>
				</th>				
				<th width="50%">
					<?php echo JText::_('COM_RSSCOLLECTOR_STATUS_HEADER');?>
				</th>					
 		...
 		if (count($manifest->modules->module) > 0)
		{
			...
			<tr class="rsscollectorinstall-subheading">
				<th>
					<?php echo JText::_('COM_RSSCOLLECTOR_MODULE_HEADER');?>
				</th>
				<th>
					<?php echo JText::_('COM_RSSCOLLECTOR_MODULE_GROUP_HEADER');?>
				</th>				
				<th width="50%">
					<?php echo JText::_('COM_RSSCOLLECTOR_STATUS_HEADER');?>
				</th>					
	...
	?>
				...
				<tfoot>
					<tr>
						<td colspan="3" text-align="center">
							<?php if ($install_error) : ?>
								<div id="rsscollectorinstall-component-error">
									<?php echo JText::_('COM_RSSCOLLECTOR_INSTALL_COMPONENT_ERROR'); ?>
								</div>			
							<?php else : ?>
								<div id="rsscollectorinstall-component-success">
									<?php echo JText::_('COM_RSSCOLLECTOR_INSTALL_COMPONENT_SUCCESS'); ?>
								</div>			
							<?php endif; ?>
						</td>
					</tr>
					<tr>
						<td colspan="3" text-align="center">
							<?php echo JText::_('COM_RSSCOLLECTOR_JOOMLA_LOGO_DISCLAIMER'); ?>	
						</td>				
					</tr>					
				</tfoot>
			</table>					
    ...
    function uninstall($parent) 
    {
        ...
        $manifest = $parent->get("manifest");
        $parent = $parent->getParent();
		$uninstall_html_file = __DIR__ . '/rsscollector_uninstall.html';
     ...
     ?>
	<div id="rsscollectorinstall-info">
		<h1><?php echo JText::_('COM_RSSCOLLECTOR_UNINSTALL_HEADER'); ?></h1>
			<table id="rsscollectorinstall-table" class="adminlist">
				<thead class="rsscollectorinstall-heading">
					<tr>
						<th colspan="3">
							<?php echo JText::_('COM_RSSCOLLECTOR_UNINSTALL_HEADER');?>
						</th>
					</tr>
				</thead>
				<tbody>
					...
					<tr class="rsscollectorinstall-row">
						...
						<td class="rsscollectorinstall-success">
							<?php echo JText::_('COM_RSSCOLLECTOR_UNINSTALL_PACKAGE_SUCCESS');?>
						</td>
					</tr>
	<?php
		$buffer .= ob_get_clean();  
		...
		JFolder::delete(JPATH_SITE.'/images/rsscollector'); 
		JFolder::delete(JPATH_SITE.'/plugins/rsscollector'); 

		$db->setQuery(
						'DELETE FROM '.$db->quoteName('#__content_types')
						.' WHERE '.$db->quoteName('type_alias').' = '.$db->quote('com_rsscollector.item')
					 );
				...
				<tfoot>
					<tr>
						<td colspan="3">
							<?php if ($install_error) : ?>
								<div id="rsscollectorinstall-component-error">
									<?php echo JText::_('COM_RSSCOLLECTOR_UNINSTALL_COMPONENT_ERROR'); ?>
								</div>			
							<?php else : ?>
								<div id="rsscollectorinstall-component-success">
									<?php echo JText::_('COM_RSSCOLLECTOR_UNINSTALL_COMPONENT_SUCCESS'); ?>
								</div>			
							<?php endif; ?>
						</td>
					</tr>
    ...
    function update($parent) 
    {
		...
		?>
		<div id="rsscollectorinstall-info">
			<h1><?php echo JText::_('COM_RSSCOLLECTOR_UPDATE_HEADER'); ?></h1>
			<table id="rsscollectorinstall-table" class="adminlist">
				<thead class="rsscollectorinstall-heading">
					<tr>
						<th colspan="3">
							<?php echo JText::_('COM_RSSCOLLECTOR_UPDATE_HEADER');?>
						</th>
					</tr>
				</thead>
				<tbody>
					...
					<tr class="rsscollectorinstall-row">
						...
						<td class="rsscollectorinstall-success">
							<?php echo JText::_('COM_RSSCOLLECTOR_UPDATE_PACKAGE_SUCCESS');?>
						</td>
					</tr>					
		<?php
		$buffer .= ob_get_clean();  
				...
				<tfoot>
					<tr>
						<td colspan="3">
							<?php if ($install_error) : ?>
								<div id="rsscollectorinstall-component-error">
									<?php echo JText::_('COM_RSSCOLLECTOR_UPDATE_COMPONENT_ERROR'); ?>
								</div>			
							<?php else : ?>
								<div id="rsscollectorinstall-component-success">
									<?php echo JText::_('COM_RSSCOLLECTOR_UPDATE_COMPONENT_SUCCESS'); ?>
								</div>			
							<?php endif; ?>
						</td>
					</tr>
    ...
    function preflight($type, $parent) 
    {
		...
		if( version_compare( $joomla_version->getShortVersion(), $this->minimum_joomla_release, 'lt' ) ) {
			Jerror::raiseWarning(null, JTEXT::sprintf('COM_RSSCOLLECTOR_INSTALL_COMPONENT_ERROR_WRONG_JOOMLA_VERSION',$this->minimum_joomla_release));
			return false;
		}
		switch ($type)
		{
			...
			case 'update' :
				...
				{
					Jerror::raiseWarning(null, JTEXT::sprintf('COM_RSSCOLLECTOR_UPDATE_COMPONENT_ERROR_WRONG_VERSION_SEQUENCE', $rel));
					return false;
				}			
			default :
				break; 
    ...
    function postflight($type, $parent) 
    {
		...
		{
			case 'install' :
				JFolder::create(JPATH_SITE.'/images/rsscollector'); 
				JFile::copy('administrator/components/com_rsscollector/index.html','images/rsscollector/index.html', JPATH_SITE);
				
				// Make sure index.html files in all folders
				if (JFolder::exists(JPATH_SITE.'/plugins/rsscollector') AND !JFile::exists(JPATH_SITE.'/plugins/rsscollector/index.html'))
				{
					JFile::copy('administrator/components/com_rsscollector/index.html','plugins/rsscollector/index.html', JPATH_SITE);
				}	
				break;    				
			case 'update' :
				/*
	...
	private function getManifest()
	{
		...
		$query->from($db->quoteName('#__extensions'));	
		$query->where($db->quoteName('name').' = '.$db->quote('com_rsscollector'));		
	...
	<tr class="rsscollectorinstall-row">
		...
		<td class="rsscollectorinstall-error">
			<div>
				<?php echo JText::_('COM_RSSCOLLECTOR_'.strtoupper($action).'_PACKAGE_ERROR');?><br />
				<span class="rsscollectorinstall-errormsg">
					<?php echo $msg; ?>
				</span>	
			</div>		
		</td>
    ...
    private function printSuccess($package, $group, $action)
    {
		...
		<tr class="rsscollectorinstall-row">
			...
			<td class="rsscollectorinstall-success">
				<div><?php echo JText::_('COM_RSSCOLLECTOR_'.strtoupper($action).'_PACKAGE_SUCCESS');?></div>
			</td>
		</tr> 		
		<?php
            $out = ob_get_clean();
    ...
    private function populateUCM()
    {
		...
		$content_type['type_alias'] = 'com_rsscollector.item';
		$content_type['table'] = '{"special":{"dbtable":"rsscollector_items","key":"id","type":"Items","prefix":"RssCollectorTable","config":"array()"},';
		...
		$content_type['router'] = 'RssCollectorHelperRoute::getItemRoute';

		$content_type['content_history_options'] = '{"formFile":"administrator\/components\/rsscollector\/models\/forms\/item.xml",';
