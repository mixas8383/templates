...
class TeamViewItem extends JViewLegacy
{
	...
	public function display($tpl = null)
	{
		if ($this->getLayout() == 'pagebreak')
		{
			...
			$document->setTitle(JText::_('COM_TEAM_PAGEBREAK_DOC_TITLE'));
			$this->eName = &$eName;
			parent::display($tpl);
			return;
		}
		...
		$this->can_do = JHelperContent::getActions('com_team', 'item', $this->item->id);
	...
	protected function addToolbar()
	{
		...
		JToolbarHelper::title($is_new ? JText::_('COM_TEAM_ITEMS_NEW_HEADER') : JText::_('COM_TEAM_ITEMS_EDIT_HEADER'), 'items.png');
