 ...
 *
 */
class TeamViewItems extends JViewLegacy
{
	protected $items;
	...
	public function display($tpl = null)
	{
		...
		$this->can_do = JHelperContent::getActions('com_team', 'category', $this->state->get('filter.category_id'));
	...
	protected function addToolbar()
	{
		...
		JToolbarHelper::title(JText::_('COM_TEAM_ITEMS_LIST_HEADER'), 'stack items');
		...
		// Add a batch button
		if ($user->authorise('core.create', 'com_team') AND $user->authorise('core.edit', 'com_team') AND $user->authorise('core.edit.state', 'com_team'))
		{
	...
	{	
		JHtmlSidebar::setAction('index.php?option=com_team&view=items');
	...
	protected function getSortFields()
	{
		return array(
			...
			'a.name' => JText::_('COM_TEAM_FIELD_NAME_LABEL'),
			'category_title' => JText::_('JCATEGORY'),
			'a.state' => JText::_('COM_TEAM_FIELD_STATUS_LABEL'),
			'access_level' => JText::_('JGRID_HEADING_ACCESS'),
			'a.created_by' => JText::_('COM_TEAM_FIELD_CREATED_BY_LABEL'),
			'a.created' => JText::_('COM_TEAM_FIELD_CREATED_LABEL'),
