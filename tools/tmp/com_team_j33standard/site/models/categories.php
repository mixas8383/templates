...
/**
 * This models supports retrieving lists of team categories.
 *
 */
class TeamModelCategories extends JModelList
{
	/**
	 ...
	 * @var		string
	 */
	public $_context = 'com_team.categories';
