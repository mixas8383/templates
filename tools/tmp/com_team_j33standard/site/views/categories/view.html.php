...
class TeamViewCategories extends JViewLegacy
{
	...
	public function display($tpl = null)
	{
		...
		if ($children === false)
		{
			JError::raiseWarning(500, JText::_('COM_TEAM_ERROR_CATEGORY_NOT_FOUND'));
			return false;
		}

		if ($parent == false)
		{
			JError::raiseWarning(500, JText::_('COM_TEAM_ERROR_PARENT_CATEGORY_NOT_FOUND'));
			return false;
		}
	...
	protected function prepareDocument()
	{
		...
		{
			$this->params->def('page_heading', JText::_('COM_TEAM_CATEGORIES_HEADER'));
		}
