...
class com_teamInstallerScript
{
    ...
    function install($parent) 
    {
		...
		$install_html_file = __DIR__ . '/team_install.html';
		...
		ob_start();            
		?>
		<div id="teaminstall-info">
			<h1><?php echo JText::_('COM_TEAM_INSTALL_HEADER'); ?></h1>
			<div id="teaminstall-intro">
				<?php echo JText::_('COM_TEAM_INSTALL_INTRO'); ?>
			</div>
			<table id="teaminstall-table" class="adminlist">
				<thead class="teaminstall-heading">
					<tr>
						<th colspan="3">
							<?php echo JText::_('COM_TEAM_INSTALL_HEADER');?>
						</th>
					</tr>
				</thead>
				<tbody>
					<tr class="teaminstall-subheading">
						<th colspan="2">
							<?php echo JText::_('COM_TEAM_EXTENSION_HEADER');?>
						</th>
						<th width="50%">
							<?php echo JText::_('COM_TEAM_STATUS_HEADER');?>
						</th>					
					</tr>			
					<tr class="teaminstall-row">
						<td  colspan="2">
							<?php echo JText::_('COM_TEAM');?>
						</td>
						<td class="teaminstall-success">
							<?php echo JText::_('COM_TEAM_INSTALL_PACKAGE_SUCCESS');?>
						</td>
					</tr>
					<tr>				
						<td colspan="3">
							<?php echo JText::_('COM_TEAM_INSTALL_CORE_COMPONENT_SUCCESS');?>
						</td>
					</tr>
		<?php
		$buffer .= ob_get_clean();
		...
		if (count($manifest->plugins->plugin) > 0)
		{
			...
			<tr class="teaminstall-subheading">
				<th>
					<?php echo JText::_('COM_TEAM_PLUGIN_HEADER');?>
				</th>
				<th>
					<?php echo JText::_('COM_TEAM_PLUGIN_GROUP_HEADER');?>
				</th>				
				<th width="50%">
					<?php echo JText::_('COM_TEAM_STATUS_HEADER');?>
				</th>					
 		...
 		if (count($manifest->modules->module) > 0)
		{
			...
			<tr class="teaminstall-subheading">
				<th>
					<?php echo JText::_('COM_TEAM_MODULE_HEADER');?>
				</th>
				<th>
					<?php echo JText::_('COM_TEAM_MODULE_GROUP_HEADER');?>
				</th>				
				<th width="50%">
					<?php echo JText::_('COM_TEAM_STATUS_HEADER');?>
				</th>					
	...
	?>
				...
				<tfoot>
					<tr>
						<td colspan="3" text-align="center">
							<?php if ($install_error) : ?>
								<div id="teaminstall-component-error">
									<?php echo JText::_('COM_TEAM_INSTALL_COMPONENT_ERROR'); ?>
								</div>			
							<?php else : ?>
								<div id="teaminstall-component-success">
									<?php echo JText::_('COM_TEAM_INSTALL_COMPONENT_SUCCESS'); ?>
								</div>			
							<?php endif; ?>
						</td>
					</tr>
					<tr>
						<td colspan="3" text-align="center">
							<?php echo JText::_('COM_TEAM_JOOMLA_LOGO_DISCLAIMER'); ?>	
						</td>				
					</tr>					
				</tfoot>
			</table>					
    ...
    function uninstall($parent) 
    {
        ...
        $manifest = $parent->get("manifest");
        $parent = $parent->getParent();
		$uninstall_html_file = __DIR__ . '/team_uninstall.html';
     ...
     ?>
	<div id="teaminstall-info">
		<h1><?php echo JText::_('COM_TEAM_UNINSTALL_HEADER'); ?></h1>
			<table id="teaminstall-table" class="adminlist">
				<thead class="teaminstall-heading">
					<tr>
						<th colspan="3">
							<?php echo JText::_('COM_TEAM_UNINSTALL_HEADER');?>
						</th>
					</tr>
				</thead>
				<tbody>
					...
					<tr class="teaminstall-row">
						...
						<td class="teaminstall-success">
							<?php echo JText::_('COM_TEAM_UNINSTALL_PACKAGE_SUCCESS');?>
						</td>
					</tr>
	<?php
		$buffer .= ob_get_clean();  
		...
		JFolder::delete(JPATH_SITE.'/images/team'); 
		JFolder::delete(JPATH_SITE.'/plugins/team'); 

		$db->setQuery(
						'DELETE FROM '.$db->quoteName('#__content_types')
						.' WHERE '.$db->quoteName('type_alias').' = '.$db->quote('com_team.item')
					 );
		...
		$db->setQuery(
						'DELETE FROM '.$db->quoteName('#__content_types')
						.' WHERE '.$db->quoteName('type_alias').' = '.$db->quote('com_team.category')
					 );
				...
				<tfoot>
					<tr>
						<td colspan="3">
							<?php if ($install_error) : ?>
								<div id="teaminstall-component-error">
									<?php echo JText::_('COM_TEAM_UNINSTALL_COMPONENT_ERROR'); ?>
								</div>			
							<?php else : ?>
								<div id="teaminstall-component-success">
									<?php echo JText::_('COM_TEAM_UNINSTALL_COMPONENT_SUCCESS'); ?>
								</div>			
							<?php endif; ?>
						</td>
					</tr>
    ...
    function update($parent) 
    {
		...
		?>
		<div id="teaminstall-info">
			<h1><?php echo JText::_('COM_TEAM_UPDATE_HEADER'); ?></h1>
			<table id="teaminstall-table" class="adminlist">
				<thead class="teaminstall-heading">
					<tr>
						<th colspan="3">
							<?php echo JText::_('COM_TEAM_UPDATE_HEADER');?>
						</th>
					</tr>
				</thead>
				<tbody>
					...
					<tr class="teaminstall-row">
						...
						<td class="teaminstall-success">
							<?php echo JText::_('COM_TEAM_UPDATE_PACKAGE_SUCCESS');?>
						</td>
					</tr>					
		<?php
		$buffer .= ob_get_clean();  
				...
				<tfoot>
					<tr>
						<td colspan="3">
							<?php if ($install_error) : ?>
								<div id="teaminstall-component-error">
									<?php echo JText::_('COM_TEAM_UPDATE_COMPONENT_ERROR'); ?>
								</div>			
							<?php else : ?>
								<div id="teaminstall-component-success">
									<?php echo JText::_('COM_TEAM_UPDATE_COMPONENT_SUCCESS'); ?>
								</div>			
							<?php endif; ?>
						</td>
					</tr>
    ...
    function preflight($type, $parent) 
    {
		...
		if( version_compare( $joomla_version->getShortVersion(), $this->minimum_joomla_release, 'lt' ) ) {
			Jerror::raiseWarning(null, JTEXT::sprintf('COM_TEAM_INSTALL_COMPONENT_ERROR_WRONG_JOOMLA_VERSION',$this->minimum_joomla_release));
			return false;
		}
		switch ($type)
		{
			...
			case 'update' :
				...
				{
					Jerror::raiseWarning(null, JTEXT::sprintf('COM_TEAM_UPDATE_COMPONENT_ERROR_WRONG_VERSION_SEQUENCE', $rel));
					return false;
				}			
			default :
				break; 
    ...
    function postflight($type, $parent) 
    {
		...
		{
			case 'install' :
				JFolder::create(JPATH_SITE.'/images/team'); 
				JFile::copy('administrator/components/com_team/index.html','images/team/index.html', JPATH_SITE);
				
				// Make sure index.html files in all folders
				if (JFolder::exists(JPATH_SITE.'/plugins/team') AND !JFile::exists(JPATH_SITE.'/plugins/team/index.html'))
				{
					JFile::copy('administrator/components/com_team/index.html','plugins/team/index.html', JPATH_SITE);
				}	
				break;    				
			case 'update' :
				/*
	...
	private function getManifest()
	{
		...
		$query->from($db->quoteName('#__extensions'));	
		$query->where($db->quoteName('name').' = '.$db->quote('com_team'));		
	...
	<tr class="teaminstall-row">
		...
		<td class="teaminstall-error">
			<div>
				<?php echo JText::_('COM_TEAM_'.strtoupper($action).'_PACKAGE_ERROR');?><br />
				<span class="teaminstall-errormsg">
					<?php echo $msg; ?>
				</span>	
			</div>		
		</td>
    ...
    private function printSuccess($package, $group, $action)
    {
		...
		<tr class="teaminstall-row">
			...
			<td class="teaminstall-success">
				<div><?php echo JText::_('COM_TEAM_'.strtoupper($action).'_PACKAGE_SUCCESS');?></div>
			</td>
		</tr> 		
		<?php
            $out = ob_get_clean();
    ...
    private function populateUCM()
    {
		...
		$content_type['type_alias'] = 'com_team.item';
		$content_type['table'] = '{"special":{"dbtable":"team_items","key":"id","type":"Items","prefix":"TeamTable","config":"array()"},';
		...
		$content_type['router'] = 'TeamHelperRoute::getItemRoute';

		$content_type['content_history_options'] = '{"formFile":"administrator\/components\/team\/models\/forms\/item.xml",';
		...
		$content_type = array();
		$content_type['type_title'] = 'Team Category';
		$content_type['type_alias'] = 'com_team.category';
		...
		$content_type['router'] = 'TeamHelperRoute::getCategoryRoute';
