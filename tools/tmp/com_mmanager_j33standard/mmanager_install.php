 ...
 * @subpackage		com_mmanager.install
 * @copyright		
 ...
 */
class com_mmanagerInstallerScript
{
    /**
    ...
    function install($parent) 
    {
		...
		$install_html_file = __DIR__ . '/mmanager_install.html';
		...
		ob_start();            
		?>
		<div id="mmanagerinstall-info">
			<h1><?php echo JText::_('COM_MMANAGER_INSTALL_HEADER'); ?></h1>
			<div id="mmanagerinstall-intro">
				<?php echo JText::_('COM_MMANAGER_INSTALL_INTRO'); ?>
			</div>
			<table id="mmanagerinstall-table" class="adminlist">
				<thead class="mmanagerinstall-heading">
					<tr>
						<th colspan="3">
							<?php echo JText::_('COM_MMANAGER_INSTALL_HEADER');?>
						</th>
					</tr>
				</thead>
				<tbody>
					<tr class="mmanagerinstall-subheading">
						<th colspan="2">
							<?php echo JText::_('COM_MMANAGER_EXTENSION_HEADER');?>
						</th>
						<th width="50%">
							<?php echo JText::_('COM_MMANAGER_STATUS_HEADER');?>
						</th>					
					</tr>			
					<tr class="mmanagerinstall-row">
						<td  colspan="2">
							<?php echo JText::_('COM_MMANAGER');?>
						</td>
						<td class="mmanagerinstall-success">
							<?php echo JText::_('COM_MMANAGER_INSTALL_PACKAGE_SUCCESS');?>
						</td>
					</tr>
					<tr>				
						<td colspan="3">
							<?php echo JText::_('COM_MMANAGER_INSTALL_CORE_COMPONENT_SUCCESS');?>
						</td>
					</tr>
		<?php
		$buffer .= ob_get_clean();
		...
		if (count($manifest->plugins->plugin) > 0)
		{
			...
			<tr class="mmanagerinstall-subheading">
				<th>
					<?php echo JText::_('COM_MMANAGER_PLUGIN_HEADER');?>
				</th>
				<th>
					<?php echo JText::_('COM_MMANAGER_PLUGIN_GROUP_HEADER');?>
				</th>				
				<th width="50%">
					<?php echo JText::_('COM_MMANAGER_STATUS_HEADER');?>
				</th>					
 		...
 		if (count($manifest->modules->module) > 0)
		{
			...
			<tr class="mmanagerinstall-subheading">
				<th>
					<?php echo JText::_('COM_MMANAGER_MODULE_HEADER');?>
				</th>
				<th>
					<?php echo JText::_('COM_MMANAGER_MODULE_GROUP_HEADER');?>
				</th>				
				<th width="50%">
					<?php echo JText::_('COM_MMANAGER_STATUS_HEADER');?>
				</th>					
	...
	?>
				...
				<tfoot>
					<tr>
						<td colspan="3" text-align="center">
							<?php if ($install_error) : ?>
								<div id="mmanagerinstall-component-error">
									<?php echo JText::_('COM_MMANAGER_INSTALL_COMPONENT_ERROR'); ?>
								</div>			
							<?php else : ?>
								<div id="mmanagerinstall-component-success">
									<?php echo JText::_('COM_MMANAGER_INSTALL_COMPONENT_SUCCESS'); ?>
								</div>			
							<?php endif; ?>
						</td>
					</tr>
					<tr>
						<td colspan="3" text-align="center">
							<?php echo JText::_('COM_MMANAGER_JOOMLA_LOGO_DISCLAIMER'); ?>	
						</td>				
					</tr>					
				</tfoot>
			</table>					
    ...
    function uninstall($parent) 
    {
        ...
        $manifest = $parent->get("manifest");
        $parent = $parent->getParent();
		$uninstall_html_file = __DIR__ . '/mmanager_uninstall.html';
     ...
     ?>
	<div id="mmanagerinstall-info">
		<h1><?php echo JText::_('COM_MMANAGER_UNINSTALL_HEADER'); ?></h1>
			<table id="mmanagerinstall-table" class="adminlist">
				<thead class="mmanagerinstall-heading">
					<tr>
						<th colspan="3">
							<?php echo JText::_('COM_MMANAGER_UNINSTALL_HEADER');?>
						</th>
					</tr>
				</thead>
				<tbody>
					...
					<tr class="mmanagerinstall-row">
						...
						<td class="mmanagerinstall-success">
							<?php echo JText::_('COM_MMANAGER_UNINSTALL_PACKAGE_SUCCESS');?>
						</td>
					</tr>
	<?php
		$buffer .= ob_get_clean();  
		...
		JFolder::delete(JPATH_SITE.'/images/mmanager'); 
		JFolder::delete(JPATH_SITE.'/plugins/mmanager'); 

		$db->setQuery(
						'DELETE FROM '.$db->quoteName('#__content_types')
						.' WHERE '.$db->quoteName('type_alias').' = '.$db->quote('com_mmanager.edition')
					 );
		...
		$db->setQuery(
						'DELETE FROM '.$db->quoteName('#__content_types')
						.' WHERE '.$db->quoteName('type_alias').' = '.$db->quote('com_mmanager.category')
					 );
				...
				<tfoot>
					<tr>
						<td colspan="3">
							<?php if ($install_error) : ?>
								<div id="mmanagerinstall-component-error">
									<?php echo JText::_('COM_MMANAGER_UNINSTALL_COMPONENT_ERROR'); ?>
								</div>			
							<?php else : ?>
								<div id="mmanagerinstall-component-success">
									<?php echo JText::_('COM_MMANAGER_UNINSTALL_COMPONENT_SUCCESS'); ?>
								</div>			
							<?php endif; ?>
						</td>
					</tr>
    ...
    function update($parent) 
    {
		...
		?>
		<div id="mmanagerinstall-info">
			<h1><?php echo JText::_('COM_MMANAGER_UPDATE_HEADER'); ?></h1>
			<table id="mmanagerinstall-table" class="adminlist">
				<thead class="mmanagerinstall-heading">
					<tr>
						<th colspan="3">
							<?php echo JText::_('COM_MMANAGER_UPDATE_HEADER');?>
						</th>
					</tr>
				</thead>
				<tbody>
					...
					<tr class="mmanagerinstall-row">
						...
						<td class="mmanagerinstall-success">
							<?php echo JText::_('COM_MMANAGER_UPDATE_PACKAGE_SUCCESS');?>
						</td>
					</tr>					
		<?php
		$buffer .= ob_get_clean();  
				...
				<tfoot>
					<tr>
						<td colspan="3">
							<?php if ($install_error) : ?>
								<div id="mmanagerinstall-component-error">
									<?php echo JText::_('COM_MMANAGER_UPDATE_COMPONENT_ERROR'); ?>
								</div>			
							<?php else : ?>
								<div id="mmanagerinstall-component-success">
									<?php echo JText::_('COM_MMANAGER_UPDATE_COMPONENT_SUCCESS'); ?>
								</div>			
							<?php endif; ?>
						</td>
					</tr>
    ...
    function preflight($type, $parent) 
    {
		...
		if( version_compare( $joomla_version->getShortVersion(), $this->minimum_joomla_release, 'lt' ) ) {
			Jerror::raiseWarning(null, JTEXT::sprintf('COM_MMANAGER_INSTALL_COMPONENT_ERROR_WRONG_JOOMLA_VERSION',$this->minimum_joomla_release));
			return false;
		}
		switch ($type)
		{
			...
			case 'update' :
				...
				{
					Jerror::raiseWarning(null, JTEXT::sprintf('COM_MMANAGER_UPDATE_COMPONENT_ERROR_WRONG_VERSION_SEQUENCE', $rel));
					return false;
				}			
			default :
				break; 
    ...
    function postflight($type, $parent) 
    {
		...
		{
			case 'install' :
				JFolder::create(JPATH_SITE.'/images/mmanager'); 
				JFile::copy('administrator/components/com_mmanager/index.html','images/mmanager/index.html', JPATH_SITE);
				
				// Make sure index.html files in all folders
				if (JFolder::exists(JPATH_SITE.'/plugins/mmanager') AND !JFile::exists(JPATH_SITE.'/plugins/mmanager/index.html'))
				{
					JFile::copy('administrator/components/com_mmanager/index.html','plugins/mmanager/index.html', JPATH_SITE);
				}	
				break;    				
			case 'update' :
				/*
	...
	private function getManifest()
	{
		...
		$query->from($db->quoteName('#__extensions'));	
		$query->where($db->quoteName('name').' = '.$db->quote('com_mmanager'));		
	...
	<tr class="mmanagerinstall-row">
		...
		<td class="mmanagerinstall-error">
			<div>
				<?php echo JText::_('COM_MMANAGER_'.strtoupper($action).'_PACKAGE_ERROR');?><br />
				<span class="mmanagerinstall-errormsg">
					<?php echo $msg; ?>
				</span>	
			</div>		
		</td>
    ...
    private function printSuccess($package, $group, $action)
    {
		...
		<tr class="mmanagerinstall-row">
			...
			<td class="mmanagerinstall-success">
				<div><?php echo JText::_('COM_MMANAGER_'.strtoupper($action).'_PACKAGE_SUCCESS');?></div>
			</td>
		</tr> 		
		<?php
            $out = ob_get_clean();
    ...
    private function populateUCM()
    {
		...
		$content_type = array();
		$content_type['type_title'] = 'Edition';
		$content_type['type_alias'] = 'com_mmanager.edition';
		$content_type['table'] = '{"special":{"dbtable":"mmanager_editions","key":"id","type":"Editions","prefix":"MmanagerTable","config":"array()"},';
		...
		$content_type['router'] = 'MmanagerHelperRoute::getEditionRoute';

		$content_type['content_history_options'] = '{"formFile":"administrator\/components\/mmanager\/models\/forms\/edition.xml",';
		...
		$content_type = array();
		$content_type['type_title'] = 'Mmanager Category';
		$content_type['type_alias'] = 'com_mmanager.category';
		...
		$content_type['router'] = 'MmanagerHelperRoute::getCategoryRoute';
