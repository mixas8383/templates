...
/**
 * This models supports retrieving lists of mmanager categories.
 *
 */
class MmanagerModelCategories extends JModelList
{
	/**
	 ...
	 * @var		string
	 */
	public $_context = 'com_mmanager.categories';
	 ...
	 * @var		string
	 */
	protected $_extension = 'com_mmanager';
