...
if ($this->params->get('save_history') AND $this->params->get('issue_save_history'))
{
...
<div class="mmanager issue-edit<?php echo $this->escape($params->get('pageclass_sfx')); ?>">
		...
		<h2>
			<?php  
				if (!is_null($this->item->id)) :
					...
					echo JText::_('COM_MMANAGER_ISSUES_CREATE_ITEM');
				endif;
			?>
		</h2>
		</div>
	...
	<?php endif; ?>
	<form action="<?php echo JRoute::_('index.php?option=com_mmanager&view=issueform&id='.(int) $this->item->id); ?>" method="post" name="adminForm" id="issue-form" class="form-validate">
		<div class="btn-toolbar">
			...
			<?php if ($params->get('save_history') AND $params->get('issue_save_history')) : ?>
				<div class="btn-group">
		...
		<fieldset>
			<ul class="nav nav-tabs">
				<li class="active"><a href="#basic-details" data-toggle="tab"><?php echo JText::_('COM_MMANAGER_ISSUES_FIELDSET_DETAILS_LABEL');?></a></li>
			...
			<div class="tab-content">
				...
				<?php if ($this->item->params->get('access-change')): ?>
					<div class="tab-pane" id="publishing">
						...
						<?php else: ?>
							<div class="form-note">
								<p><?php echo JText::_('COM_MMANAGER_ISSUES_ORDERING'); ?></p>
							</div>
						<?php endif; ?>
					</div>	
				...
				<input type="hidden" name="form_id" id="form_id" value="issue-form" />
