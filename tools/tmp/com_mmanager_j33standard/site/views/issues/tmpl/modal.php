...
$function	= $app->input->get('function', 'jSelectIssue');
 ...
 */
?>
<div class="issues-modal<?php echo $this->params->get('pageclass_sfx');?>">
	<h3><?php echo JText::_('COM_MMANAGER_ISSUES_SELECT_ITEM_LABEL'); ?></h3>
	<form action="<?php echo JRoute::_('index.php?option=com_mmanager&view=issues&layout=modal&tmpl=component');?>" method="post" name="adminForm" id="adminForm">
