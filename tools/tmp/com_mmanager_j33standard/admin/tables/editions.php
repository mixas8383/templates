 ...
 *
 */
class MmanagerTableEditions extends JTable
{
	...
	public function __construct(&$db)
	{
		...
		parent::__construct('#__mmanager_editions', 'id', $db);
		...
		JTableObserverTags::createObserver($this, array('typeAlias' => 'com_mmanager.edition'));

		JTableObserverContenthistory::createObserver($this, array('typeAlias' => 'com_mmanager.edition'));
	}
	...
	public function check()
	{
		...
		$table = JTable::getInstance('Editions', 'MmanagerTable');
	...
	public function store($update_nulls = false)
	{
		...
		if (empty($this->id))
		{
			// New Edition. A created and created_by field can be set by the user,
	...
	{
		$k = $this->_tbl_key;
		return 'com_mmanager.edition.'.(int) $this->$k;
	}
	...
	protected function _getAssetParentId(JTable $table = null, $id = null)
	{
		...
		if (($this->catid) AND !empty($this->catid))
		{
			...
			if ($asset->loadByName('com_mmanager.category.' . (int) $this->catid))
			{
				return $asset->id;
			}
		}
