...
class MmanagerViewIssue extends JViewLegacy
{
	...
	public function display($tpl = null)
	{
		...
		$this->can_do = JHelperContent::getActions('com_mmanager', 'issue', $this->item->id);
	...
	protected function addToolbar()
	{
		...
		JToolbarHelper::title($is_new ? JText::_('COM_MMANAGER_ISSUES_NEW_HEADER') : JText::_('COM_MMANAGER_ISSUES_EDIT_HEADER'), 'issues.png');
		...
		if ($this->state->params->get('save_history', 1) AND $this->state->params->get('issue_save_history', 1)
			AND !$is_new  
