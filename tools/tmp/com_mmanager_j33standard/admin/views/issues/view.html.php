 ...
 *
 */
class MmanagerViewIssues extends JViewLegacy
{
	protected $items;
	...
	public function display($tpl = null)
	{
		...
		$this->can_do = JHelperContent::getActions('com_mmanager');
	...
	protected function addToolbar()
	{
		...
		JToolbarHelper::title(JText::_('COM_MMANAGER_ISSUES_LIST_HEADER'), 'stack issues');
		...
		if ($this->can_do->get('core.edit.state') ) 
		{
			...
			if ($this->state->get('filter.state') != -1 ) 
			{
				...
				else 
				{
					if ($this->state->get('filter.state') == 2) 
					{
						JToolbarHelper::unarchiveList('issues.publish', 'JTOOLBAR_UNARCHIVE');
					}
				}
			}
		}
	...
	{	
		JHtmlSidebar::setAction('index.php?option=com_mmanager&view=issues');
