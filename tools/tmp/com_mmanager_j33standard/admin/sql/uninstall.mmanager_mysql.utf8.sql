...
-- --------------------------------------------------------
--
-- Uninstall of `#__mmanager` tables
--
DROP TABLE IF EXISTS `#__mmanager_editions`;


DELETE FROM `#__assets` WHERE `name` LIKE '%com_mmanager%';

DELETE FROM `#__extensions` WHERE `name`='com_mmanager' AND `type`='component';

DELETE FROM `#__categories` WHERE `extension`='com_mmanager';
