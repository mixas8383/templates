	...
	<dl class="info">
		...
		<?php if ($params->get('show_item_parent_category') AND $this->item->parent_slug != '1:root') : ?>
			<dd class="parent-category-name">
				...
				<?php if ($params->get('link_item_parent_category') AND $this->item->parent_slug) : ?>
					...
					<?php echo JText::sprintf('COM_GAME_PARENT_CATEGORY', $url); ?>
				<?php else : ?>
					<?php echo JText::sprintf('COM_GAME_PARENT_CATEGORY', $title); ?>
				<?php endif; ?>
			</dd>
		<?php endif; ?>
		...
		<?php if ($params->get('show_item_category')) : ?>
			<dd class="category-name">
				...
				<?php if ($params->get('link_item_category') AND $this->item->catslug) : ?>
					...
					<?php echo JText::sprintf('COM_GAME_CATEGORY', $url); ?>
				<?php else : ?>
					<?php echo JText::sprintf('COM_GAME_CATEGORY', $title); ?>
				<?php endif; ?>
			</dd>
		<?php endif; ?>
		...
		<?php if ($params->get('show_item_created')) : ?>
			<dd class="create">
				...
				<time datetime="<?php echo JHtml::_('date', $this->item->created, 'c'); ?>" itemprop="dateCreated">
					<?php echo JText::sprintf('COM_GAME_CREATED_DATE_ON', JHtml::_('date',$this->item->created, JText::_('DATE_FORMAT_LC3'))); ?>
				</time>
			</dd>
		<?php endif; ?>
		<?php if ($params->get('show_item_publish_up') AND $this->item->publish_up > 0) : ?>
			<dd class="published">
				...
				<time datetime="<?php echo JHtml::_('date', $this->item->publish_up, 'c'); ?>" itemprop="datePublished">
					<?php echo JText::sprintf('COM_GAME_PUBLISH_UP_ON', JHtml::_('date',$this->item->publish_up, JText::_('DATE_FORMAT_LC3'))); ?>
				</time>
			</dd>
		<?php endif; ?>
		<?php if ($params->get('show_item_publish_down') AND $this->item->publish_down > 0) : ?>
			<dd class="published">
				...
				<time datetime="<?php echo JHtml::_('date', $this->item->publish_down, 'c'); ?>">
					<?php echo JText::sprintf('COM_GAME_PUBLISH_DOWN_ON', JHtml::_('date',$this->item->publish_down, JText::_('DATE_FORMAT_LC3'))); ?>
				</time
			</dd>
		<?php endif; ?>
		<?php if ($params->get('show_item_modified')) : ?>
			<dd class="modified">
				...
				<time datetime="<?php echo JHtml::_('date', $this->item->modified, 'c'); ?>" itemprop="dateModified">
					<?php echo JText::sprintf('COM_GAME_LAST_UPDATED', JHtml::_('date',$this->item->modified, JText::_('DATE_FORMAT_LC3'))); ?>
				</time>
			</dd>
		<?php endif; ?>
		<?php if ($params->get('show_item_hits')) : ?>
			<dd class="hits">
				...
				<?php echo JText::sprintf('COM_GAME_HITS', $this->item->hits); ?>
			</dd>
		<?php endif; ?>
	 </dl>
</div>