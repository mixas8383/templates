...
/**
 * This models supports retrieving lists of game categories.
 *
 */
class GameModelCategories extends JModelList
{
	/**
	 ...
	 * @var		string
	 */
	public $_context = 'com_game.categories';
