...
<div class="modal hide fade" id="collapseModal">
	<div class="modal-header">
		...
		<h3><?php echo JText::_('COM_GAME_ITEM_BATCH_OPTIONS');?></h3>
	</div>
	<div class="modal-body">
		<p><?php echo JText::_('COM_GAME_ITEM_BATCH_TIP'); ?></p>
		...
		<div class="control-group">
			<div class="controls">	
				<?php echo JHtml::_('itembatch.category', 'com_game');?>
			</div>
		</div>
		<div class="control-group">
			<div class="controls">
				<?php echo JHtml::_('itembatch.copy_items', 'com_game');?>
			</div>
		</div>
	</div>
