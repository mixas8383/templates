...
class GameViewItem extends JViewLegacy
{
	...
	public function display($tpl = null)
	{
		if ($this->getLayout() == 'pagebreak')
		{
			...
			$document->setTitle(JText::_('COM_GAME_PAGEBREAK_DOC_TITLE'));
			$this->eName = &$eName;
			parent::display($tpl);
			return;
		}
		...
		$this->can_do = JHelperContent::getActions('com_game', 'item', $this->item->id);
	...
	protected function addToolbar()
	{
		...
		JToolbarHelper::title($is_new ? JText::_('COM_GAME_ITEMS_NEW_HEADER') : JText::_('COM_GAME_ITEMS_EDIT_HEADER'), 'items.png');
		...
		if ($this->state->params->get('save_history', 1) AND $this->state->params->get('item_save_history', 1)
			AND !$is_new  
