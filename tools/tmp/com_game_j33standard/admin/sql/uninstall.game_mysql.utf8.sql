...
-- --------------------------------------------------------
--
-- Uninstall of `#__game` tables
--
DROP TABLE IF EXISTS `#__game_items`;

DROP TABLE IF EXISTS `#__game_rating`;

DELETE FROM `#__assets` WHERE `name` LIKE '%com_game%';

DELETE FROM `#__extensions` WHERE `name`='com_game' AND `type`='component';

DELETE FROM `#__categories` WHERE `extension`='com_game';
