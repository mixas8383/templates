 ...
 * @author			 ()
 * @package			com_game
 * @subpackage		com_game.finder.game.items
 * @copyright		
...
/**
 * Finder adapter for com_game - items
 *
 */
class PlgFinderItems extends FinderIndexerAdapter
{
	...
	{
		// Make sure we're handling com_game categories
		if ($extension == 'com_game')
		{
	...
	public function onFinderAfterSave($context, $row, $is_new)
	{
		...
		if ($context == 'com_game.item' OR $context == 'com_game.itemform')
		{
	...
	protected function index(FinderIndexerResult $item, $format = 'html')
	{
		...
		$item->params = JComponentHelper::getParams('com_game', true);
		...
		$item->route = GameHelperRoute::getItemRoute($item->slug, $item->catslug, $item->language, $this->sub_layout);
	...
	protected function setup()
	{
		...
		include_once JPATH_SITE . '/components/com_game/helpers/route.php';
