 ...
 * @author			 ()
 * @package			com_car
 * @subpackage		com_car.finder.car.drives
 * @copyright		
...
/**
 * Finder adapter for com_car - drives
 *
 */
class PlgFinderDrives extends FinderIndexerAdapter
{
	/**
	 * @var    $context	string	The plugin identifier.
	 */
	protected $context = 'Drives';

	/**
	 * @var    $extensionstring	The extension name.
	 */
	protected $extension = 'com_car';
	...
	{
		// We only want to handle drives here
		if ($context == 'com_car.drive' OR $context == 'com_car.driveform')
		{
	...
	protected function index(FinderIndexerResult $item, $format = 'html')
	{
		...
		$item->params = JComponentHelper::getParams('com_car', true);
		...
		$item->route = CarHelperRoute::getDriveRoute($item->slug, $item->language, $this->sub_layout);
	...
	protected function setup()
	{
		...
		include_once JPATH_SITE . '/components/com_car/helpers/route.php';
