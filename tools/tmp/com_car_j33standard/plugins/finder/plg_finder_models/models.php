 ...
 * @author			 ()
 * @package			com_car
 * @subpackage		com_car.finder.car.models
 * @copyright		
...
/**
 * Finder adapter for com_car - models
 *
 */
class PlgFinderModels extends FinderIndexerAdapter
{
	/**
	 * @var    $context	string	The plugin identifier.
	 */
	protected $context = 'Models';
	 ...
	 */
	protected $type_title = 'Models';

	/**
	 * @var    $table	string	The table name.
	 */
	protected $table = '#__car_models';
	...
	{
		// We only want to handle models here
		if ($context == 'com_car.model' OR $context == 'com_car.modelform')
		{
	...
	protected function index(FinderIndexerResult $item, $format = 'html')
	{
		...
		$item->route = CarHelperRoute::getModelRoute($item->slug, $item->language, $this->sub_layout);
