 ...
 * @author			 ()
 * @package			com_car
 * @subpackage		com_car.finder.car.cars
 * @copyright		
...
/**
 * Finder adapter for com_car - cars
 *
 */
class PlgFinderCars extends FinderIndexerAdapter
{
	...
	{
		// Make sure we're handling com_car categories
		if ($extension == 'com_car')
		{
	...
	public function onFinderAfterSave($context, $row, $is_new)
	{
		...
		if ($context == 'com_car.car' OR $context == 'com_car.carform')
		{
	...
	protected function index(FinderIndexerResult $item, $format = 'html')
	{
		...
		$item->route = CarHelperRoute::getCarRoute($item->slug, $item->catslug, $item->language, $this->sub_layout);
