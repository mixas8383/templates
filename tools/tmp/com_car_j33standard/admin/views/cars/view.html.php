...
class CarViewCars extends JViewLegacy
{
	...
	public function display($tpl = null)
	{
		...
		$this->can_do = JHelperContent::getActions('com_car', 'category', $this->state->get('filter.category_id'));
	...
	protected function addToolbar()
	{
		...
		JToolbarHelper::title(JText::_('COM_CAR_CARS_LIST_HEADER'), 'stack cars');
		...
		if ($this->can_do->get('core.edit.state')) 
		{
			JToolbarHelper::custom('cars.checkin', 'checkin.png', 'checkin_f2.png', 'JTOOLBAR_CHECKIN', true);
		}
	...
	{	
		JHtmlSidebar::setAction('index.php?option=com_car&view=cars');
