 ...
 *
 */
class CarTableModels extends JTable
{
	...
	public function __construct(&$db)
	{
		...
		parent::__construct('#__car_models', 'id', $db);
		...
		JTableObserverTags::createObserver($this, array('typeAlias' => 'com_car.model'));

		JTableObserverContenthistory::createObserver($this, array('typeAlias' => 'com_car.model'));
	}
	...
	public function check()
	{
		...
		$table = JTable::getInstance('Models', 'CarTable');
	...
	public function store($update_nulls = false)
	{
		...
		if (empty($this->id))
		{
			// New Model. A created and created_by field can be set by the user,
	...
	{
		$k = $this->_tbl_key;
		return 'com_car.model.'.(int) $this->$k;
	}
