 ...
 *
 */
class CarTableDrives extends JTable
{
	...
	public function __construct(&$db)
	{
		...
		parent::__construct('#__car_drives', 'id', $db);
		...
		JTableObserverTags::createObserver($this, array('typeAlias' => 'com_car.drive'));

		JTableObserverContenthistory::createObserver($this, array('typeAlias' => 'com_car.drive'));
	}
	...
	public function check()
	{
		...
		$table = JTable::getInstance('Drives', 'CarTable');
	...
	public function store($update_nulls = false)
	{
		...
		if (empty($this->id))
		{
			// New Drive. A created and created_by field can be set by the user,
	...
	{
		$k = $this->_tbl_key;
		return 'com_car.drive.'.(int) $this->$k;
	}
