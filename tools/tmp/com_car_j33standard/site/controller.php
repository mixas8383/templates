...
class CarController extends JControllerLegacy
{
	...
	public function display($cachable = false, $url_params = false)
	{
		...
		$safe_url_params = array(
			...
			'filter_drive_order'=>'CMD','filter_drive_order_Dir'=>'CMD','drive-filter-search'=>'STRING',
			'filter_model_order'=>'CMD','filter_model_order_Dir'=>'CMD','model-filter-search'=>'STRING',
