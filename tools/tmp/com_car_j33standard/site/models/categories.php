...
/**
 * This models supports retrieving lists of car categories.
 *
 */
class CarModelCategories extends JModelList
{
	/**
	 ...
	 * @var		string
	 */
	public $_context = 'com_car.categories';
