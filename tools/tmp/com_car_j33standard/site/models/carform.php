...
require_once JPATH_ADMINISTRATOR.'/components/com_car/models/car.php';

class CarModelCarForm extends CarModelCar
{
	/**
	 ...
	 * @var		string
	 */
	protected $context = 'com_car.edit.car';
	/**
	...
	protected function populateState()
	{
		...
		$this->setState('car.catid', $app->input->getInt('catid'));
	...
	*/
	 ...
	 *
	 * @param	integer	$item_id	The id of the car.
	 *
	...
	public function getItem($item_id = null)
	{
		...
		{
			// New item.
			$cat_id = (int) $this->getState('car.catid');
			if ($cat_id)
			{
				$item->params->set('access-change', $user->authorise('core.edit.state', 'com_car.category.'.$cat_id));
				$item->catid = $cat_id;
			}
			else 
			{
	...
	protected function loadFormData()
	{
		...
		$data = JFactory::getApplication()->getUserState('com_car.edit.car.data', array());
	...
	public function save($data)
	{
		...
		$result = $dispatcher->trigger('onCarBeforeSave', array('com_car.car', &$table, $is_new));
		...
		$dispatcher->trigger('onCarAfterSave', array('com_car.car', $table, $is_new));
