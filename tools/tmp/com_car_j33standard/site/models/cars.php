 ...
 *
 */
class CarModelCars extends JModelList
{
	/**
	...
	protected function populateState($ordering = null, $direction = null)
	{
		...
		$pk = $params->get('car_id', '') == '' ? $app->input->getInt('id', '') : $params->get('car_id');
		...
		// process show_car_noauth parameter
		if (!$params->get('show_car_noauth'))
		{
		...
		if ($params->get('filter_car_featured') <> "")
		{
			$this->setState('filter.featured', $params->get('filter_car_featured'));
	...
	protected function getStoreId($id = '')
	{
		...
		$id .= ':'.serialize($this->getState('filter.car_id'));
	...
	protected function getListQuery()
	{
		...
		if ((is_object($params)) AND ($params->get('show_car_filter_field') != 'hide') AND ($filter = $this->getState('filter.search')))
		{
			...
			switch ($params->get('show_car_filter_field'))
			{
				case 'hits':
	...
	public function getItems()
	{
		...
		if ($items = parent::getItems())
		{
			...
			foreach ($items as &$item)
			{
				...
				if ($access) 
				{
					// If the access filter has been set, we already have only the cars this user can view.
