...
<div class="car model-view<?php echo $params->get('pageclass_sfx')?>" itemscope itemtype="http://schema.org/CreativeWork">
	...
	<?php if ($params->get('show_model_hits') != '0' OR 
		($params->get('show_model_image', '0') == '1' AND isset($images['image_url']) AND $images['image_url'] != '')): ?>	
			<div class="pull-<?php echo htmlspecialchars($params->get('show_model_image_float','right')); ?>">
			<?php if ($params->get('show_model_image') == '1' AND isset($images['image_url']) AND $images['image_url'] != '') : ?>
	...
	<div style="clear:both; padding-top: 10px;">
		...
		<?php elseif ($params->get('show_model_noauth') == true AND  $user->get('guest') ) : ?>
			<?php if ($params->get('show_model_intro')) : ?>
				<span itemprop="description">
				<?php echo $this->item->intro; ?>
				</span>
			<?php endif; ?>	
			<?php //Optional link to let them register to see the whole model. ?>
			<?php if ($params->get('show_model_readmore')) :
	...
	<div style="padding-top: 10px;">
		...
		$display_fieldset = (
							...
							($params->get('show_model_publish_up')) OR
							($params->get('show_model_publish_down')) OR
							($params->get('show_model_admin') AND $this->item->params->get('access-change')) OR							
							$dummy
							);
			?>
			...
			<?php endif; ?>	
			<?php if ($params->get('show_model_publish_up')) : ?>
				<div class="formelm">
					<label>
			...
			<?php endif; ?>
			<?php if ($params->get('show_model_publish_down')) : ?>
				<div class="formelm">
					<label>
			...
			<?php if ($params->get('access-change')): ?>
				<?php if ($params->get('show_model_admin')) : ?>
