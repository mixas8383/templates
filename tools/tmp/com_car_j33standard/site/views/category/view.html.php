...
class CarViewCategory extends JViewLegacy
{
	...
	public function display($tpl = null)
	{
		...
		$this->category->tags->getItemTags('com_car.category', $this->category->id);
	...
	protected function prepareDocument()
	{
		...
		{
			$this->params->def('page_heading', JText::_('COM_CAR_CATEGORY_HEADER'));
		}

		$id = (int) @$menu->query['id'];

		if ($menu AND ($menu->query['option'] != 'com_car' OR
					 ...
					 $id != $this->category->id))
		{
			...
			while (($menu->query['option'] != 'com_car' OR
					$menu->query['view'] == 'car' OR
