...
?>
<dl class="drive-info">
	<dt class="drive-info-term"><?php  echo JText::_('COM_CAR_DRIVES_INFO'); ?></dt>
	<?php if ($params->get('show_drive_tags')) : ?>
		<?php 
			$this->item->tags = new JHelperTags;
			$this->item->tags->getItemTags('com_car.drive', $this->item->id);	
	...
	<?php endif; ?>	
	<?php if ($params->get('show_drive_hits') AND !empty($this->item->hits)) : ?>
			<dd class="hits">
