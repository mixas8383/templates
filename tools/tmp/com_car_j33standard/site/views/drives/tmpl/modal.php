 ...
 */
?>
<div class="drives-modal<?php echo $this->params->get('pageclass_sfx');?>">
	<h3><?php echo JText::_('COM_CAR_DRIVES_SELECT_ITEM_LABEL'); ?></h3>
	<form action="<?php echo JRoute::_('index.php?option=com_car&view=drives&layout=modal&tmpl=component');?>" method="post" name="adminForm" id="adminForm">
