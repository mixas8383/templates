...
?>
<dl class="model-info">
	<dt class="model-info-term"><?php  echo JText::_('COM_CAR_MODELS_INFO'); ?></dt>
	<?php if ($params->get('show_model_tags')) : ?>
		<?php 
			$this->item->tags = new JHelperTags;
			$this->item->tags->getItemTags('com_car.model', $this->item->id);	
	...
	<?php endif; ?>	
	<?php if ($params->get('show_model_hits') AND !empty($this->item->hits)) : ?>
			<dd class="hits">
