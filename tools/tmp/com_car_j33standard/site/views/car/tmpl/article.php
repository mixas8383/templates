...
$info		= $this->item->params->get('car_info_block_position', 0);
...
<div class="car car-article<?php echo $params->get('pageclass_sfx')?>" itemscope itemtype="http://schema.org/Article">
	...
	<?php if ($params->get('show_car_icons',-1) >= 0) : ?>
		<?php
			if ($params->get('show_car_print_icon') 
	...
	<?php if (($params->get('show_car_image', '0') == '1' AND isset($images['image_url']) AND $images['image_url'] != "")): ?>	
		<div class="pull-<?php echo htmlspecialchars($params->get('show_car_image_float','right')); ?>">
			<?php 
				...
				$display_width = (int) $params->get('show_car_image_width','100');
				$display_height = (int) $params->get('show_car_image_height','0');
	...
	<?php if ($params->get('access-view')) : ?>	
		...
		<dl class="info">
			<dt class="info-title"><?php  echo JText::_('COM_CAR_CARS_INFO'); ?></dt>
		<?php endif; ?>		
	...
	<?php elseif ($params->get('show_car_noauth') AND $user->get('guest') ) : ?>
		<?php if (($params->get('show_car_intro_image', '0') == '1' AND isset($images['intro_image_url']) AND $images['intro_image_url'] != "")): ?>	
			<div class="pull-<?php echo htmlspecialchars($params->get('show_car_intro_image_float','right')); ?>">
				<?php 
		...
		<?php
			if ($params->get('show_car_readmore')) :
