...
<div class="car car-view<?php echo $params->get('pageclass_sfx')?>" itemscope itemtype="http://schema.org/CreativeWork">
	...
	?>	
	<?php if ($params->get('show_car_icons',-1) >= 0) : ?>
	...
	<?php if ($params->get('show_car_hits') != '0' OR 
		($params->get('show_car_image', '0') == '1' AND isset($images['image_url']) AND $images['image_url'] != '')): ?>	
			<div class="pull-<?php echo htmlspecialchars($params->get('show_car_image_float','right')); ?>">
			<?php if ($params->get('show_car_image') == '1' AND isset($images['image_url']) AND $images['image_url'] != '') : ?>
					...
					<?php 
						...
						$display_width = (int) $params->get('show_car_intro_image_width','100');
						$display_height = (int) $params->get('show_car_intro_image_height','0');
	...
	<div style="clear:both; padding-top: 10px;">
		...
		<?php if ($params->get('access-view')) :?>
		<?php
			if (isset($this->item->urls) AND $params->get('show_car_urls') == '1' AND $params->get('show_car_urls_position')=='0') :
		...
		<?php elseif ($params->get('show_car_noauth') == true AND  $user->get('guest') ) : ?>
			<?php if ($params->get('show_car_intro')) : ?>
			...
			<?php if ($params->get('show_car_readmore')) :
				...
				<p class="readmore">
					<a href="<?php echo $link; ?>" itemprop="url">
						<?php
						if ($this->item->car_alternative_readmore == null) :
	...
	<div style="padding-top: 10px;">
		...
		$display_fieldset = (
							...
							($params->get('show_car_tags')) OR
							($params->get('show_car_created_by')) OR
							($params->get('show_car_created')) OR
							($params->get('show_car_modified')) OR
							($params->get('show_car_publish_up')) OR
							($params->get('show_car_publish_down')) OR
			...
			<?php if ($params->get('show_car_parent_category') AND $this->item->parent_slug != '1:root') : ?>
				...
				<div class="formelm">
					<label>
						<?php echo JText::_('COM_CAR_FIELD_PARENT_CATEGORY_LABEL'); ?>
					</label>
					<span>
						<?php if ($params->get('link_car_parent_category') AND $this->item->parent_slug) : ?>
							<?php $url = '<a href="'.JRoute::_(CarHelperRoute::getCategoryRoute($this->item->parent_slug, $params->get('keep_car_itemid'))).'" itemprop="url">'.$title.'</a>'; ?>
							<?php echo $url; ?>
						<?php else : ?>
							<?php echo $title; ?>
						<?php endif; ?>
			...
			<?php if ($params->get('show_car_category')) : ?>
				...
				<div class="formelm">				
					<label>
						<?php echo JText::_('COM_CAR_FIELD_CATEGORY_LABEL'); ?>
					</label>
					<span>
						<?php if ($params->get('link_car_category') AND $this->item->catslug) : ?>
							<?php $url = '<a href="'.JRoute::_(CarHelperRoute::getCategoryRoute($this->item->catslug, $params->get('keep_car_itemid'))).'" itemprop="url">'.$title.'</a>'; ?>
							<?php echo $url; ?>
						<?php else : ?>
							<?php echo $title; ?>
						<?php endif; ?>	
			...
			<?php endif; ?>						
			<?php if ($params->get('show_car_tags')  == '1' AND !empty($this->item->tags) AND !empty($this->item->tags->itemTags)) : ?>
				<div class="formelm">
					<label>
			...
			<?php endif; ?>
			<?php if ($params->get('show_car_created_by') ) : ?>
				...
				<div class="formelm">				
					...
					<span itemprop="creator" itemscope itemtype="http://schema.org/Person">
						<?php if (!empty($this->item->created_by ) AND  $this->params->get('link_car_created_by') == 1):?>
							<?php echo JHtml::_(
									'link',
			...
			<?php endif; ?>	
			<?php if ($params->get('show_car_created_by_alias')) : ?>
			...
			<?php endif; ?>				
			<?php if ($params->get('show_car_created')) : ?>
				<div class="formelm">
					<label>
			...
			<?php endif; ?>
			<?php if ($params->get('show_car_modified')) : ?>
				<div class="formelm">
					<label>
			...
			<?php endif; ?>	
			<?php if ($params->get('show_car_publish_up')) : ?>
				<div class="formelm">
					<label>
			...
			<?php endif; ?>
			<?php if ($params->get('show_car_publish_down')) : ?>
				<div class="formelm">
					<label>
			...
			<?php
				if (isset($this->item->urls) AND $params->get('show_car_urls') == '1' AND $params->get('show_car_urls_position')=='1') :
					echo $this->loadTemplate('urls');
				endif;
			?>	
			<?php if ($display_fieldset) : ?>				
