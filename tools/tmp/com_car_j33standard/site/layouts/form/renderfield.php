		...
		<?php if (!isset($displayData['options']['user'])) : ?>
			...
			<?php if (isset($displayData['options']['file']) AND $displayData['options']['file'] != '') : ?>
				<div class="button2-left">
					<div class="blank">
						<a title="<?php echo JText::_('COM_CAR_VIEW_FILE');?>" href="<?php echo JRoute::_(JUri::root().trim($displayData['options']['file']), false); ?>" target="_blank">
							<?php echo JText::_('COM_CAR_VIEW_FILE');?>
						</a>
					</div>
				</div>
			<?php endif; ?>	
