 ...
 * @subpackage		com_selectfile.install
 * @copyright		
 ...
 */
class com_selectfileInstallerScript
{
    /**
    ...
    function install($parent) 
    {
		...
		$install_html_file = __DIR__ . '/selectfile_install.html';
		...
		ob_start();            
		?>
		<div id="selectfileinstall-info">
			<h1><?php echo JText::_('COM_SELECTFILE_INSTALL_HEADER'); ?></h1>
			<div id="selectfileinstall-intro">
				<?php echo JText::_('COM_SELECTFILE_INSTALL_INTRO'); ?>
			</div>
			<table id="selectfileinstall-table" class="adminlist">
				<thead class="selectfileinstall-heading">
					<tr>
						<th colspan="3">
							<?php echo JText::_('COM_SELECTFILE_INSTALL_HEADER');?>
						</th>
					</tr>
				</thead>
				<tbody>
					<tr class="selectfileinstall-subheading">
						<th colspan="2">
							<?php echo JText::_('COM_SELECTFILE_EXTENSION_HEADER');?>
						</th>
						<th width="50%">
							<?php echo JText::_('COM_SELECTFILE_STATUS_HEADER');?>
						</th>					
					</tr>			
					<tr class="selectfileinstall-row">
						<td  colspan="2">
							<?php echo JText::_('COM_SELECTFILE');?>
						</td>
						<td class="selectfileinstall-success">
							<?php echo JText::_('COM_SELECTFILE_INSTALL_PACKAGE_SUCCESS');?>
						</td>
					</tr>
					<tr>				
						<td colspan="3">
							<?php echo JText::_('COM_SELECTFILE_INSTALL_CORE_COMPONENT_SUCCESS');?>
						</td>
					</tr>
		<?php
		$buffer .= ob_get_clean();
		...
		if (count($manifest->plugins->plugin) > 0)
		{
			...
			<tr class="selectfileinstall-subheading">
				<th>
					<?php echo JText::_('COM_SELECTFILE_PLUGIN_HEADER');?>
				</th>
				<th>
					<?php echo JText::_('COM_SELECTFILE_PLUGIN_GROUP_HEADER');?>
				</th>				
				<th width="50%">
					<?php echo JText::_('COM_SELECTFILE_STATUS_HEADER');?>
				</th>					
 		...
 		if (count($manifest->modules->module) > 0)
		{
			...
			<tr class="selectfileinstall-subheading">
				<th>
					<?php echo JText::_('COM_SELECTFILE_MODULE_HEADER');?>
				</th>
				<th>
					<?php echo JText::_('COM_SELECTFILE_MODULE_GROUP_HEADER');?>
				</th>				
				<th width="50%">
					<?php echo JText::_('COM_SELECTFILE_STATUS_HEADER');?>
				</th>					
	...
	?>
				...
				<tfoot>
					<tr>
						<td colspan="3" text-align="center">
							<?php if ($install_error) : ?>
								<div id="selectfileinstall-component-error">
									<?php echo JText::_('COM_SELECTFILE_INSTALL_COMPONENT_ERROR'); ?>
								</div>			
							<?php else : ?>
								<div id="selectfileinstall-component-success">
									<?php echo JText::_('COM_SELECTFILE_INSTALL_COMPONENT_SUCCESS'); ?>
								</div>			
							<?php endif; ?>
						</td>
					</tr>
					<tr>
						<td colspan="3" text-align="center">
							<?php echo JText::_('COM_SELECTFILE_JOOMLA_LOGO_DISCLAIMER'); ?>	
						</td>				
					</tr>					
				</tfoot>
			</table>					
    ...
    function uninstall($parent) 
    {
        ...
        $manifest = $parent->get("manifest");
        $parent = $parent->getParent();
		$uninstall_html_file = __DIR__ . '/selectfile_uninstall.html';
     ...
     ?>
	<div id="selectfileinstall-info">
		<h1><?php echo JText::_('COM_SELECTFILE_UNINSTALL_HEADER'); ?></h1>
			<table id="selectfileinstall-table" class="adminlist">
				<thead class="selectfileinstall-heading">
					<tr>
						<th colspan="3">
							<?php echo JText::_('COM_SELECTFILE_UNINSTALL_HEADER');?>
						</th>
					</tr>
				</thead>
				<tbody>
					...
					<tr class="selectfileinstall-row">
						...
						<td class="selectfileinstall-success">
							<?php echo JText::_('COM_SELECTFILE_UNINSTALL_PACKAGE_SUCCESS');?>
						</td>
					</tr>
	<?php
		$buffer .= ob_get_clean();  
		...
		JFolder::delete(JPATH_SITE.'/images/selectfile'); 
		JFolder::delete(JPATH_SITE.'/plugins/selectfile'); 

		$db->setQuery(
						'DELETE FROM '.$db->quoteName('#__content_types')
						.' WHERE '.$db->quoteName('type_alias').' = '.$db->quote('com_selectfile.size')
					 );
				...
				<tfoot>
					<tr>
						<td colspan="3">
							<?php if ($install_error) : ?>
								<div id="selectfileinstall-component-error">
									<?php echo JText::_('COM_SELECTFILE_UNINSTALL_COMPONENT_ERROR'); ?>
								</div>			
							<?php else : ?>
								<div id="selectfileinstall-component-success">
									<?php echo JText::_('COM_SELECTFILE_UNINSTALL_COMPONENT_SUCCESS'); ?>
								</div>			
							<?php endif; ?>
						</td>
					</tr>
    ...
    function update($parent) 
    {
		...
		?>
		<div id="selectfileinstall-info">
			<h1><?php echo JText::_('COM_SELECTFILE_UPDATE_HEADER'); ?></h1>
			<table id="selectfileinstall-table" class="adminlist">
				<thead class="selectfileinstall-heading">
					<tr>
						<th colspan="3">
							<?php echo JText::_('COM_SELECTFILE_UPDATE_HEADER');?>
						</th>
					</tr>
				</thead>
				<tbody>
					...
					<tr class="selectfileinstall-row">
						...
						<td class="selectfileinstall-success">
							<?php echo JText::_('COM_SELECTFILE_UPDATE_PACKAGE_SUCCESS');?>
						</td>
					</tr>					
		<?php
		$buffer .= ob_get_clean();  
				...
				<tfoot>
					<tr>
						<td colspan="3">
							<?php if ($install_error) : ?>
								<div id="selectfileinstall-component-error">
									<?php echo JText::_('COM_SELECTFILE_UPDATE_COMPONENT_ERROR'); ?>
								</div>			
							<?php else : ?>
								<div id="selectfileinstall-component-success">
									<?php echo JText::_('COM_SELECTFILE_UPDATE_COMPONENT_SUCCESS'); ?>
								</div>			
							<?php endif; ?>
						</td>
					</tr>
    ...
    function preflight($type, $parent) 
    {
		...
		if( version_compare( $joomla_version->getShortVersion(), $this->minimum_joomla_release, 'lt' ) ) {
			Jerror::raiseWarning(null, JTEXT::sprintf('COM_SELECTFILE_INSTALL_COMPONENT_ERROR_WRONG_JOOMLA_VERSION',$this->minimum_joomla_release));
			return false;
		}
		switch ($type)
		{
			...
			case 'update' :
				...
				{
					Jerror::raiseWarning(null, JTEXT::sprintf('COM_SELECTFILE_UPDATE_COMPONENT_ERROR_WRONG_VERSION_SEQUENCE', $rel));
					return false;
				}			
			default :
				break; 
    ...
    function postflight($type, $parent) 
    {
		...
		{
			case 'install' :
				JFolder::create(JPATH_SITE.'/images/selectfile'); 
				JFile::copy('administrator/components/com_selectfile/index.html','images/selectfile/index.html', JPATH_SITE);
				
				// Make sure index.html files in all folders
				if (JFolder::exists(JPATH_SITE.'/plugins/selectfile') AND !JFile::exists(JPATH_SITE.'/plugins/selectfile/index.html'))
				{
					JFile::copy('administrator/components/com_selectfile/index.html','plugins/selectfile/index.html', JPATH_SITE);
				}	
				break;    				
			case 'update' :
				/*
	...
	private function getManifest()
	{
		...
		$query->from($db->quoteName('#__extensions'));	
		$query->where($db->quoteName('name').' = '.$db->quote('com_selectfile'));		
	...
	<tr class="selectfileinstall-row">
		...
		<td class="selectfileinstall-error">
			<div>
				<?php echo JText::_('COM_SELECTFILE_'.strtoupper($action).'_PACKAGE_ERROR');?><br />
				<span class="selectfileinstall-errormsg">
					<?php echo $msg; ?>
				</span>	
			</div>		
		</td>
    ...
    private function printSuccess($package, $group, $action)
    {
		...
		<tr class="selectfileinstall-row">
			...
			<td class="selectfileinstall-success">
				<div><?php echo JText::_('COM_SELECTFILE_'.strtoupper($action).'_PACKAGE_SUCCESS');?></div>
			</td>
		</tr> 		
		<?php
            $out = ob_get_clean();
    ...
    private function populateUCM()
    {
		...
		$content_type = array();
		$content_type['type_title'] = 'Size';
		$content_type['type_alias'] = 'com_selectfile.size';
		$content_type['table'] = '{"special":{"dbtable":"selectfile_sizes","key":"id","type":"Sizes","prefix":"SelectfileTable","config":"array()"},';
		...
		$content_type['router'] = 'SelectfileHelperRoute::getSizeRoute';
