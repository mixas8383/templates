...
-- --------------------------------------------------------
--
-- Uninstall of `#__selectfile` tables
--
DROP TABLE IF EXISTS `#__selectfile_sizes`;


DELETE FROM `#__assets` WHERE `name` LIKE '%com_selectfile%';

DELETE FROM `#__extensions` WHERE `name`='com_selectfile' AND `type`='component';
