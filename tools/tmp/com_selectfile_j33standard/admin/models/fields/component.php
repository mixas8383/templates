...
class JFormFieldComponent extends JFormFieldList
{
	...
	public function getOptions()
	{
		...
		$query->where($db->quoteName('a.name').' <> "'.JText::_('COM_SELECTFILE_COMPONENT_NAME').'"');
		...
		array_unshift($options, JHtml::_('select.option', '0', JText::_('COM_SELECTFILE_COMPONENT_NAME')));
		return $options;
	}
}
