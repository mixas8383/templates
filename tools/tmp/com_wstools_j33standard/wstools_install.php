 ...
 * @author			 ()
 * @package			com_wstools
 * @subpackage		com_wstools.install
 * @copyright		
 ...
 */
class com_wstoolsInstallerScript
{
    /**
    ...
    function install($parent) 
    {
		...
		$install_html_file = __DIR__ . '/wstools_install.html';
		...
		ob_start();            
		?>
		<div id="wstoolsinstall-info">
			<h1><?php echo JText::_('COM_WSTOOLS_INSTALL_HEADER'); ?></h1>
			<div id="wstoolsinstall-intro">
				<?php echo JText::_('COM_WSTOOLS_INSTALL_INTRO'); ?>
			</div>
			<table id="wstoolsinstall-table" class="adminlist">
				<thead class="wstoolsinstall-heading">
					<tr>
						<th colspan="3">
							<?php echo JText::_('COM_WSTOOLS_INSTALL_HEADER');?>
						</th>
					</tr>
				</thead>
				<tbody>
					<tr class="wstoolsinstall-subheading">
						<th colspan="2">
							<?php echo JText::_('COM_WSTOOLS_EXTENSION_HEADER');?>
						</th>
						<th width="50%">
							<?php echo JText::_('COM_WSTOOLS_STATUS_HEADER');?>
						</th>					
					</tr>			
					<tr class="wstoolsinstall-row">
						<td  colspan="2">
							<?php echo JText::_('COM_WSTOOLS');?>
						</td>
						<td class="wstoolsinstall-success">
							<?php echo JText::_('COM_WSTOOLS_INSTALL_PACKAGE_SUCCESS');?>
						</td>
					</tr>
					<tr>				
						<td colspan="3">
							<?php echo JText::_('COM_WSTOOLS_INSTALL_CORE_COMPONENT_SUCCESS');?>
						</td>
					</tr>
		<?php
		$buffer .= ob_get_clean();
		...
		if (count($manifest->plugins->plugin) > 0)
		{
			...
			<tr class="wstoolsinstall-subheading">
				<th>
					<?php echo JText::_('COM_WSTOOLS_PLUGIN_HEADER');?>
				</th>
				<th>
					<?php echo JText::_('COM_WSTOOLS_PLUGIN_GROUP_HEADER');?>
				</th>				
				<th width="50%">
					<?php echo JText::_('COM_WSTOOLS_STATUS_HEADER');?>
				</th>					
 		...
 		if (count($manifest->modules->module) > 0)
		{
			...
			<tr class="wstoolsinstall-subheading">
				<th>
					<?php echo JText::_('COM_WSTOOLS_MODULE_HEADER');?>
				</th>
				<th>
					<?php echo JText::_('COM_WSTOOLS_MODULE_GROUP_HEADER');?>
				</th>				
				<th width="50%">
					<?php echo JText::_('COM_WSTOOLS_STATUS_HEADER');?>
				</th>					
	...
	?>
				...
				<tfoot>
					<tr>
						<td colspan="3" text-align="center">
							<?php if ($install_error) : ?>
								<div id="wstoolsinstall-component-error">
									<?php echo JText::_('COM_WSTOOLS_INSTALL_COMPONENT_ERROR'); ?>
								</div>			
							<?php else : ?>
								<div id="wstoolsinstall-component-success">
									<?php echo JText::_('COM_WSTOOLS_INSTALL_COMPONENT_SUCCESS'); ?>
								</div>			
							<?php endif; ?>
						</td>
					</tr>
					<tr>
						<td colspan="3" text-align="center">
							<?php echo JText::_('COM_WSTOOLS_JOOMLA_LOGO_DISCLAIMER'); ?>	
						</td>				
					</tr>					
				</tfoot>
			</table>					
    ...
    function uninstall($parent) 
    {
        ...
        $manifest = $parent->get("manifest");
        $parent = $parent->getParent();
		$uninstall_html_file = __DIR__ . '/wstools_uninstall.html';
     ...
     ?>
	<div id="wstoolsinstall-info">
		<h1><?php echo JText::_('COM_WSTOOLS_UNINSTALL_HEADER'); ?></h1>
			<table id="wstoolsinstall-table" class="adminlist">
				<thead class="wstoolsinstall-heading">
					<tr>
						<th colspan="3">
							<?php echo JText::_('COM_WSTOOLS_UNINSTALL_HEADER');?>
						</th>
					</tr>
				</thead>
				<tbody>
					...
					<tr class="wstoolsinstall-row">
						...
						<td class="wstoolsinstall-success">
							<?php echo JText::_('COM_WSTOOLS_UNINSTALL_PACKAGE_SUCCESS');?>
						</td>
					</tr>
	<?php
		$buffer .= ob_get_clean();  
		...
		JFolder::delete(JPATH_SITE.'/images/wstools'); 
		JFolder::delete(JPATH_SITE.'/plugins/wstools'); 

		$db->setQuery(
						'DELETE FROM '.$db->quoteName('#__content_types')
						.' WHERE '.$db->quoteName('type_alias').' = '.$db->quote('com_wstools.remotemedia')
					 );
				...
				<tfoot>
					<tr>
						<td colspan="3">
							<?php if ($install_error) : ?>
								<div id="wstoolsinstall-component-error">
									<?php echo JText::_('COM_WSTOOLS_UNINSTALL_COMPONENT_ERROR'); ?>
								</div>			
							<?php else : ?>
								<div id="wstoolsinstall-component-success">
									<?php echo JText::_('COM_WSTOOLS_UNINSTALL_COMPONENT_SUCCESS'); ?>
								</div>			
							<?php endif; ?>
						</td>
					</tr>
    ...
    function update($parent) 
    {
		...
		?>
		<div id="wstoolsinstall-info">
			<h1><?php echo JText::_('COM_WSTOOLS_UPDATE_HEADER'); ?></h1>
			<table id="wstoolsinstall-table" class="adminlist">
				<thead class="wstoolsinstall-heading">
					<tr>
						<th colspan="3">
							<?php echo JText::_('COM_WSTOOLS_UPDATE_HEADER');?>
						</th>
					</tr>
				</thead>
				<tbody>
					...
					<tr class="wstoolsinstall-row">
						...
						<td class="wstoolsinstall-success">
							<?php echo JText::_('COM_WSTOOLS_UPDATE_PACKAGE_SUCCESS');?>
						</td>
					</tr>					
		<?php
		$buffer .= ob_get_clean();  
				...
				<tfoot>
					<tr>
						<td colspan="3">
							<?php if ($install_error) : ?>
								<div id="wstoolsinstall-component-error">
									<?php echo JText::_('COM_WSTOOLS_UPDATE_COMPONENT_ERROR'); ?>
								</div>			
							<?php else : ?>
								<div id="wstoolsinstall-component-success">
									<?php echo JText::_('COM_WSTOOLS_UPDATE_COMPONENT_SUCCESS'); ?>
								</div>			
							<?php endif; ?>
						</td>
					</tr>
    ...
    function preflight($type, $parent) 
    {
		...
		if( version_compare( $joomla_version->getShortVersion(), $this->minimum_joomla_release, 'lt' ) ) {
			Jerror::raiseWarning(null, JTEXT::sprintf('COM_WSTOOLS_INSTALL_COMPONENT_ERROR_WRONG_JOOMLA_VERSION',$this->minimum_joomla_release));
			return false;
		}
		switch ($type)
		{
			...
			case 'update' :
				...
				{
					Jerror::raiseWarning(null, JTEXT::sprintf('COM_WSTOOLS_UPDATE_COMPONENT_ERROR_WRONG_VERSION_SEQUENCE', $rel));
					return false;
				}			
			default :
				break; 
    ...
    function postflight($type, $parent) 
    {
		...
		{
			case 'install' :
				JFolder::create(JPATH_SITE.'/images/wstools'); 
				JFile::copy('administrator/components/com_wstools/index.html','images/wstools/index.html', JPATH_SITE);
				
				// Make sure index.html files in all folders
				if (JFolder::exists(JPATH_SITE.'/plugins/wstools') AND !JFile::exists(JPATH_SITE.'/plugins/wstools/index.html'))
				{
					JFile::copy('administrator/components/com_wstools/index.html','plugins/wstools/index.html', JPATH_SITE);
				}	
				break;    				
			case 'update' :
				/*
	...
	private function getManifest()
	{
		...
		$query->from($db->quoteName('#__extensions'));	
		$query->where($db->quoteName('name').' = '.$db->quote('com_wstools'));		
	...
	<tr class="wstoolsinstall-row">
		...
		<td class="wstoolsinstall-error">
			<div>
				<?php echo JText::_('COM_WSTOOLS_'.strtoupper($action).'_PACKAGE_ERROR');?><br />
				<span class="wstoolsinstall-errormsg">
					<?php echo $msg; ?>
				</span>	
			</div>		
		</td>
    ...
    private function printSuccess($package, $group, $action)
    {
		...
		<tr class="wstoolsinstall-row">
			...
			<td class="wstoolsinstall-success">
				<div><?php echo JText::_('COM_WSTOOLS_'.strtoupper($action).'_PACKAGE_SUCCESS');?></div>
			</td>
		</tr> 		
		<?php
            $out = ob_get_clean();
    ...
    private function populateUCM()
    {
		...
		$content_type = array();
		$content_type['type_title'] = 'Remotemedia';
		$content_type['type_alias'] = 'com_wstools.remotemedia';
		$content_type['table'] = '{"special":{"dbtable":"wstools_remotemedias","key":"id","type":"Remotemedias","prefix":"WstoolsTable","config":"array()"},';
		...
		$content_type['router'] = 'WstoolsHelperRoute::getRemotemediaRoute';

		$content_type['content_history_options'] = '{"formFile":"administrator\/components\/wstools\/models\/forms\/remotemedia.xml",';
