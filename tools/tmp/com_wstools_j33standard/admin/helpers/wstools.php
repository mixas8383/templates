 ...
 *
 */
class WstoolsHelper extends JHelperContent
{
	/**
	 * Constructor.
	 *
	...
	public static function addSubmenu($view_name)
	{
		...
		$active = $view_name == 'remotemedias'? true : false;
		JHtmlSidebar::addEntry(
			JText::_('COM_WSTOOLS_REMOTEMEDIAS_SUBMENU'),
			'index.php?option=com_wstools&view=remotemedias',
			$view_name == 'remotemedias',
			$active
		);
