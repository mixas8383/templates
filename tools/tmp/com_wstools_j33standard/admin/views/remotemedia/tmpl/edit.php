...
$this->document->addScript(JUri::root() .'media/com_wstools/js/wstoolsvalidate.js');

$this->document->addScript(JUri::root() .'media/com_wstools/js/formsubmitbutton.js');

JText::script('COM_WSTOOLS_ERROR_ON_FORM');
/*
...
<form action="<?php echo JRoute::_('index.php?option=com_wstools&view=remotemedia&layout=edit&id='.(int) $this->item->id); ?>" method="post" name="adminForm" id="remotemedia-form" class="form-validate">
	...
	<div class="form-horizontal">
		<?php echo JHtml::_('bootstrap.startTabSet', 'remotemedia-tabs', array('active' => 'details')); ?>
			<?php echo JHtml::_('bootstrap.addTab', 'remotemedia-tabs', 'details', JText::_('COM_WSTOOLS_REMOTEMEDIAS_FIELDSET_DETAILS_LABEL', true)); ?>
			<div class="row-fluid">
				<div class="span9">
				...
				<div class="span3">
					<fieldset class="form-vertical">
						...
						<?php endif; ?>
						<?php if ($this->item->version AND $params->get('save_history') AND $params->get('remotemedia_save_history')) : ?>
			...
			<?php echo JHtml::_('bootstrap.addTab', 'remotemedia-tabs', 'publishing', JText::_('COM_WSTOOLS_FIELDSET_PUBLISHING_LABEL', true)); ?>
			...
			<?php echo JHtml::_('bootstrap.addTab', 'remotemedia-tabs', 'imageslinks', JText::_('COM_WSTOOLS_FIELDSET_IMAGES_URLS_LABEL', true)); ?>
			...
			<?php foreach ($fieldsets as $name => $fieldset) :?>
				<?php echo JHtml::_('bootstrap.addTab', 'remotemedia-tabs', 'params-'.$name, JText::_($fieldset->label, true)); ?>
				<div class="row-fluid form-horizontal-desktop">
			...
			<?php echo JHtml::_('bootstrap.addTab', 'remotemedia-tabs', 'metadata', JText::_('COM_WSTOOLS_FIELDSET_METADATA_LABEL', true)); ?>
			<div class="row-fluid form-horizontal-desktop">
				<fieldset>
			...
			<?php if (isset($app->item_associations) AND JLanguageAssociations::isEnabled()) : ?>
				<?php echo JHtml::_('bootstrap.addTab', 'remotemedia-tabs', 'associations', JText::_('COM_WSTOOLS_FIELDSET_ASSOCIATIONS_LABEL', true)); ?>
					<?php echo JLayoutHelper::render('joomla.edit.associations', $this); ?>
				<?php echo JHtml::_('bootstrap.endTab'); ?>
			<?php endif; ?>
			<?php if ($this->can_do->get('core.admin')) : ?>
				<?php echo JHtml::_('bootstrap.addTab', 'remotemedia-tabs', 'permissions', JText::_('COM_WSTOOLS_REMOTEMEDIAS_FIELDSET_RULES', true)); ?>
	...
	<input type="hidden" name="form_id" id="form_id" value="remotemedia-form" />
