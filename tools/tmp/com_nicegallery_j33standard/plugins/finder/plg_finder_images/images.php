 ...
 * @subpackage		com_nicegallery.finder.nicegallery.images
 * @copyright		
...
/**
 * Finder adapter for com_nicegallery - images
 *
 */
class PlgFinderImages extends FinderIndexerAdapter
{
	/**
	 * @var    $context	string	The plugin identifier.
	 */
	protected $context = 'Images';
	 ...
	 */
	protected $type_title = 'Images';

	/**
	 * @var    $table	string	The table name.
	 */
	protected $table = '#__nicegallery_images';
	...
	{
		// Make sure we're handling com_nicegallery categories
		if ($extension == 'com_nicegallery')
		{
	...
	{
		if ($context == 'com_nicegallery.image')
		{
			$id = $table->id;
		}
	...
	{
		// We only want to handle images here
		if ($context == 'com_nicegallery.image' OR $context == 'com_nicegallery.imageform')
		{
	...
	protected function index(FinderIndexerResult $item, $format = 'html')
	{
		...
		$item->route = NicegalleryHelperRoute::getImageRoute($item->slug, $item->catslug, $item->language, $this->sub_layout);
