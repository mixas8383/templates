 ...
 * @subpackage		com_nicegallery.finder.nicegallery.comentses
 * @copyright		
...
/**
 * Finder adapter for com_nicegallery - comentses
 *
 */
class PlgFinderComentses extends FinderIndexerAdapter
{
	/**
	 * @var    $context	string	The plugin identifier.
	 */
	protected $context = 'Comentses';

	/**
	 * @var    $extensionstring	The extension name.
	 */
	protected $extension = 'com_nicegallery';
	...
	{
		if ($context == 'com_nicegallery.coments')
		{
			$id = $table->id;
		}
	...
	{
		// We only want to handle comentses here
		if ($context == 'com_nicegallery.coments' OR $context == 'com_nicegallery.comentsform')
		{
	...
	protected function index(FinderIndexerResult $item, $format = 'html')
	{
		...
		$item->params = JComponentHelper::getParams('com_nicegallery', true);
		...
		$item->route = NicegalleryHelperRoute::getComentsRoute($item->slug, $item->language, $this->sub_layout);
	...
	protected function setup()
	{
		...
		include_once JPATH_SITE . '/components/com_nicegallery/helpers/route.php';
