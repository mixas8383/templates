 ...
 * @subpackage		com_nicegallery.finder.nicegallery.configs
 * @copyright		
...
/**
 * Finder adapter for com_nicegallery - configs
 *
 */
class PlgFinderConfigs extends FinderIndexerAdapter
{
	 ...
	 */
	protected $table = '#__nicegallery_configs';
	...
	{
		if ($context == 'com_nicegallery.config')
		{
			$id = $table->id;
		}
	...
	public function onFinderAfterSave($context, $row, $is_new)
	{
		...
		if ($context == 'com_nicegallery.config' OR $context == 'com_nicegallery.configform')
		{
	...
	protected function index(FinderIndexerResult $item, $format = 'html')
	{
		...
		$item->route = NicegalleryHelperRoute::getConfigRoute($item->slug, $item->language, $this->sub_layout);
