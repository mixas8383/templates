 ...
 * @subpackage		com_nicegallery.finder.nicegallery.votes
 * @copyright		
...
/**
 * Finder adapter for com_nicegallery - votes
 *
 */
class PlgFinderVotes extends FinderIndexerAdapter
{
	/**
	 * @var    $context	string	The plugin identifier.
	 */
	protected $context = 'Votes';
	...
	{
		if ($context == 'com_nicegallery.vote')
		{
			$id = $table->id;
		}
	...
	{
		// We only want to handle votes here
		if ($context == 'com_nicegallery.vote' OR $context == 'com_nicegallery.voteform')
		{
	...
	protected function index(FinderIndexerResult $item, $format = 'html')
	{
		...
		$item->route = NicegalleryHelperRoute::getVoteRoute($item->slug, $item->language, $this->sub_layout);
