 ...
 * @subpackage		com_nicegallery.search.nicegallery.configs
 * @copyright		
	...
	public function onContentSearch($text, $phrase='', $ordering='', $areas=null)
	{
		...
		if ($sConfig AND $limit > 0)
		{
			...
			if (isset($list))
			{
				...
				{
					$list[$key]->href = JRoute::_(NicegalleryHelperRoute::getConfigRoute($item->slug, $item->language, $this->layout, $keep_item_id));
		...
		if ($sConfigArchived AND $limit > 0)
		{
			...
			$item	= $app->getMenu()->getItems('link', 'index.php?option=com_nicegallery&view=configarchive', true);
			...
			if (isset($list3))
			{
				foreach($list3 as $key => $item)
				{
					...
					$list3[$key]->href	= JRoute::_('index.php?option=com_nicegallery&view=configarchive'.
