 ...
 * @subpackage		com_nicegallery.install
 * @copyright		
 ...
 */
class com_nicegalleryInstallerScript
{
    /**
    ...
    function install($parent) 
    {
		...
		$install_html_file = __DIR__ . '/nicegallery_install.html';
		...
		ob_start();            
		?>
		<div id="nicegalleryinstall-info">
			<h1><?php echo JText::_('COM_NICEGALLERY_INSTALL_HEADER'); ?></h1>
			<div id="nicegalleryinstall-intro">
				<?php echo JText::_('COM_NICEGALLERY_INSTALL_INTRO'); ?>
			</div>
			<table id="nicegalleryinstall-table" class="adminlist">
				<thead class="nicegalleryinstall-heading">
					<tr>
						<th colspan="3">
							<?php echo JText::_('COM_NICEGALLERY_INSTALL_HEADER');?>
						</th>
					</tr>
				</thead>
				<tbody>
					<tr class="nicegalleryinstall-subheading">
						<th colspan="2">
							<?php echo JText::_('COM_NICEGALLERY_EXTENSION_HEADER');?>
						</th>
						<th width="50%">
							<?php echo JText::_('COM_NICEGALLERY_STATUS_HEADER');?>
						</th>					
					</tr>			
					<tr class="nicegalleryinstall-row">
						<td  colspan="2">
							<?php echo JText::_('COM_NICEGALLERY');?>
						</td>
						<td class="nicegalleryinstall-success">
							<?php echo JText::_('COM_NICEGALLERY_INSTALL_PACKAGE_SUCCESS');?>
						</td>
					</tr>
					<tr>				
						<td colspan="3">
							<?php echo JText::_('COM_NICEGALLERY_INSTALL_CORE_COMPONENT_SUCCESS');?>
						</td>
					</tr>
		<?php
		$buffer .= ob_get_clean();
		...
		if (count($manifest->plugins->plugin) > 0)
		{
			...
			<tr class="nicegalleryinstall-subheading">
				<th>
					<?php echo JText::_('COM_NICEGALLERY_PLUGIN_HEADER');?>
				</th>
				<th>
					<?php echo JText::_('COM_NICEGALLERY_PLUGIN_GROUP_HEADER');?>
				</th>				
				<th width="50%">
					<?php echo JText::_('COM_NICEGALLERY_STATUS_HEADER');?>
				</th>					
 		...
 		if (count($manifest->modules->module) > 0)
		{
			...
			<tr class="nicegalleryinstall-subheading">
				<th>
					<?php echo JText::_('COM_NICEGALLERY_MODULE_HEADER');?>
				</th>
				<th>
					<?php echo JText::_('COM_NICEGALLERY_MODULE_GROUP_HEADER');?>
				</th>				
				<th width="50%">
					<?php echo JText::_('COM_NICEGALLERY_STATUS_HEADER');?>
				</th>					
	...
	?>
				...
				<tfoot>
					<tr>
						<td colspan="3" text-align="center">
							<?php if ($install_error) : ?>
								<div id="nicegalleryinstall-component-error">
									<?php echo JText::_('COM_NICEGALLERY_INSTALL_COMPONENT_ERROR'); ?>
								</div>			
							<?php else : ?>
								<div id="nicegalleryinstall-component-success">
									<?php echo JText::_('COM_NICEGALLERY_INSTALL_COMPONENT_SUCCESS'); ?>
								</div>			
							<?php endif; ?>
						</td>
					</tr>
					<tr>
						<td colspan="3" text-align="center">
							<?php echo JText::_('COM_NICEGALLERY_JOOMLA_LOGO_DISCLAIMER'); ?>	
						</td>				
					</tr>					
				</tfoot>
			</table>					
    ...
    function uninstall($parent) 
    {
        ...
        $manifest = $parent->get("manifest");
        $parent = $parent->getParent();
		$uninstall_html_file = __DIR__ . '/nicegallery_uninstall.html';
     ...
     ?>
	<div id="nicegalleryinstall-info">
		<h1><?php echo JText::_('COM_NICEGALLERY_UNINSTALL_HEADER'); ?></h1>
			<table id="nicegalleryinstall-table" class="adminlist">
				<thead class="nicegalleryinstall-heading">
					<tr>
						<th colspan="3">
							<?php echo JText::_('COM_NICEGALLERY_UNINSTALL_HEADER');?>
						</th>
					</tr>
				</thead>
				<tbody>
					...
					<tr class="nicegalleryinstall-row">
						...
						<td class="nicegalleryinstall-success">
							<?php echo JText::_('COM_NICEGALLERY_UNINSTALL_PACKAGE_SUCCESS');?>
						</td>
					</tr>
	<?php
		$buffer .= ob_get_clean();  
		...
		JFolder::delete(JPATH_SITE.'/images/nicegallery'); 
		JFolder::delete(JPATH_SITE.'/plugins/nicegallery'); 

		$db->setQuery(
						'DELETE FROM '.$db->quoteName('#__content_types')
						.' WHERE '.$db->quoteName('type_alias').' = '.$db->quote('com_nicegallery.coments')
					 );

		$db->execute(); 
		$db->setQuery(
						'DELETE FROM '.$db->quoteName('#__content_types')
						.' WHERE '.$db->quoteName('type_alias').' = '.$db->quote('com_nicegallery.vote')
					 );

		$db->execute(); 
		$db->setQuery(
						'DELETE FROM '.$db->quoteName('#__content_types')
						.' WHERE '.$db->quoteName('type_alias').' = '.$db->quote('com_nicegallery.config')
					 );

		$db->execute(); 
		$db->setQuery(
						'DELETE FROM '.$db->quoteName('#__content_types')
						.' WHERE '.$db->quoteName('type_alias').' = '.$db->quote('com_nicegallery.image')
					 );
		...
		$db->setQuery(
						'DELETE FROM '.$db->quoteName('#__content_types')
						.' WHERE '.$db->quoteName('type_alias').' = '.$db->quote('com_nicegallery.category')
					 );
				...
				<tfoot>
					<tr>
						<td colspan="3">
							<?php if ($install_error) : ?>
								<div id="nicegalleryinstall-component-error">
									<?php echo JText::_('COM_NICEGALLERY_UNINSTALL_COMPONENT_ERROR'); ?>
								</div>			
							<?php else : ?>
								<div id="nicegalleryinstall-component-success">
									<?php echo JText::_('COM_NICEGALLERY_UNINSTALL_COMPONENT_SUCCESS'); ?>
								</div>			
							<?php endif; ?>
						</td>
					</tr>
    ...
    function update($parent) 
    {
		...
		?>
		<div id="nicegalleryinstall-info">
			<h1><?php echo JText::_('COM_NICEGALLERY_UPDATE_HEADER'); ?></h1>
			<table id="nicegalleryinstall-table" class="adminlist">
				<thead class="nicegalleryinstall-heading">
					<tr>
						<th colspan="3">
							<?php echo JText::_('COM_NICEGALLERY_UPDATE_HEADER');?>
						</th>
					</tr>
				</thead>
				<tbody>
					...
					<tr class="nicegalleryinstall-row">
						...
						<td class="nicegalleryinstall-success">
							<?php echo JText::_('COM_NICEGALLERY_UPDATE_PACKAGE_SUCCESS');?>
						</td>
					</tr>					
		<?php
		$buffer .= ob_get_clean();  
				...
				<tfoot>
					<tr>
						<td colspan="3">
							<?php if ($install_error) : ?>
								<div id="nicegalleryinstall-component-error">
									<?php echo JText::_('COM_NICEGALLERY_UPDATE_COMPONENT_ERROR'); ?>
								</div>			
							<?php else : ?>
								<div id="nicegalleryinstall-component-success">
									<?php echo JText::_('COM_NICEGALLERY_UPDATE_COMPONENT_SUCCESS'); ?>
								</div>			
							<?php endif; ?>
						</td>
					</tr>
    ...
    function preflight($type, $parent) 
    {
		...
		if( version_compare( $joomla_version->getShortVersion(), $this->minimum_joomla_release, 'lt' ) ) {
			Jerror::raiseWarning(null, JTEXT::sprintf('COM_NICEGALLERY_INSTALL_COMPONENT_ERROR_WRONG_JOOMLA_VERSION',$this->minimum_joomla_release));
			return false;
		}
		switch ($type)
		{
			...
			case 'update' :
				...
				{
					Jerror::raiseWarning(null, JTEXT::sprintf('COM_NICEGALLERY_UPDATE_COMPONENT_ERROR_WRONG_VERSION_SEQUENCE', $rel));
					return false;
				}			
			default :
				break; 
    ...
    function postflight($type, $parent) 
    {
		...
		{
			case 'install' :
				JFolder::create(JPATH_SITE.'/images/nicegallery'); 
				JFile::copy('administrator/components/com_nicegallery/index.html','images/nicegallery/index.html', JPATH_SITE);
				
				// Make sure index.html files in all folders
				if (JFolder::exists(JPATH_SITE.'/plugins/nicegallery') AND !JFile::exists(JPATH_SITE.'/plugins/nicegallery/index.html'))
				{
					JFile::copy('administrator/components/com_nicegallery/index.html','plugins/nicegallery/index.html', JPATH_SITE);
				}	
				break;    				
			case 'update' :
				/*
	...
	private function getManifest()
	{
		...
		$query->from($db->quoteName('#__extensions'));	
		$query->where($db->quoteName('name').' = '.$db->quote('com_nicegallery'));		
	...
	<tr class="nicegalleryinstall-row">
		...
		<td class="nicegalleryinstall-error">
			<div>
				<?php echo JText::_('COM_NICEGALLERY_'.strtoupper($action).'_PACKAGE_ERROR');?><br />
				<span class="nicegalleryinstall-errormsg">
					<?php echo $msg; ?>
				</span>	
			</div>		
		</td>
    ...
    private function printSuccess($package, $group, $action)
    {
		...
		<tr class="nicegalleryinstall-row">
			...
			<td class="nicegalleryinstall-success">
				<div><?php echo JText::_('COM_NICEGALLERY_'.strtoupper($action).'_PACKAGE_SUCCESS');?></div>
			</td>
		</tr> 		
		<?php
            $out = ob_get_clean();
    ...
    private function populateUCM()
    {
		...
		$content_type = array();
		$content_type['type_title'] = 'Coments';
		$content_type['type_alias'] = 'com_nicegallery.coments';
		$content_type['table'] = '{"special":{"dbtable":"nicegallery_comentses","key":"id","type":"Comentses","prefix":"NicegalleryTable","config":"array()"},';
		...
		$content_type['router'] = 'NicegalleryHelperRoute::getComentsRoute';

		$content_type['content_history_options'] = '{"formFile":"administrator\/components\/nicegallery\/models\/forms\/coments.xml",';
		...
		$db->execute(); 
		$content_type = array();
		$content_type['type_title'] = 'Vote';
		$content_type['type_alias'] = 'com_nicegallery.vote';
		$content_type['table'] = '{"special":{"dbtable":"nicegallery_votes","key":"id","type":"Votes","prefix":"NicegalleryTable","config":"array()"},';
		$content_type['table'] .= '"common":{"dbtable":"#__core_content","key":"ucm_id","type":"Corecontent","prefix":"JTable","config":"array()"}}';
		$content_type['rules'] = '';
		$content_type['field_mappings'] = '{"special":{},"common":{"core_content_item_id":"id",';
		$content_type['field_mappings'] .= '"core_title":"name",';
		...
		$content_type['field_mappings'] .= '"asset_id":"asset_id"';
		$content_type['field_mappings'] .= '}}';									
		$content_type['router'] = 'NicegalleryHelperRoute::getVoteRoute';

		$content_type['content_history_options'] = '{"formFile":"administrator\/components\/nicegallery\/models\/forms\/vote.xml",';
		$content_type['content_history_options'] .= '"hideFields":[';
		$content_type['content_history_options'] .= '"asset_id",';
		$content_type['content_history_options'] .= '"checked_out","checked_out_time",';
		$content_type['content_history_options'] .= '"version"],"ignoreChanges":[';
		...
		$db->execute(); 
		$content_type = array();
		$content_type['type_title'] = 'Config';
		$content_type['type_alias'] = 'com_nicegallery.config';
		$content_type['table'] = '{"special":{"dbtable":"nicegallery_configs","key":"id","type":"Configs","prefix":"NicegalleryTable","config":"array()"},';
		$content_type['table'] .= '"common":{"dbtable":"#__core_content","key":"ucm_id","type":"Corecontent","prefix":"JTable","config":"array()"}}';
		$content_type['rules'] = '';
		$content_type['field_mappings'] = '{"special":{},"common":{"core_content_item_id":"id",';
		$content_type['field_mappings'] .= '"core_title":"name",';
		...
		$content_type['field_mappings'] .= '"asset_id":"asset_id"';
		$content_type['field_mappings'] .= '}}';									
		$content_type['router'] = 'NicegalleryHelperRoute::getConfigRoute';

		$content_type['content_history_options'] = '{"formFile":"administrator\/components\/nicegallery\/models\/forms\/config.xml",';
		$content_type['content_history_options'] .= '"hideFields":[';
		$content_type['content_history_options'] .= '"asset_id",';
		$content_type['content_history_options'] .= '"checked_out","checked_out_time",';
		$content_type['content_history_options'] .= '"version"],"ignoreChanges":[';
		...
		$db->execute(); 
		$content_type = array();
		$content_type['type_title'] = 'Image';
		$content_type['type_alias'] = 'com_nicegallery.image';
		$content_type['table'] = '{"special":{"dbtable":"nicegallery_images","key":"id","type":"Images","prefix":"NicegalleryTable","config":"array()"},';
		$content_type['table'] .= '"common":{"dbtable":"#__core_content","key":"ucm_id","type":"Corecontent","prefix":"JTable","config":"array()"}}';
		$content_type['rules'] = '';
		$content_type['field_mappings'] = '{"special":{},"common":{"core_content_item_id":"id",';
		$content_type['field_mappings'] .= '"core_title":"name",';
		...
		$content_type['field_mappings'] .= '"asset_id":"asset_id"';
		$content_type['field_mappings'] .= '}}';									
		$content_type['router'] = 'NicegalleryHelperRoute::getImageRoute';

		$content_type['content_history_options'] = '{"formFile":"administrator\/components\/nicegallery\/models\/forms\/image.xml",';
		$content_type['content_history_options'] .= '"hideFields":[';
		$content_type['content_history_options'] .= '"asset_id",';
		$content_type['content_history_options'] .= '"checked_out","checked_out_time",';
		$content_type['content_history_options'] .= '"version"],"ignoreChanges":[';
		...
		$content_type = array();
		$content_type['type_title'] = 'Nicegallery Category';
		$content_type['type_alias'] = 'com_nicegallery.category';
		...
		$content_type['router'] = 'NicegalleryHelperRoute::getCategoryRoute';
