 ...
 * 
 */
abstract class JHtmlNicegalleryBatch
{
	/**
	...
	public static function category($extension)
	{
		...
		$lines = array('<label id="batch-category-lbl" for="batch-category-id" class="hasTip"'
			. ' title="' . JText::_('COM_NICEGALLERY_CATEGORIES_BATCH_CATEGORY_LABEL') . '::' . JText::_('COM_NICEGALLERY_CATEGORIES_BATCH_CATEGORY_DESC') . '">', 
			JText::_('COM_NICEGALLERY_CATEGORIES_BATCH_CATEGORY_LABEL'), '</label>',
	...
	public static function copy_items()
	{
		...
		$lines = array('<label id="batch-copy-items-lbl" for="batch-copy-items"  class="hasTip"'
			. ' title="' . JText::_('COM_NICEGALLERY_NICEGALLERIES_BATCH_COPY_ITEMS_LABEL') . '::' . JText::_('COM_NICEGALLERY_NICEGALLERIES_BATCH_COPY_ITEMS_DESC') . '">',
			 JText::_('COM_NICEGALLERY_NICEGALLERIES_BATCH_COPY_ITEMS_LABEL'), '</label>',
