...
abstract class JHtmlConfigBatch
{
	...
	public static function copy_items()
	{
		...
		$lines = array('<label id="batch-copy-items-lbl" for="batch-copy-items"  class="hasTip"'
			. ' title="' . JText::_('COM_NICEGALLERY_CONFIGS_BATCH_COPY_ITEMS_LABEL') . '::' . JText::_('COM_NICEGALLERY_CONFIGS_BATCH_COPY_ITEMS_DESC') . '">',
			 JText::_('COM_NICEGALLERY_CONFIGS_BATCH_COPY_ITEMS_LABEL'), '</label>',
