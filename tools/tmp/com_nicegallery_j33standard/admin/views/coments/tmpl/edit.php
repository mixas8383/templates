...
<form action="<?php echo JRoute::_('index.php?option=com_nicegallery&view=coments&layout=edit&id='.(int) $this->item->id); ?>" method="post" name="adminForm" id="coments-form" class="form-validate">
	...
	<div class="form-horizontal">
		<?php echo JHtml::_('bootstrap.startTabSet', 'coments-tabs', array('active' => 'details')); ?>
			<?php echo JHtml::_('bootstrap.addTab', 'coments-tabs', 'details', JText::_('COM_NICEGALLERY_COMENTSES_FIELDSET_DETAILS_LABEL', true)); ?>
			<div class="row-fluid">
				<div class="span9">
				...
				<div class="span3">
					<fieldset class="form-vertical">
						...
						<?php endif; ?>
						<?php if ($this->item->version AND $params->get('save_history') AND $params->get('coments_save_history')) : ?>
			...
			<?php echo JHtml::_('bootstrap.addTab', 'coments-tabs', 'publishing', JText::_('COM_NICEGALLERY_FIELDSET_PUBLISHING_LABEL', true)); ?>
			...
			<?php echo JHtml::_('bootstrap.addTab', 'coments-tabs', 'imageslinks', JText::_('COM_NICEGALLERY_FIELDSET_IMAGES_URLS_LABEL', true)); ?>
			...
			<?php foreach ($fieldsets as $name => $fieldset) :?>
				<?php echo JHtml::_('bootstrap.addTab', 'coments-tabs', 'params-'.$name, JText::_($fieldset->label, true)); ?>
				<div class="row-fluid form-horizontal-desktop">
			...
			<?php echo JHtml::_('bootstrap.addTab', 'coments-tabs', 'metadata', JText::_('COM_NICEGALLERY_FIELDSET_METADATA_LABEL', true)); ?>
			<div class="row-fluid form-horizontal-desktop">
				<fieldset>
			...
			<?php if (isset($app->item_associations) AND JLanguageAssociations::isEnabled()) : ?>
				<?php echo JHtml::_('bootstrap.addTab', 'coments-tabs', 'associations', JText::_('COM_NICEGALLERY_FIELDSET_ASSOCIATIONS_LABEL', true)); ?>
					<?php echo JLayoutHelper::render('joomla.edit.associations', $this); ?>
				<?php echo JHtml::_('bootstrap.endTab'); ?>
			<?php endif; ?>
			<?php if ($this->can_do->get('core.admin')) : ?>
				<?php echo JHtml::_('bootstrap.addTab', 'coments-tabs', 'permissions', JText::_('COM_NICEGALLERY_COMENTSES_FIELDSET_RULES', true)); ?>
	...
	<input type="hidden" name="form_id" id="form_id" value="coments-form" />
