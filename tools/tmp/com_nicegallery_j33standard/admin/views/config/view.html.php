...
class NicegalleryViewConfig extends JViewLegacy
{
	...
	public function display($tpl = null)
	{
		...
		$this->can_do = JHelperContent::getActions('com_nicegallery', 'config', $this->item->id);
	...
	protected function addToolbar()
	{
		...
		JToolbarHelper::title($is_new ? JText::_('COM_NICEGALLERY_CONFIGS_NEW_HEADER') : JText::_('COM_NICEGALLERY_CONFIGS_EDIT_HEADER'), 'configs.png');
			...
			)
		{
			...
			$type_alias = 'com_nicegallery.config';
