...
class NicegalleryViewVote extends JViewLegacy
{
	...
	public function display($tpl = null)
	{
		...
		$this->can_do = JHelperContent::getActions('com_nicegallery', 'vote', $this->item->id);
	...
	protected function addToolbar()
	{
		...
		JToolbarHelper::title($is_new ? JText::_('COM_NICEGALLERY_VOTES_NEW_HEADER') : JText::_('COM_NICEGALLERY_VOTES_EDIT_HEADER'), 'votes.png');
		...
		if ($this->state->params->get('save_history', 1) AND $this->state->params->get('vote_save_history', 1)
			AND !$is_new  
			...
			)
		{
			...
			$type_alias = 'com_nicegallery.vote';
