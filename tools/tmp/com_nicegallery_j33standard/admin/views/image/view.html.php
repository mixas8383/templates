...
class NicegalleryViewImage extends JViewLegacy
{
	...
	public function display($tpl = null)
	{
		...
		$this->can_do = JHelperContent::getActions('com_nicegallery', 'image', $this->item->id);
	...
	protected function addToolbar()
	{
		...
		JToolbarHelper::title($is_new ? JText::_('COM_NICEGALLERY_IMAGES_NEW_HEADER') : JText::_('COM_NICEGALLERY_IMAGES_EDIT_HEADER'), 'images.png');
		...
		if ($this->state->params->get('save_history', 1) AND $this->state->params->get('image_save_history', 1)
			AND !$is_new  
			...
			)
		{
			...
			$type_alias = 'com_nicegallery.image';
