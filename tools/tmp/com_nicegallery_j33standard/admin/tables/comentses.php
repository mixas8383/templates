 ...
 *
 */
class NicegalleryTableComentses extends JTable
{
	...
	public function __construct(&$db)
	{
		...
		parent::__construct('#__nicegallery_comentses', 'id', $db);
		...
		JTableObserverTags::createObserver($this, array('typeAlias' => 'com_nicegallery.coments'));

		JTableObserverContenthistory::createObserver($this, array('typeAlias' => 'com_nicegallery.coments'));
	}
	...
	public function check()
	{
		...
		$table = JTable::getInstance('Comentses', 'NicegalleryTable');
	...
	public function store($update_nulls = false)
	{
		...
		if (empty($this->id))
		{
			// New Coments. A created and created_by field can be set by the user,
	...
	{
		$k = $this->_tbl_key;
		return 'com_nicegallery.coments.'.(int) $this->$k;
	}
