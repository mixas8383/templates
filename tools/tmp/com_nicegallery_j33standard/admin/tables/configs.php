 ...
 *
 */
class NicegalleryTableConfigs extends JTable
{
	...
	public function __construct(&$db)
	{
		...
		parent::__construct('#__nicegallery_configs', 'id', $db);
		...
		JTableObserverTags::createObserver($this, array('typeAlias' => 'com_nicegallery.config'));

		JTableObserverContenthistory::createObserver($this, array('typeAlias' => 'com_nicegallery.config'));
	}
	...
	public function check()
	{
		...
		$table = JTable::getInstance('Configs', 'NicegalleryTable');
	...
	{
		$k = $this->_tbl_key;
		return 'com_nicegallery.config.'.(int) $this->$k;
	}
