 ...
 *
 */
class NicegalleryTableImages extends JTable
{
	...
	public function __construct(&$db)
	{
		...
		parent::__construct('#__nicegallery_images', 'id', $db);
		...
		JTableObserverTags::createObserver($this, array('typeAlias' => 'com_nicegallery.image'));

		JTableObserverContenthistory::createObserver($this, array('typeAlias' => 'com_nicegallery.image'));
	}
	...
	public function check()
	{
		...
		$table = JTable::getInstance('Images', 'NicegalleryTable');
	...
	public function store($update_nulls = false)
	{
		...
		if (empty($this->id))
		{
			// New Image. A created and created_by field can be set by the user,
	...
	{
		$k = $this->_tbl_key;
		return 'com_nicegallery.image.'.(int) $this->$k;
	}
