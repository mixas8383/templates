 ...
 *
 */
class NicegalleryTableVotes extends JTable
{
	...
	public function __construct(&$db)
	{
		...
		parent::__construct('#__nicegallery_votes', 'id', $db);
		...
		JTableObserverTags::createObserver($this, array('typeAlias' => 'com_nicegallery.vote'));

		JTableObserverContenthistory::createObserver($this, array('typeAlias' => 'com_nicegallery.vote'));
	}
	...
	public function check()
	{
		...
		$table = JTable::getInstance('Votes', 'NicegalleryTable');
	...
	public function store($update_nulls = false)
	{
		...
		if (empty($this->id))
		{
			// New Vote. A created and created_by field can be set by the user,
	...
	{
		$k = $this->_tbl_key;
		return 'com_nicegallery.vote.'.(int) $this->$k;
	}
