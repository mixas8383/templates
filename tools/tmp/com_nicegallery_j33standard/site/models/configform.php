...
require_once JPATH_ADMINISTRATOR.'/components/com_nicegallery/models/config.php';

class NicegalleryModelConfigForm extends NicegalleryModelConfig
{
	/**
	 ...
	 * @var		string
	 */
	protected $context = 'com_nicegallery.edit.config';
	/**
	...
	*/
	...
	protected function loadFormData()
	{
		...
		$data = JFactory::getApplication()->getUserState('com_nicegallery.edit.config.data', array());
	...
	public function save($data)
	{
		...
		// Reorder the configs so the new config is first
		if (empty($table->id))
		{
		...
		$result = $dispatcher->trigger('onConfigBeforeSave', array('com_nicegallery.config', &$table, $is_new));
		...
		$dispatcher->trigger('onConfigAfterSave', array('com_nicegallery.config', $table, $is_new));
