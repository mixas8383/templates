...
/**
 * This models supports retrieving lists of nicegallery categories.
 *
 */
class NicegalleryModelCategories extends JModelList
{
	/**
	 ...
	 * @var		string
	 */
	public $_context = 'com_nicegallery.categories';
	 ...
	 * @var		string
	 */
	protected $_extension = 'com_nicegallery';
