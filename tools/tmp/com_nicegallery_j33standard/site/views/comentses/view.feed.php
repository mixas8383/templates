...
class NicegalleryViewComentses extends JViewLegacy
{
	...
	public function display($tpl = null)
	{
		...
		$doc->link = JRoute::_('index.php?option=com_nicegallery&view=comentses');
		...
		foreach ($rows as $row)
		{
			...
			// url link to coments
			$link = JRoute::_(NicegalleryHelperRoute::getComentsRoute($row->slug, 
																						$row->language,									
																						'default',								
