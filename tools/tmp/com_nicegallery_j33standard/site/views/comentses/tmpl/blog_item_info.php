 ...
 */	
?>
<dl class="coments-info">
	<dt class="coments-info-term"><?php  echo JText::_('COM_NICEGALLERY_COMENTSES_INFO'); ?></dt>
	<?php if ($params->get('show_coments_tags')) : ?>
		<?php 
			$this->item->tags = new JHelperTags;
			$this->item->tags->getItemTags('com_nicegallery.coments', $this->item->id);	
	...
	<?php endif; ?>	
	<?php if ($params->get('show_coments_hits') AND !empty($this->item->hits)) : ?>
			<dd class="hits">
