...
if ($this->params->get('save_history') AND $this->params->get('nicegallery_save_history'))
{
...
<div class="nicegallery nicegallery-edit<?php echo $this->escape($params->get('pageclass_sfx')); ?>">
		...
		<h2>
			<?php  
				if (!is_null($this->item->id)) :
					...
					echo JText::_('COM_NICEGALLERY_NICEGALLERIES_CREATE_ITEM');
				endif;
			?>
		</h2>
		</div>
	...
	<?php endif; ?>
	<form action="<?php echo JRoute::_('index.php?option=com_nicegallery&view=nicegalleryform&id='.(int) $this->item->id); ?>" method="post" name="adminForm" id="nicegallery-form" class="form-validate">
		<div class="btn-toolbar">
			<div class="btn-group">
				<button type="button" class="btn btn-primary" onclick="Joomla.submitbutton('nicegallery.save')">
					<span class="icon-ok"></span>&#160;<?php echo JText::_('JSAVE') ?>
				</button>
			</div>
			<div class="btn-group">
				<button type="button" class="btn" onclick="Joomla.submitbutton('nicegallery.cancel')">
					<span class="icon-cancel"></span>&#160;<?php echo JText::_('JCANCEL') ?>
				</button>
			</div>
			<?php if ($params->get('save_history') AND $params->get('nicegallery_save_history')) : ?>
				<div class="btn-group">
		...
		<fieldset>
			<ul class="nav nav-tabs">
				<li class="active"><a href="#basic-details" data-toggle="tab"><?php echo JText::_('COM_NICEGALLERY_NICEGALLERIES_FIELDSET_DETAILS_LABEL');?></a></li>
			...
			<div class="tab-content">
				...
				<?php if ($this->item->params->get('access-change')): ?>
					<div class="tab-pane" id="publishing">
						...
						<?php else: ?>
							<div class="form-note">
								<p><?php echo JText::_('COM_NICEGALLERY_NICEGALLERIES_ORDERING'); ?></p>
							</div>
						<?php endif; ?>
					</div>	
