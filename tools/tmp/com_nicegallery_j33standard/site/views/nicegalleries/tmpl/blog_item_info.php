 ...
 */	
?>
<dl class="nicegallery-info">
	<dt class="nicegallery-info-term"><?php  echo JText::_('COM_NICEGALLERY_NICEGALLERIES_INFO'); ?></dt>
	...
	<?php endif; ?>
	<?php if ($params->get('show_nicegallery_tags')) : ?>
		<?php 
			$this->item->tags = new JHelperTags;
			$this->item->tags->getItemTags('com_nicegallery.nicegallery', $this->item->id);	
	...
	<?php endif; ?>	
	<?php if ($params->get('show_nicegallery_hits') AND !empty($this->item->hits)) : ?>
			<dd class="hits">
