...
<div class="nicegallery configs-list<?php echo $this->params->get('pageclass_sfx');?>">
	...
	<form action="<?php echo JFilterOutput::ampReplace(JUri::getInstance()->toString()); ?>" method="post" name="adminForm" id="adminForm">
		<?php if (($this->params->get('show_config_filter_field') != '' AND $this->params->get('show_config_filter_field') != 'hide')) :?>
			<div class="filter-search">
				<?php if ($this->params->get('show_config_filter_field') != '' AND $this->params->get('show_config_filter_field') != 'hide') :?>
					<input type="text" name="filter_search" id="filter_search" value="<?php echo $this->escape($this->state->get('filter.search')); ?>" onchange="document.adminForm.submit();" title="<?php echo JText::_('COM_NICEGALLERY_FILTER_SEARCH_DESC'); ?>" placeholder="<?php echo JText::_('COM_NICEGALLERY_'.$this->params->get('show_config_filter_field').'_FILTER_LABEL'); ?>" />
				<?php endif; ?>	
			</div>
		<?php endif; ?>
		...
		<?php if (empty($this->items)) : ?>
			...
			<p><?php echo JText::_('COM_NICEGALLERY_CONFIGS_NO_ITEMS'); ?></p>
			<?php endif; ?>
		...
		<?php else : ?>
			...
			<tbody>
				...
				?>			
					...
					<td class="list-name">
						<a href="<?php echo JRoute::_(NicegalleryHelperRoute::getConfigRoute($item->slug, 
																									$item->language,									
																									$layout,									
