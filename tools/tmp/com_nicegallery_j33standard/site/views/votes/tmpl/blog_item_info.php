...
?>
<dl class="vote-info">
	<dt class="vote-info-term"><?php  echo JText::_('COM_NICEGALLERY_VOTES_INFO'); ?></dt>
	<?php if ($params->get('show_vote_tags')) : ?>
		<?php 
			$this->item->tags = new JHelperTags;
			$this->item->tags->getItemTags('com_nicegallery.vote', $this->item->id);	
	...
	<?php endif; ?>	
	<?php if ($params->get('show_vote_hits') AND !empty($this->item->hits)) : ?>
			<dd class="hits">
