 ...
 */
?>
<div class="images-modal<?php echo $this->params->get('pageclass_sfx');?>">
	<h3><?php echo JText::_('COM_NICEGALLERY_IMAGES_SELECT_ITEM_LABEL'); ?></h3>
	<form action="<?php echo JRoute::_('index.php?option=com_nicegallery&view=images&layout=modal&tmpl=component');?>" method="post" name="adminForm" id="adminForm">
