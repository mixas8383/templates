...
class NicegalleryViewCategory extends JViewLegacy
{
	...
	public function display($tpl = null)
	{
		...
		$doc->link = JRoute::_(NicegalleryHelperRoute::getCategoryRoute($category->id, $params->get('keep_image_itemid')));
		...
		foreach ($rows as $row)
		{
			...
			$link = JRoute::_(NicegalleryHelperRoute::getImageRoute($row->slug, 
																						$row->catid, 
																						$row->language,
																						'default',									
