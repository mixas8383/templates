...
/**
 * HTML View class for the Nicegallery component
 *
 */
class NicegalleryViewCategory extends JViewLegacy
{
	protected $state;
	protected $category;
	protected $children;
	...
	public function display($tpl = null)
	{
		...
		$this->category->tags->getItemTags('com_nicegallery.category', $this->category->id);
	...
	protected function prepareDocument()
	{
		...
		{
			$this->params->def('page_heading', JText::_('COM_NICEGALLERY_CATEGORY_HEADER'));
		}

		$id = (int) @$menu->query['id'];

		if ($menu AND ($menu->query['option'] != 'com_nicegallery' OR
					 $menu->query['view'] == 'image' OR 
					 $id != $this->category->id))
		{
			$path = array(array('title' => $this->category->title, 'link' => ''));
			$category = $this->category->getParent();

			while (($menu->query['option'] != 'com_nicegallery' OR
					$menu->query['view'] == 'image' OR
