 ...
 *
 */
class NicegalleryControllerImages extends JControllerLegacy
{
	/**
	 ...
	 * 
	 */
	public function getModel($name = 'Images', $prefix = 'NicegalleryModel',$config = array('ignore_request' => true))
	{
