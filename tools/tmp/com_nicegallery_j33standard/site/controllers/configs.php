 ...
 *
 */
class NicegalleryControllerConfigs extends JControllerLegacy
{
	/**
	 ...
	 * 
	 */
	public function getModel($name = 'Configs', $prefix = 'NicegalleryModel',$config = array('ignore_request' => true))
	{
