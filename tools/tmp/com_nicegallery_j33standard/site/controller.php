...
/**
 * Nicegallery Component Controller
 *
 */
class NicegalleryController extends JControllerLegacy
{
	...
	public function display($cachable = false, $url_params = false)
	{
		...
		$safe_url_params = array(
			...
			'filter_coments_order'=>'CMD','filter_coments_order_Dir'=>'CMD','coments-filter-search'=>'STRING',
			'filter_vote_order'=>'CMD','filter_vote_order_Dir'=>'CMD','vote-filter-search'=>'STRING',
			'filter_config_order'=>'CMD','filter_config_order_Dir'=>'CMD','config-filter-search'=>'STRING',
			'filter_image_order'=>'CMD','filter_image_order_Dir'=>'CMD','image-filter-search'=>'STRING',
