 ...
 * @subpackage		com_simplepoll.install
 * @copyright		
 ...
 */
class com_simplepollInstallerScript
{
    /**
    ...
    function install($parent) 
    {
		...
		$install_html_file = __DIR__ . '/simplepoll_install.html';
		...
		ob_start();            
		?>
		<div id="simplepollinstall-info">
			<h1><?php echo JText::_('COM_SIMPLEPOLL_INSTALL_HEADER'); ?></h1>
			<div id="simplepollinstall-intro">
				<?php echo JText::_('COM_SIMPLEPOLL_INSTALL_INTRO'); ?>
			</div>
			<table id="simplepollinstall-table" class="adminlist">
				<thead class="simplepollinstall-heading">
					<tr>
						<th colspan="3">
							<?php echo JText::_('COM_SIMPLEPOLL_INSTALL_HEADER');?>
						</th>
					</tr>
				</thead>
				<tbody>
					<tr class="simplepollinstall-subheading">
						<th colspan="2">
							<?php echo JText::_('COM_SIMPLEPOLL_EXTENSION_HEADER');?>
						</th>
						<th width="50%">
							<?php echo JText::_('COM_SIMPLEPOLL_STATUS_HEADER');?>
						</th>					
					</tr>			
					<tr class="simplepollinstall-row">
						<td  colspan="2">
							<?php echo JText::_('COM_SIMPLEPOLL');?>
						</td>
						<td class="simplepollinstall-success">
							<?php echo JText::_('COM_SIMPLEPOLL_INSTALL_PACKAGE_SUCCESS');?>
						</td>
					</tr>
					<tr>				
						<td colspan="3">
							<?php echo JText::_('COM_SIMPLEPOLL_INSTALL_CORE_COMPONENT_SUCCESS');?>
						</td>
					</tr>
		<?php
		$buffer .= ob_get_clean();
		...
		if (count($manifest->plugins->plugin) > 0)
		{
			...
			<tr class="simplepollinstall-subheading">
				<th>
					<?php echo JText::_('COM_SIMPLEPOLL_PLUGIN_HEADER');?>
				</th>
				<th>
					<?php echo JText::_('COM_SIMPLEPOLL_PLUGIN_GROUP_HEADER');?>
				</th>				
				<th width="50%">
					<?php echo JText::_('COM_SIMPLEPOLL_STATUS_HEADER');?>
				</th>					
 		...
 		if (count($manifest->modules->module) > 0)
		{
			...
			<tr class="simplepollinstall-subheading">
				<th>
					<?php echo JText::_('COM_SIMPLEPOLL_MODULE_HEADER');?>
				</th>
				<th>
					<?php echo JText::_('COM_SIMPLEPOLL_MODULE_GROUP_HEADER');?>
				</th>				
				<th width="50%">
					<?php echo JText::_('COM_SIMPLEPOLL_STATUS_HEADER');?>
				</th>					
	...
	?>
				...
				<tfoot>
					<tr>
						<td colspan="3" text-align="center">
							<?php if ($install_error) : ?>
								<div id="simplepollinstall-component-error">
									<?php echo JText::_('COM_SIMPLEPOLL_INSTALL_COMPONENT_ERROR'); ?>
								</div>			
							<?php else : ?>
								<div id="simplepollinstall-component-success">
									<?php echo JText::_('COM_SIMPLEPOLL_INSTALL_COMPONENT_SUCCESS'); ?>
								</div>			
							<?php endif; ?>
						</td>
					</tr>
					<tr>
						<td colspan="3" text-align="center">
							<?php echo JText::_('COM_SIMPLEPOLL_JOOMLA_LOGO_DISCLAIMER'); ?>	
						</td>				
					</tr>					
				</tfoot>
			</table>					
    ...
    function uninstall($parent) 
    {
        ...
        $manifest = $parent->get("manifest");
        $parent = $parent->getParent();
		$uninstall_html_file = __DIR__ . '/simplepoll_uninstall.html';
     ...
     ?>
	<div id="simplepollinstall-info">
		<h1><?php echo JText::_('COM_SIMPLEPOLL_UNINSTALL_HEADER'); ?></h1>
			<table id="simplepollinstall-table" class="adminlist">
				<thead class="simplepollinstall-heading">
					<tr>
						<th colspan="3">
							<?php echo JText::_('COM_SIMPLEPOLL_UNINSTALL_HEADER');?>
						</th>
					</tr>
				</thead>
				<tbody>
					...
					<tr class="simplepollinstall-row">
						...
						<td class="simplepollinstall-success">
							<?php echo JText::_('COM_SIMPLEPOLL_UNINSTALL_PACKAGE_SUCCESS');?>
						</td>
					</tr>
	<?php
		$buffer .= ob_get_clean();  
		...
		JFolder::delete(JPATH_SITE.'/images/simplepoll'); 
		JFolder::delete(JPATH_SITE.'/plugins/simplepoll'); 

		$db->setQuery(
						'DELETE FROM '.$db->quoteName('#__content_types')
						.' WHERE '.$db->quoteName('type_alias').' = '.$db->quote('com_simplepoll.answers')
					 );

		$db->execute(); 
		$db->setQuery(
						'DELETE FROM '.$db->quoteName('#__content_types')
						.' WHERE '.$db->quoteName('type_alias').' = '.$db->quote('com_simplepoll.poll')
					 );
		...
		$db->setQuery(
						'DELETE FROM '.$db->quoteName('#__content_types')
						.' WHERE '.$db->quoteName('type_alias').' = '.$db->quote('com_simplepoll.category')
					 );
				...
				<tfoot>
					<tr>
						<td colspan="3">
							<?php if ($install_error) : ?>
								<div id="simplepollinstall-component-error">
									<?php echo JText::_('COM_SIMPLEPOLL_UNINSTALL_COMPONENT_ERROR'); ?>
								</div>			
							<?php else : ?>
								<div id="simplepollinstall-component-success">
									<?php echo JText::_('COM_SIMPLEPOLL_UNINSTALL_COMPONENT_SUCCESS'); ?>
								</div>			
							<?php endif; ?>
						</td>
					</tr>
    ...
    function update($parent) 
    {
		...
		?>
		<div id="simplepollinstall-info">
			<h1><?php echo JText::_('COM_SIMPLEPOLL_UPDATE_HEADER'); ?></h1>
			<table id="simplepollinstall-table" class="adminlist">
				<thead class="simplepollinstall-heading">
					<tr>
						<th colspan="3">
							<?php echo JText::_('COM_SIMPLEPOLL_UPDATE_HEADER');?>
						</th>
					</tr>
				</thead>
				<tbody>
					...
					<tr class="simplepollinstall-row">
						...
						<td class="simplepollinstall-success">
							<?php echo JText::_('COM_SIMPLEPOLL_UPDATE_PACKAGE_SUCCESS');?>
						</td>
					</tr>					
		<?php
		$buffer .= ob_get_clean();  
				...
				<tfoot>
					<tr>
						<td colspan="3">
							<?php if ($install_error) : ?>
								<div id="simplepollinstall-component-error">
									<?php echo JText::_('COM_SIMPLEPOLL_UPDATE_COMPONENT_ERROR'); ?>
								</div>			
							<?php else : ?>
								<div id="simplepollinstall-component-success">
									<?php echo JText::_('COM_SIMPLEPOLL_UPDATE_COMPONENT_SUCCESS'); ?>
								</div>			
							<?php endif; ?>
						</td>
					</tr>
    ...
    function preflight($type, $parent) 
    {
		...
		if( version_compare( $joomla_version->getShortVersion(), $this->minimum_joomla_release, 'lt' ) ) {
			Jerror::raiseWarning(null, JTEXT::sprintf('COM_SIMPLEPOLL_INSTALL_COMPONENT_ERROR_WRONG_JOOMLA_VERSION',$this->minimum_joomla_release));
			return false;
		}
		switch ($type)
		{
			...
			case 'update' :
				...
				{
					Jerror::raiseWarning(null, JTEXT::sprintf('COM_SIMPLEPOLL_UPDATE_COMPONENT_ERROR_WRONG_VERSION_SEQUENCE', $rel));
					return false;
				}			
			default :
				break; 
    ...
    function postflight($type, $parent) 
    {
		...
		{
			case 'install' :
				JFolder::create(JPATH_SITE.'/images/simplepoll'); 
				JFile::copy('administrator/components/com_simplepoll/index.html','images/simplepoll/index.html', JPATH_SITE);
				
				// Make sure index.html files in all folders
				if (JFolder::exists(JPATH_SITE.'/plugins/simplepoll') AND !JFile::exists(JPATH_SITE.'/plugins/simplepoll/index.html'))
				{
					JFile::copy('administrator/components/com_simplepoll/index.html','plugins/simplepoll/index.html', JPATH_SITE);
				}	
				break;    				
			case 'update' :
				/*
	...
	private function getManifest()
	{
		...
		$query->from($db->quoteName('#__extensions'));	
		$query->where($db->quoteName('name').' = '.$db->quote('com_simplepoll'));		
	...
	<tr class="simplepollinstall-row">
		...
		<td class="simplepollinstall-error">
			<div>
				<?php echo JText::_('COM_SIMPLEPOLL_'.strtoupper($action).'_PACKAGE_ERROR');?><br />
				<span class="simplepollinstall-errormsg">
					<?php echo $msg; ?>
				</span>	
			</div>		
		</td>
    ...
    private function printSuccess($package, $group, $action)
    {
		...
		<tr class="simplepollinstall-row">
			...
			<td class="simplepollinstall-success">
				<div><?php echo JText::_('COM_SIMPLEPOLL_'.strtoupper($action).'_PACKAGE_SUCCESS');?></div>
			</td>
		</tr> 		
		<?php
            $out = ob_get_clean();
    ...
    private function populateUCM()
    {
		...
		$content_type = array();
		$content_type['type_title'] = 'Answers';
		$content_type['type_alias'] = 'com_simplepoll.answers';
		$content_type['table'] = '{"special":{"dbtable":"simplepoll_answerses","key":"id","type":"Answerses","prefix":"SimplepollTable","config":"array()"},';
		...
		$content_type['router'] = 'SimplepollHelperRoute::getAnswersRoute';

		$content_type['content_history_options'] = '{"formFile":"administrator\/components\/simplepoll\/models\/forms\/answers.xml",';
		...
		$db->execute(); 
		$content_type = array();
		$content_type['type_title'] = 'Poll';
		$content_type['type_alias'] = 'com_simplepoll.poll';
		$content_type['table'] = '{"special":{"dbtable":"simplepoll_polls","key":"id","type":"Polls","prefix":"SimplepollTable","config":"array()"},';
		$content_type['table'] .= '"common":{"dbtable":"#__core_content","key":"ucm_id","type":"Corecontent","prefix":"JTable","config":"array()"}}';
		$content_type['rules'] = '';
		$content_type['field_mappings'] = '{"special":{},"common":{"core_content_item_id":"id",';
		$content_type['field_mappings'] .= '"core_title":"name",';
		...
		$content_type['field_mappings'] .= '"asset_id":"asset_id"';
		$content_type['field_mappings'] .= '}}';									
		$content_type['router'] = 'SimplepollHelperRoute::getPollRoute';

		$content_type['content_history_options'] = '{"formFile":"administrator\/components\/simplepoll\/models\/forms\/poll.xml",';
		$content_type['content_history_options'] .= '"hideFields":[';
		$content_type['content_history_options'] .= '"asset_id",';
		$content_type['content_history_options'] .= '"checked_out","checked_out_time",';
		$content_type['content_history_options'] .= '"version"],"ignoreChanges":[';
		...
		$content_type = array();
		$content_type['type_title'] = 'Simplepoll Category';
		$content_type['type_alias'] = 'com_simplepoll.category';
		...
		$content_type['router'] = 'SimplepollHelperRoute::getCategoryRoute';
