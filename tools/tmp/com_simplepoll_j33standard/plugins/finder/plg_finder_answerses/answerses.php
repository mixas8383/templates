 ...
 * @subpackage		com_simplepoll.finder.simplepoll.answerses
 * @copyright		
...
/**
 * Finder adapter for com_simplepoll - answerses
 *
 */
class PlgFinderAnswerses extends FinderIndexerAdapter
{
	/**
	 * @var    $context	string	The plugin identifier.
	 */
	protected $context = 'Answerses';

	/**
	 * @var    $extensionstring	The extension name.
	 */
	protected $extension = 'com_simplepoll';
	...
	{
		if ($context == 'com_simplepoll.answers')
		{
			$id = $table->id;
		}
	...
	{
		// We only want to handle answerses here
		if ($context == 'com_simplepoll.answers' OR $context == 'com_simplepoll.answersform')
		{
	...
	protected function index(FinderIndexerResult $item, $format = 'html')
	{
		...
		$item->params = JComponentHelper::getParams('com_simplepoll', true);
		...
		$item->route = SimplepollHelperRoute::getAnswersRoute($item->slug, $item->language, $this->sub_layout);
	...
	protected function setup()
	{
		...
		include_once JPATH_SITE . '/components/com_simplepoll/helpers/route.php';
