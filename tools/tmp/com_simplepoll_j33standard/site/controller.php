...
/**
 * Simplepoll Component Controller
 *
 */
class SimplepollController extends JControllerLegacy
{
	...
	public function display($cachable = false, $url_params = false)
	{
		...
		$safe_url_params = array(
			...
			'filter_answers_order'=>'CMD','filter_answers_order_Dir'=>'CMD','answers-filter-search'=>'STRING',
			'filter_poll_order'=>'CMD','filter_poll_order_Dir'=>'CMD','poll-filter-search'=>'STRING',
