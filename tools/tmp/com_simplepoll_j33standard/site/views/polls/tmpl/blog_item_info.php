...
?>
<dl class="poll-info">
	<dt class="poll-info-term"><?php  echo JText::_('COM_SIMPLEPOLL_POLLS_INFO'); ?></dt>
	...
	<?php endif; ?>
	<?php if ($params->get('show_poll_tags')) : ?>
		<?php 
			$this->item->tags = new JHelperTags;
			$this->item->tags->getItemTags('com_simplepoll.poll', $this->item->id);	
	...
	<?php endif; ?>	
	<?php if ($params->get('show_poll_hits') AND !empty($this->item->hits)) : ?>
			<dd class="hits">
