...
class SimplepollViewPoll extends JViewLegacy
{
	...
	public function display($tpl = null)
	{
		...
		$this->can_do = JHelperContent::getActions('com_simplepoll', 'poll', $this->item->id);
	...
	protected function addToolbar()
	{
		...
		JToolbarHelper::title($is_new ? JText::_('COM_SIMPLEPOLL_POLLS_NEW_HEADER') : JText::_('COM_SIMPLEPOLL_POLLS_EDIT_HEADER'), 'polls.png');
		...
		if ($this->state->params->get('save_history', 1) AND $this->state->params->get('poll_save_history', 1)
			AND !$is_new  
			...
			)
		{
			...
			$type_alias = 'com_simplepoll.poll';
