...
<form action="<?php echo JRoute::_('index.php?option=com_simplepoll&view=poll&layout=edit&id='.(int) $this->item->id); ?>" method="post" name="adminForm" id="poll-form" class="form-validate">
	...
	<div class="form-horizontal">
		<?php echo JHtml::_('bootstrap.startTabSet', 'poll-tabs', array('active' => 'details')); ?>
			<?php echo JHtml::_('bootstrap.addTab', 'poll-tabs', 'details', JText::_('COM_SIMPLEPOLL_POLLS_FIELDSET_DETAILS_LABEL', true)); ?>
			<div class="row-fluid">
				<div class="span9">
				...
				<div class="span3">
					<fieldset class="form-vertical">
						...
						<?php endif; ?>
						<?php if ($this->item->version AND $params->get('save_history') AND $params->get('poll_save_history')) : ?>
			...
			<?php echo JHtml::_('bootstrap.addTab', 'poll-tabs', 'publishing', JText::_('COM_SIMPLEPOLL_FIELDSET_PUBLISHING_LABEL', true)); ?>
			...
			<?php echo JHtml::_('bootstrap.addTab', 'poll-tabs', 'imageslinks', JText::_('COM_SIMPLEPOLL_FIELDSET_IMAGES_URLS_LABEL', true)); ?>
			...
			<?php foreach ($fieldsets as $name => $fieldset) :?>
				<?php echo JHtml::_('bootstrap.addTab', 'poll-tabs', 'params-'.$name, JText::_($fieldset->label, true)); ?>
				<div class="row-fluid form-horizontal-desktop">
			...
			<?php echo JHtml::_('bootstrap.addTab', 'poll-tabs', 'metadata', JText::_('COM_SIMPLEPOLL_FIELDSET_METADATA_LABEL', true)); ?>
			<div class="row-fluid form-horizontal-desktop">
				<fieldset>
			...
			<?php if (isset($app->item_associations) AND JLanguageAssociations::isEnabled()) : ?>
				<?php echo JHtml::_('bootstrap.addTab', 'poll-tabs', 'associations', JText::_('COM_SIMPLEPOLL_FIELDSET_ASSOCIATIONS_LABEL', true)); ?>
					<?php echo JLayoutHelper::render('joomla.edit.associations', $this); ?>
				<?php echo JHtml::_('bootstrap.endTab'); ?>
			<?php endif; ?>
			<?php if ($this->can_do->get('core.admin')) : ?>
				<?php echo JHtml::_('bootstrap.addTab', 'poll-tabs', 'permissions', JText::_('COM_SIMPLEPOLL_POLLS_FIELDSET_RULES', true)); ?>
	...
	<input type="hidden" name="form_id" id="form_id" value="poll-form" />
