...
<div class="modal hide fade" id="collapseModal">
	<div class="modal-header">
		...
		<h3><?php echo JText::_('COM_SIMPLEPOLL_POLL_BATCH_OPTIONS');?></h3>
	</div>
	<div class="modal-body">
		<p><?php echo JText::_('COM_SIMPLEPOLL_POLL_BATCH_TIP'); ?></p>
		<div class="control-group">
			<div class="controls">
				<?php echo JHtml::_('pollbatch.access');?>
			</div>
		</div>
		<div class="control-group">
			<div class="controls">
				<?php echo JHtml::_('pollbatch.tag');?>
			</div>
		</div>	
		<div class="control-group">
			<div class="controls">
				<?php echo JHtml::_('pollbatch.language'); ?>
			</div>
		</div>
		<div class="control-group">
			<div class="controls">	
				<?php echo JHtml::_('pollbatch.category', 'com_simplepoll');?>
			</div>
		</div>
		<div class="control-group">
			<div class="controls">
				<?php echo JHtml::_('pollbatch.copy_items', 'com_simplepoll');?>
			</div>
		</div>
	</div>
