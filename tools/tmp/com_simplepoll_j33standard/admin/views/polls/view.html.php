...
class SimplepollViewPolls extends JViewLegacy
{
	...
	public function display($tpl = null)
	{
		...
		$this->can_do = JHelperContent::getActions('com_simplepoll', 'category', $this->state->get('filter.category_id'));
	...
	protected function addToolbar()
	{
		...
		JToolbarHelper::title(JText::_('COM_SIMPLEPOLL_POLLS_LIST_HEADER'), 'stack polls');
		...
		if ($this->can_do->get('core.edit.state') ) 
		{
			...
			if ($this->state->get('filter.state') != -1 ) 
			{
				...
				else 
				{
					if ($this->state->get('filter.state') == 2) 
					{
						JToolbarHelper::unarchiveList('polls.publish', 'JTOOLBAR_UNARCHIVE');
					}
				}
			}
		}
	...
	{	
		JHtmlSidebar::setAction('index.php?option=com_simplepoll&view=polls');
