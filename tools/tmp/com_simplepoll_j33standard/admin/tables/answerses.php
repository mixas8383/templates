 ...
 *
 */
class SimplepollTableAnswerses extends JTable
{
	...
	public function __construct(&$db)
	{
		...
		parent::__construct('#__simplepoll_answerses', 'id', $db);
		...
		JTableObserverTags::createObserver($this, array('typeAlias' => 'com_simplepoll.answers'));

		JTableObserverContenthistory::createObserver($this, array('typeAlias' => 'com_simplepoll.answers'));
	}
	...
	public function check()
	{
		...
		$table = JTable::getInstance('Answerses', 'SimplepollTable');
	...
	public function store($update_nulls = false)
	{
		...
		if (empty($this->id))
		{
			// New Answers. A created and created_by field can be set by the user,
	...
	{
		$k = $this->_tbl_key;
		return 'com_simplepoll.answers.'.(int) $this->$k;
	}
